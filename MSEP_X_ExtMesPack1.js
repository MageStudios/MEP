...
Game_System.prototype.initMessageSounds = function() {
    ...
    this._msgSoundPitch = MageStudios.Param.EMP1SoundPitch;
    this._msgSoundPitchVar = MageStudios.Param.EMP1PitchVar;
...
Game_System.prototype.initChoiceShow = function() {
    ...
    for (var i = 0; i < length; ++i) {
      var switchId = MageStudios.Param.EMP1ChoiceShow[i];
...
Game_System.prototype.initChoiceEnable = function() {
    ...
    for (var i = 0; i < length; ++i) {
      var switchId = MageStudios.Param.EMP1ChoiceOn[i];
      if (switchId <= 0) continue;
      $gameSwitches.setValue(switchId, true);
    }
...
Game_System.prototype.initMessagePosition = function() {
    ...
    if (MageStudios.Param.EMP1DefaultY.match(/center/i)) {
      this._msgWindowAnchorY = 0.5;
    } else if (MageStudios.Param.EMP1DefaultY.match(/bottom/i)) {
