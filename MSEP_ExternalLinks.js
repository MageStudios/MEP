...
MageStudios.Param.HomePageText = String(
  MageStudios.Parameters["Home Page Text"]
);
MageStudios.Param.PopupMessage = String(
  MageStudios.Parameters["Popup Blocker Notice"]
);
