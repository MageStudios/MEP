//=============================================================================
// Mage Studios Engine Plugins - Region Restrictions Extension - Vehicle Restrictions
// MSEP_X_VehicleRestrict.js
//=============================================================================
...
MageStudios.SetupParameters = function() {
  ...
  for (var i = 0; i < MageStudios.Param.VRBoatRestrict.length; ++i) {
    MageStudios.Param.VRBoatRestrict[i] = Number(MageStudios.Param.VRBoatRestrict[i]);
  }
  ...
  for (var i = 0; i < MageStudios.Param.VRBoatAllow.length; ++i) {
    MageStudios.Param.VRBoatAllow[i] = Number(MageStudios.Param.VRBoatAllow[i]);
  }
  ...
  MageStudios.Param.VRShipRestrict = MageStudios.Param.VRShipRestrict.split(' ');
  for (var i = 0; i < MageStudios.Param.VRShipRestrict.length; ++i) {
    MageStudios.Param.VRShipRestrict[i] = Number(MageStudios.Param.VRShipRestrict[i]);
  }
  ...
  for (var i = 0; i < MageStudios.Param.VRShipAllow.length; ++i) {
    MageStudios.Param.VRShipAllow[i] = Number(MageStudios.Param.VRShipAllow[i]);
  }
  ...
  MageStudios.Param.VRAirRestrict = MageStudios.Param.VRAirRestrict.split(' ');
  for (var i = 0; i < MageStudios.Param.VRAirRestrict.length; ++i) {
    MageStudios.Param.VRAirRestrict[i] = Number(MageStudios.Param.VRAirRestrict[i]);
  }
...
DataManager.processVRNotetags = function() {
  ...
  for (var i = 0; i < notedata.length; i++) {
    ...
    if (line.match(note1)) {
      ...
      var key = vehicle + 'Restrict';
      if ($dataMap.vehicleRestrictions[key]) {
        var range = MageStudios.Util.getRange(Number(RegExp.$2), Number(RegExp.$3));
        $dataMap.vehicleRestrictions[key] =
...
MageStudios.VR.Game_Vehicle_isMapPassable = Game_Vehicle.prototype.isMapPassable;
...
// End of File
//=============================================================================
}; // Imported.MSEP_RegionRestrictions