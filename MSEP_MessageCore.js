...
MageStudios.Message.version = 1.0;
...
MageStudios.Param.MSGDefaultRows = String(
  MageStudios.Parameters["Default Rows"]
);
MageStudios.Param.MSGDefaultWidth = String(
  MageStudios.Parameters["Default Width"]
);
MageStudios.Param.MSGFaceIndent = String(MageStudios.Parameters["Face Indent"]);
MageStudios.Param.MSGFastForwardKey = String(
  MageStudios.Parameters["Fast Forward Key"]
);
MageStudios.Param.MSGFFOn = eval(
  String(MageStudios.Parameters["Enable Fast Forward"])
);
...
MageStudios.Param.MSGDescWrap = String(
  MageStudios.Parameters["Description Wrap"]
);
MageStudios.Param.MSGWrapSpace = eval(
  String(MageStudios.Parameters["Word Wrap Space"])
);
MageStudios.Param.MSGTightWrap = eval(
  String(MageStudios.Parameters["Tight Wrap"])
);

MageStudios.Param.MSGFontName = String(MageStudios.Parameters["Font Name"]);
MageStudios.Param.MSGCNFontName = String(
  MageStudios.Parameters["Font Name CH"]
);
MageStudios.Param.MSGKRFontName = String(
  MageStudios.Parameters["Font Name KR"]
);
MageStudios.Param.MSGFontSize = Number(MageStudios.Parameters["Font Size"]);
MageStudios.Param.MSGFontSizeChange = String(
  MageStudios.Parameters["Font Size Change"]
);
MageStudios.Param.MSGFontChangeMax = String(
  MageStudios.Parameters["Font Changed Max"]
);
MageStudios.Param.MSGFontChangeMin = String(
  MageStudios.Parameters["Font Changed Min"]
);
MageStudios.Param.MSGFontOutline =
  Number(MageStudios.Parameters["Font Outline"]) || 4;
MageStudios.Param.MSGFontMaintain = eval(
  String(MageStudios.Parameters["Maintain Font"])
);

MageStudios.Param.MSGNameBoxBufferX = String(
  MageStudios.Parameters["Name Box Buffer X"]
);
MageStudios.Param.MSGNameBoxBufferY = String(
  MageStudios.Parameters["Name Box Buffer Y"]
);
MageStudios.Param.MSGNameBoxPadding = String(
  MageStudios.Parameters["Name Box Padding"]
);
MageStudios.Param.MSGNameBoxColor = Number(
  MageStudios.Parameters["Name Box Color"]
);
MageStudios.Param.MSGNameBoxClear = String(
  MageStudios.Parameters["Name Box Clear"]
);
MageStudios.Param.MSGNameBoxText = String(
  MageStudios.Parameters["Name Box Added Text"]
);
MageStudios.Param.MSGNameBoxClose = String(
  MageStudios.Parameters["Name Box Auto Close"]
);
...
MageStudios.Message.Bitmap_makeFontNameText =
...
Window_Base.prototype.convertEscapeCharacters = function (text) {
  ...
  text = MageStudios.Message.Window_Base_convertEscapeCharacters.call(
    this,
    text
  );
...
Window_Base.prototype.processEscapeCharacter = function (code, textState) {
  switch (code) {
    ...
    case "FS":
      ...
      if (MageStudios.Param.MSGFontMaintain)
        $gameSystem.setMessageFontSize(size);
      break;
    case "FN":
      var name = this.obtainEscapeString(textState);
      this.contents.fontFace = name;
      if (MageStudios.Param.MSGFontMaintain)
        $gameSystem.setMessageFontName(name);
      break;
    case "OC":
      var id = this.obtainEscapeParam(textState);
    ...
    case "PY":
      ...
      break;
    default:
      MageStudios.Message.Window_Base_processEscapeCharacter.call(
        this,
        code,
        textState
      );
...
MageStudios.Message.Window_Message_newPage = Window_Message.prototype.newPage;
...
Window_Message.prototype.processEscapeCharacter = function (code, textState) {
  switch (code) {
    ...
    default:
      MageStudios.Message.Window_Message_processEscapeCharacter.call(
        this,
        code,
        textState
      );
