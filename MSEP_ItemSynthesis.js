...
Imported.MSEP_ItemSynthesis = true;

var MageStudios = MageStudios || {};
MageStudios.IS = MageStudios.IS || {};
MageStudios.IS.version = 1.0;
...
MageStudios.Param.ISSynthCmd = String(
  MageStudios.Parameters["Synthesis Command"]
);
MageStudios.Param.ISShowSynth = String(MageStudios.Parameters["Show Command"]);
MageStudios.Param.ISShowSynth = eval(MageStudios.Param.ISShowSynth);
MageStudios.Param.ISEnableSynth = String(
  MageStudios.Parameters["Enable Command"]
);
MageStudios.Param.ISEnableSynth = eval(MageStudios.Param.ISEnableSynth);
MageStudios.Param.ISAutoPlaceCmd = String(
  MageStudios.Parameters["Auto Place Command"]
);

MageStudios.Param.ISItemCmd = String(MageStudios.Parameters["Item Command"]);
MageStudios.Param.ISWeaponCmd = String(
  MageStudios.Parameters["Weapon Command"]
);
MageStudios.Param.ISArmorCmd = String(MageStudios.Parameters["Armor Command"]);
MageStudios.Param.ISFinishCmd = String(
  MageStudios.Parameters["Finish Command"]
);
MageStudios.Param.ISTextAlign = String(
  MageStudios.Parameters["Text Alignment"]
);

MageStudios.Param.ISColRecipes = String(
  MageStudios.Parameters["Collected Recipes"]
);
MageStudios.Param.ISCraftedItems = String(
  MageStudios.Parameters["Crafted Items"]
);
MageStudios.Param.ISCraftedWeapons = String(
  MageStudios.Parameters["Crafted Weapons"]
);
MageStudios.Param.ISCraftedArmors = String(
  MageStudios.Parameters["Crafted Armors"]
);

MageStudios.Param.ISEquRecipes = eval(
  String(MageStudios.Parameters["Equipped Recipes"])
);
MageStudios.Param.ISMaskUnknown = String(
  MageStudios.Parameters["Mask Unknown"]
);
MageStudios.Param.ISMaskText = String(MageStudios.Parameters["Mask Text"]);
MageStudios.Param.ISMaskItalic = String(MageStudios.Parameters["Mask Italic"]);
MageStudios.Param.ISMaskItalic = eval(MageStudios.Param.ISMaskItalic);
MageStudios.Param.ISMaskHelpText = String(
  MageStudios.Parameters["Mask Help Text"]
);
MageStudios.Param.ISIngredientsList = String(
  MageStudios.Parameters["Ingredients Text"]
);
MageStudios.Param.ISAmountText = String(MageStudios.Parameters["Amount Text"]);
MageStudios.Param.ISAmountFmt = eval(
  MageStudios.Parameters["Amount Format"] || "false"
);
MageStudios.Param.ISQuantitySize = Number(
  MageStudios.Parameters["Quantity Text Size"]
);

MageStudios.Param.ISDefSEName = String(MageStudios.Parameters["Default SE"]);
MageStudios.Param.ISDefVol = Number(MageStudios.Parameters["Default Volume"]);
MageStudios.Param.ISDefPitch = Number(MageStudios.Parameters["Default Pitch"]);
MageStudios.Param.ISDefPant = Number(MageStudios.Parameters["Default Pan"]);

MageStudios.IS.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function () {
  if (!MageStudios.IS.DataManager_isDatabaseLoaded.call(this)) return false;
  if (!MageStudios._loaded_MSEP_ItemSynthesis) {
    this.processISNotetagsI($dataItems);
    this.processISNotetagsW($dataWeapons);
    this.processISNotetagsA($dataArmors);
    MageStudios.IS.SynthesisRecipeCount = 0;
    MageStudios.IS.SynthesisItemTotal = 0;
    MageStudios.IS.SynthesisWeaponTotal = 0;
    MageStudios.IS.SynthesisArmorTotal = 0;
    this.processISNotetags1($dataItems, 0);
    this.processISNotetags1($dataWeapons, 1);
    this.processISNotetags1($dataArmors, 2);
    MageStudios._loaded_MSEP_ItemSynthesis = true;
  }
  return true;
};
...
DataManager.processISNotetags1 = function (group, type) {
  ...
  for (var n = 1; n < group.length; n++) {
    ...
    obj.synthSeName = MageStudios.Param.ISDefSEName;
    obj.synthSeVol = MageStudios.Param.ISDefVol;
    obj.synthSePitch = MageStudios.Param.ISDefPitch;
    obj.synthSePan = MageStudios.Param.ISDefPan;
    obj.customSynthEval = "";
    var evalMode = "none";
...
DataManager.addSynthesisIngredient = function (obj, line) {
  ...
  if (line.match(/GOLD:[ ](\d+)/i)) {
    ...
    if (MageStudios.ItemIdRef[name]) {
      ingId = MageStudios.ItemIdRef[name];
      ingType = 0;
    } else if (MageStudios.WeaponIdRef[name]) {
      ingId = MageStudios.WeaponIdRef[name];
      ingType = 1;
    } else if (MageStudios.ArmorIdRef[name]) {
      ingId = MageStudios.ArmorIdRef[name];
      ingType = 2;
    }
  } else {
...
DataManager.isSynthesisIngredientOk = function (ingId, ingType) {
  ...
  if (Imported.MSEP_ItemCore && this.isIndependent(item)) return false;
  return true;
};
...
DataManager.processRecipeCounts = function (obj) {
  if (
    obj.recipeItem.length > 0 ||
    obj.recipeWeapon.length > 0 ||
    obj.recipeArmor.length > 0
  ) {
    MageStudios.IS.SynthesisRecipeCount += obj.recipeItem.length;
    MageStudios.IS.SynthesisRecipeCount += obj.recipeWeapon.length;
    MageStudios.IS.SynthesisRecipeCount += obj.recipeArmor.length;
  }
  if (obj.name === "") return;
  if (obj.synthCost > 0 || obj.synthIngredients.length > 0) {
    if (obj.groupType === 0) MageStudios.IS.SynthesisItemTotal += 1;
    if (obj.groupType === 1) MageStudios.IS.SynthesisWeaponTotal += 1;
    if (obj.groupType === 2) MageStudios.IS.SynthesisArmorTotal += 1;
  }
};

MageStudios.IS.Game_System_initialize = Game_System.prototype.initialize;
Game_System.prototype.initialize = function () {
  MageStudios.IS.Game_System_initialize.call(this);
  this.initSynthesis();
};

Game_System.prototype.initSynthesis = function () {
  this._showSynthesis = MageStudios.Param.ISShowSynth;
  this._enableSynthesis = MageStudios.Param.ISEnableSynth;
  this._synthedItems = [];
...
MageStudios.IS.Game_Interpreter_pluginCommand =
  Game_Interpreter.prototype.pluginCommand;
Game_Interpreter.prototype.pluginCommand = function (command, args) {
  MageStudios.IS.Game_Interpreter_pluginCommand.call(this, command, args);
...
Window_SynthesisCommand.prototype.itemTextAlign = function () {
  return MageStudios.Param.ISTextAlign;
};
...
Window_SynthesisCommand.prototype.addItemCommands = function () {
  if (Scene_Synthesis.availableItems().length > 0) {
    this.addCommand(MageStudios.Param.ISItemCmd, "item", true);
  }
  if (Scene_Synthesis.availableWeapons().length > 0) {
    this.addCommand(MageStudios.Param.ISWeaponCmd, "weapon", true);
  }
  if (Scene_Synthesis.availableArmors().length > 0) {
    this.addCommand(MageStudios.Param.ISArmorCmd, "armor", true);
  }
};
...
Window_SynthesisCommand.prototype.addFinishCommand = function () {
  this.addCommand(MageStudios.Param.ISFinishCmd, "cancel", true);
};
...
Window_SynthesisStatus.prototype.drawCollectedRecipes = function (dy) {
  if (MageStudios.Param.ISColRecipes.length <= 0) return dy;
  var dw = this.contents.width;
  this.changeTextColor(this.systemColor());
  this.drawText(MageStudios.Param.ISColRecipes, 0, dy, dw);
  this.changeTextColor(this.normalColor());
  var value =
    parseFloat($gameSystem.totalRecipes()) /
    MageStudios.IS.SynthesisRecipeCount;
...
Window_SynthesisStatus.prototype.drawCraftedItems = function (dy) {
  if (MageStudios.Param.ISCraftedItems.length <= 0) return dy;
  var dw = this.contents.width;
  this.changeTextColor(this.systemColor());
  this.drawText(MageStudios.Param.ISCraftedItems, 0, dy, dw);
  this.changeTextColor(this.normalColor());
  var value =
    parseFloat($gameSystem.synthedItems().length) /
    Math.max(1, MageStudios.IS.SynthesisItemTotal);
  var text = String(parseInt(value * 100)) + "%";
  this.drawText(text, 0, dy, dw, "right");
  dw -= this.textWidth("100%") + this.standardPadding() * 2;
  var fmt = "%1/%2";
  text = fmt.format(
    ...
    MageStudios.IS.SynthesisItemTotal
  );
  this.drawText(text, 0, dy, dw, "right");
  return dy + this.lineHeight();
};
...
Window_SynthesisStatus.prototype.drawCraftedWeapons = function (dy) {
  if (MageStudios.Param.ISCraftedWeapons.length <= 0) return dy;
  var dw = this.contents.width;
  this.changeTextColor(this.systemColor());
  this.drawText(MageStudios.Param.ISCraftedWeapons, 0, dy, dw);
  this.changeTextColor(this.normalColor());
  var value =
    parseFloat($gameSystem.synthedWeapons().length) /
    Math.max(1, MageStudios.IS.SynthesisWeaponTotal);
  var text = String(parseInt(value * 100)) + "%";
  this.drawText(text, 0, dy, dw, "right");
  dw -= this.textWidth("100%") + this.standardPadding() * 2;
  var fmt = "%1/%2";
  text = fmt.format(
    ...
    MageStudios.IS.SynthesisWeaponTotal
  );
  this.drawText(text, 0, dy, dw, "right");
  return dy + this.lineHeight();
};
...
Window_SynthesisStatus.prototype.drawCraftedArmors = function (dy) {
  if (MageStudios.Param.ISCraftedArmors.length <= 0) return dy;
  var dw = this.contents.width;
  this.changeTextColor(this.systemColor());
  this.drawText(MageStudios.Param.ISCraftedArmors, 0, dy, dw);
  this.changeTextColor(this.normalColor());
  var value =
    parseFloat($gameSystem.synthedArmors().length) /
    Math.max(1, MageStudios.IS.SynthesisArmorTotal);
  var text = String(parseInt(value * 100)) + "%";
  this.drawText(text, 0, dy, dw, "right");
  dw -= this.textWidth("100%") + this.standardPadding() * 2;
  var fmt = "%1/%2";
  text = fmt.format(
    ...
    MageStudios.IS.SynthesisArmorTotal
  );
  this.drawText(text, 0, dy, dw, "right");
  return dy + this.lineHeight();
};
...
Window_SynthesisList.prototype.updateHelp = function () {
  if (this._commandWindow.active) {
    ...
    eval(MageStudios.Param.ISMaskUnknown) &&
    !$gameSystem.hasSynthed(this.item())
  ) {
    var text = MageStudios.Param.ISMaskHelpText;
...
Window_SynthesisList.prototype.drawItemName = function (item, x, y, width) {
  ...
  var text = item.name;
  if (eval(MageStudios.Param.ISMaskUnknown)) {
    this.contents.fontItalic = MageStudios.Param.ISMaskItalic;
    if (item.maskName !== "") {
      text = item.maskName;
    } else {
      text = MageStudios.Util.maskString(text, MageStudios.Param.ISMaskText);
    }
  }
...
Window_SynthesisList.prototype.drawItemNumber = function (item, wx, wy, ww) {
  if (eval(MageStudios.Param.ISMaskUnknown) && !$gameSystem.hasSynthed(item)) {
    return;
  }
  ww -= this.textPadding();
  if (Imported.MSEP_ItemCore && DataManager.isIndependent(item)) {
    ...
    var numItems = MageStudios.Util.toGroup(value);
  } else {
    var numItems = MageStudios.Util.toGroup($gameParty.numItems(item));
  }
  this.contents.fontSize = MageStudios.Param.ISQuantitySize;
...
Window_SynthesisIngredients.prototype.drawItemIngredients = function (
  item,
  wy
) {
  var ww = this.contents.width;
  this.changeTextColor(this.systemColor());
  this.drawText(MageStudios.Param.ISIngredientsList, 0, 0, ww, "center");
  this.changeTextColor(this.normalColor());
  for (var i = 0; i < item.synthIngredients.length; ++i) {
...
Window_SynthesisIngredients.prototype.drawItemDetails = function (index, wy) {
  ...
  if (MageStudios.Param.ISAmountFmt) {
...
Window_SynthesisIngredients.prototype.drawItemQuantity = function (index, wy) {
  ...
  this.contents.fontSize = MageStudios.Param.ISQuantitySize;
  this.changeTextColor(this.normalColor());
  var num = "/" + MageStudios.Util.toGroup($gameParty.numItems(ingredient));
  ...
  var text = String(MageStudios.Util.toGroup(quantity));
...
Window_SynthesisIngredients.prototype.drawItemQuantity2 = function (index, wy) {
  ...
  this.contents.fontSize = MageStudios.Param.ISQuantitySize;
  this.changeTextColor(this.normalColor());
  var num = "/" + MageStudios.Util.toGroup(quantity);
  this.drawText(num, 0, wy, ww, "right");
  ww -= this.textWidth(num);
  if ($gameParty.numItems(ingredient) >= quantity) {
    this.changeTextColor(this.powerUpColor());
  ...
  var text = String(MageStudios.Util.toGroup(owned));
  this.drawText(text, 0, wy, ww, "right");
};
...
Window_SynthesisNumber.prototype.drawAmountText = function () {
  this.resetFontSettings();
  this.changeTextColor(this.systemColor());
  this.drawText(MageStudios.Param.ISAmountText, 0, 0, this.contents.width);
  this.resetTextColor();
};
...
Window_SynthesisNumber.prototype.drawNumber = function () {
  ...
  this.resetTextColor();
  this.drawText(MageStudios.Util.toGroup(this._number), x, y, width, "right");
};
...
Window_SynthesisNumber.prototype.maxDigits = function () {
  if (this._item) {
    ...
    return String(MageStudios.Util.toGroup(maxItem)).length;
  }
  return 2;
};
...
MageStudios.IS.Scene_Menu_createCommandWindow =
  Scene_Menu.prototype.createCommandWindow;
Scene_Menu.prototype.createCommandWindow = function () {
  MageStudios.IS.Scene_Menu_createCommandWindow.call(this);
...
Scene_Synthesis.availableLibrary = function () {
  ...
  if (MageStudios.Param.ISEquRecipes) {
...
Scene_Synthesis.prototype.customSynthEffect = function (number) {
  ...
  try {
    ...
    MageStudios.Util.displayError(e, code, "CUSTOM SYNTH EFFECT ERROR");
  }
};
...
MageStudios.Util.maskString = function (str, mask) {
  var text = mask;
  if (mask.length === 1) {
