//=============================================================================
// Mage Studios Engine Plugins - Item Synthesis
// MSEP_ItemSynthesis.js
//=============================================================================
...
MageStudios.Param.ISEnableSynth = String(MageStudios.Parameters['Enable Command']);
MageStudios.Param.ISEnableSynth = eval(MageStudios.Param.ISEnableSynth);
MageStudios.Param.ISAutoPlaceCmd = String(MageStudios.Parameters['Auto Place Command']);

MageStudios.Param.ISItemCmd = String(MageStudios.Parameters['Item Command']);
MageStudios.Param.ISWeaponCmd  = String(MageStudios.Parameters['Weapon Command']);
MageStudios.Param.ISArmorCmd  = String(MageStudios.Parameters['Armor Command']);
MageStudios.Param.ISFinishCmd = String(MageStudios.Parameters['Finish Command']);
MageStudios.Param.ISTextAlign = String(MageStudios.Parameters['Text Alignment']);

MageStudios.Param.ISColRecipes = String(MageStudios.Parameters['Collected Recipes']);
MageStudios.Param.ISCraftedItems = String(MageStudios.Parameters['Crafted Items']);
MageStudios.Param.ISCraftedWeapons = String(MageStudios.Parameters['Crafted Weapons']);
MageStudios.Param.ISCraftedArmors = String(MageStudios.Parameters['Crafted Armors']);

MageStudios.Param.ISEquRecipes = eval(String(MageStudios.Parameters['Equipped Recipes']));
MageStudios.Param.ISMaskUnknown = String(MageStudios.Parameters['Mask Unknown']);
...
MageStudios.Param.ISMaskHelpText = String(MageStudios.Parameters['Mask Help Text']);
MageStudios.Param.ISIngredientsList = String(MageStudios.Parameters['Ingredients Text']);
MageStudios.Param.ISAmountText = String(MageStudios.Parameters['Amount Text']);
MageStudios.Param.ISAmountFmt = eval(MageStudios.Parameters['Amount Format'] || 'false');
MageStudios.Param.ISQuantitySize = Number(MageStudios.Parameters['Quantity Text Size']);
...
Window_SynthesisList.prototype.updateHelp = function() {
    ...
    } else if (eval(MageStudios.Param.ISMaskUnknown) &&
