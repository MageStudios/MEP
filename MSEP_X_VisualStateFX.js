//=============================================================================
// Mage Studios Engine Plugins - Buffs & States Extension - Visual State Effects
// MSEP_X_VisualStateFX.js
//=============================================================================
...
MageStudios.Param.VSFXActorIcons = String(MageStudios.Parameters['Actor State Icons']);
MageStudios.Param.VSFXActorIcons = eval(MageStudios.Param.VSFXActorIcons);
MageStudios.Param.VSFXActorAni = String(MageStudios.Parameters['Actor State Animation']);
MageStudios.Param.VSFXActorAni = eval(MageStudios.Param.VSFXActorAni);

MageStudios.Param.VSFXEnemyOver = String(MageStudios.Parameters['Enemy State Overlay']);
MageStudios.Param.VSFXEnemyOver = eval(MageStudios.Param.VSFXEnemyOver);
MageStudios.Param.VSFXEnemyIcons = String(MageStudios.Parameters['Enemy State Icons']);
MageStudios.Param.VSFXEnemyIcons = eval(MageStudios.Param.VSFXEnemyIcons);
MageStudios.Param.VSFXEnemyAni = String(MageStudios.Parameters['Enemy State Animation']);
MageStudios.Param.VSFXEnemyAni = eval(MageStudios.Param.VSFXEnemyAni);

MageStudios.Param.VSFXAniTarget = String(MageStudios.Parameters['Allow Target Flash']);
MageStudios.Param.VSFXAniTarget = eval(MageStudios.Param.VSFXAniTarget);
MageStudios.Param.VSFXAniScreen = String(MageStudios.Parameters['Allow Screen Flash']);
MageStudios.Param.VSFXAniScreen = eval(MageStudios.Param.VSFXAniScreen);
MageStudios.Param.VSFXAniHide = String(MageStudios.Parameters['Allow Hide Target']);
MageStudios.Param.VSFXAniHide = eval(MageStudios.Param.VSFXAniHide);
MageStudios.Param.VSFXAniSound = String(MageStudios.Parameters['Allow Sound']);
...
MageStudios.VSFX.Game_Battler_removeState = Game_Battler.prototype.removeState;
...
MageStudios.VSFX.Sprite_Actor_initMembers = Sprite_Actor.prototype.initMembers;
...
MageStudios.VSFX.Sprite_Actor_refreshMotion = Sprite_Actor.prototype.refreshMotion;
...
MageStudios.VSFX.Sprite_Enemy_initMembers = Sprite_Enemy.prototype.initMembers;
...
MageStudios.VSFX.Sprite_Enemy_refreshMotion = Sprite_Enemy.prototype.refreshMotion;
...
// End of File
//=============================================================================
}; // Imported.MSEP_BattleEngineCore && Imported.MSEP_BuffsStatesCore