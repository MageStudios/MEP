...
MageStudios.KeyConfig.version = 1.0;
...
MageStudios.SetupParameters = function () {
  if (Imported.MSEP_ButtonCommonEvents) {
    ...
    var array = JSON.parse(
      MageStudios.Parameters["Button Events List"] || "[]"
    );
...
MageStudios.KeyConfig.DataManager_isDatabaseLoaded =
  DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function () {
  if (!MageStudios.KeyConfig.DataManager_isDatabaseLoaded.call(this))
    return false;
...
if (Imported.MSEP_ButtonCommonEvents) {
  if (MageStudios.Param.BCEList["tilde"] !== 0)
    ConfigManager.wasdMap[192] = "tilde";
  ...
  if (MageStudios.Param.BCEList["minus"] !== 0)
    ConfigManager.wasdMap[189] = "minus";
  if (MageStudios.Param.BCEList["equal"] !== 0)
    ConfigManager.wasdMap[187] = "equal";
  ...
  if (MageStudios.Param.BCEList["foreBrack"] !== 0)
    ConfigManager.wasdMap[219] = "foreBrack";
  if (MageStudios.Param.BCEList["backBrack"] !== 0)
    ConfigManager.wasdMap[221] = "backBrack";
  if (MageStudios.Param.BCEList["backSlash"] !== 0)
    ConfigManager.wasdMap[220] = "backSlash";
  ...
  if (MageStudios.Param.BCEList["semicolon"] !== 0)
    ConfigManager.wasdMap[186] = "semicolon";
  if (MageStudios.Param.BCEList["quote"] !== 0)
    ConfigManager.wasdMap[222] = "quote";
  if (MageStudios.Param.BCEList["enter"] !== 0)
    ConfigManager.wasdMap[13] = "enter";

  if (MageStudios.Param.BCEList["keyShift"] !== 0)
    ConfigManager.wasdMap[16] = "keyShift";
  ...
  if (MageStudios.Param.BCEList["comma"] !== 0)
    ConfigManager.wasdMap[188] = "comma";
  if (MageStudios.Param.BCEList["period"] !== 0)
    ConfigManager.wasdMap[190] = "period";
  if (MageStudios.Param.BCEList["foreSlash"] !== 0)
    ConfigManager.wasdMap[191] = "foreSlash";

  if (MageStudios.Param.BCEList["space"] !== 0)
    ConfigManager.wasdMap[32] = "space";
  if (MageStudios.Param.BCEList["dirLeft"] !== 0)
    ConfigManager.wasdMap[37] = "dirLeft";
  if (MageStudios.Param.BCEList["dirUp"] !== 0)
    ConfigManager.wasdMap[38] = "dirUp";
  if (MageStudios.Param.BCEList["dirRight"] !== 0)
    ConfigManager.wasdMap[39] = "dirRight";
  if (MageStudios.Param.BCEList["dirDown"] !== 0)
    ConfigManager.wasdMap[40] = "dirDown";
  ...
  if (MageStudios.Param.BCEList["home"] !== 0)
    ConfigManager.wasdMap[36] = "home";
  if (MageStudios.Param.BCEList["end"] !== 0) ConfigManager.wasdMap[35] = "end";
  if (MageStudios.Param.BCEList["pageUp"] !== 0)
    ConfigManager.wasdMap[33] = "pageUp";
  if (MageStudios.Param.BCEList["pageDown"] !== 0)
    ConfigManager.wasdMap[34] = "pageDown";

  if (MageStudios.Param.BCEList["num0"] !== 0)
    ConfigManager.wasdMap[96] = "num0";
  if (MageStudios.Param.BCEList["num1"] !== 0)
    ConfigManager.wasdMap[97] = "num1";
  if (MageStudios.Param.BCEList["num2"] !== 0)
    ConfigManager.wasdMap[98] = "num2";
  if (MageStudios.Param.BCEList["num3"] !== 0)
    ConfigManager.wasdMap[99] = "num3";
  if (MageStudios.Param.BCEList["num4"] !== 0)
    ConfigManager.wasdMap[100] = "num4";
  if (MageStudios.Param.BCEList["num5"] !== 0)
    ConfigManager.wasdMap[101] = "num5";
  if (MageStudios.Param.BCEList["num6"] !== 0)
    ConfigManager.wasdMap[102] = "num6";
  if (MageStudios.Param.BCEList["num7"] !== 0)
    ConfigManager.wasdMap[103] = "num7";
  if (MageStudios.Param.BCEList["num8"] !== 0)
    ConfigManager.wasdMap[104] = "num8";
  if (MageStudios.Param.BCEList["num9"] !== 0)
    ConfigManager.wasdMap[105] = "num9";
  if (MageStudios.Param.BCEList["numPeriod"] !== 0)
    ConfigManager.wasdMap[110] = "numPeriod";
  if (MageStudios.Param.BCEList["numPlus"] !== 0)
    ConfigManager.wasdMap[107] = "numPlus";
  if (MageStudios.Param.BCEList["numMinus"] !== 0)
    ConfigManager.wasdMap[109] = "numMinus";
  if (MageStudios.Param.BCEList["numTimes"] !== 0)
    ConfigManager.wasdMap[106] = "numTimes";
  if (MageStudios.Param.BCEList["numDivide"] !== 0)
    ConfigManager.wasdMap[111] = "numDivide";
}
...
Scene_KeyConfig.prototype.commandDefault = function () {
  ConfigManager.keyMapper = JSON.parse(
    JSON.stringify(ConfigManager.defaultMap)
  );
