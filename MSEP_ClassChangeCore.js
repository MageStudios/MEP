//=============================================================================
// Mage Studios Engine Plugins - Class Change Core
// MSEP_ClassChangeCore.js
//=============================================================================

var Imported = Imported || {};
Imported.MSEP_ClassChangeCore = true;
 ...
 *
 *       Name: MageStudios.Param.CCCCmdName
 *     Symbol: class
...
MageStudios.Param.CCCCmdName = String(MageStudios.Parameters['Class Command']);
MageStudios.Param.CCCAutoAdd = eval(String(MageStudios.Parameters['Auto Add Menu']));
MageStudios.Param.CCCShowCmd = String(MageStudios.Parameters['Show Command']);
MageStudios.Param.CCCShowCmd = eval(MageStudios.Param.CCCShowCmd);
MageStudios.Param.CCCEnableCmd = String(MageStudios.Parameters['Enable Command']);
MageStudios.Param.CCCEnableCmd = eval(MageStudios.Param.CCCEnableCmd);
MageStudios.Param.CCCAutoPlace = String(MageStudios.Parameters['Auto Place Command']);
MageStudios.Param.CCCAutoPlace = eval(MageStudios.Param.CCCAutoPlace);
MageStudios.Icon.DefaultClass = Number(MageStudios.Parameters['Default Icon']);
MageStudios.Param.CCCMaintainLv = String(MageStudios.Parameters['Maintain Levels']);
MageStudios.Param.CCCMaintainLv = eval(MageStudios.Param.CCCMaintainLv);
MageStudios.Param.CCCUnlock = String(MageStudios.Parameters['Unlocked Classes']);
MageStudios.Param.CCCUnlock = MageStudios.Param.CCCUnlock.split(' ');
if (MageStudios.Param.CCCUnlock === '') MageStudios.Param.CCCUnlock = [];
for (MageStudios.i = 0; MageStudios.i < MageStudios.Param.CCCUnlock.length; ++MageStudios.i) {
  MageStudios.Param.CCCUnlock[MageStudios.i] = parseInt(MageStudios.Param.CCCUnlock[MageStudios.i]);
}

MageStudios.Param.CCCClassCmd = String(MageStudios.Parameters['Class Change Command']);
MageStudios.Param.CCCShowClass = String(MageStudios.Parameters['Show Class Change']);
MageStudios.Param.CCCShowClass = eval(MageStudios.Param.CCCShowClass);
MageStudios.Param.CCCEnableClass = String(MageStudios.Parameters['Enable Class Change']);
MageStudios.Param.CCCEnableClass = eval(MageStudios.Param.CCCEnableClass);
MageStudios.Param.CCCShowLearn = String(MageStudios.Parameters['Show Skill Learn']);
MageStudios.Param.CCCShowLearn = eval(MageStudios.Param.CCCShowLearn);
MageStudios.Param.CCCFinishCmd = String(MageStudios.Parameters['Finish Command']);
MageStudios.Param.CCCTextAlign = String(MageStudios.Parameters['Text Alignment']);

MageStudios.Param.CCCClassColor = Number(MageStudios.Parameters['Current Class Color']);
MageStudios.Param.CCCLvFmt = String(MageStudios.Parameters['Class Level Format']);
MageStudios.Param.CCCLvFontSize = Number(MageStudios.Parameters['Class Level Font Size']);

//=============================================================================
// DataManager
//=============================================================================

MageStudios.CCC.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function() {
    if (!MageStudios.CCC.DataManager_isDatabaseLoaded.call(this)) return false;
    if (!MageStudios._loaded_MSEP_ClassChangeCore) {
      this.processCCCNotetags1($dataClasses);
      this.processCCCNotetags2($dataActors);
      this.processCCCNotetags3($dataClasses);
      MageStudios._loaded_MSEP_ClassChangeCore = true;
    }
    return true;
};
...
DataManager.processCCCNotetags2 = function(group) {
  ...
  for (var n = 1; n < group.length; n++) {
    ...
    obj.unlockedClasses = obj.unlockedClasses.filter(MageStudios.Util.onlyUnique);
  }
};
...
DataManager.processCCCNotetags3 = function(group) {
  for (var n = 1; n < group.length; n++) {
    ...
    obj.iconIndex = MageStudios.Icon.DefaultClass;
...
MageStudios.CCC.Game_System_initialize = Game_System.prototype.initialize;
Game_System.prototype.initialize = function() {
    MageStudios.CCC.Game_System_initialize.call(this);
    this.initClasses();
};

Game_System.prototype.initClasses = function() {
    this._showClass = MageStudios.Param.CCCShowCmd;
    this._enableClass = MageStudios.Param.CCCEnableCmd;
    this._showClassChange = MageStudios.Param.CCCShowClass;
    this._enableClassChange = MageStudios.Param.CCCEnableClass;
};
...
MageStudios.CCC.Game_Actor_setup = Game_Actor.prototype.setup;
Game_Actor.prototype.setup = function(actorId) {
    MageStudios.CCC.Game_Actor_setup.call(this, actorId);
    this.initClasses();
};
...
MageStudios.CCC.Game_Actor_turnEndOnMap = Game_Actor.prototype.turnEndOnMap;
Game_Actor.prototype.turnEndOnMap = function() {
    $gameTemp._noUpdateUnlockedSkills = true;
    MageStudios.CCC.Game_Actor_turnEndOnMap.call(this);
    $gameTemp._noUpdateUnlockedSkills = undefined;
};

MageStudios.CCC.Game_Actor_refresh = Game_Actor.prototype.refresh;
Game_Actor.prototype.refresh = function() {
    this.updateUnlockedClassSkills();
    MageStudios.CCC.Game_Actor_refresh.call(this);
};
...
Game_Actor.prototype.unlockedClasses = function() {
    ...
    return classes.filter(MageStudios.Util.onlyUnique);
};
...
MageStudios.CCC.Game_Actor_changeClass = Game_Actor.prototype.changeClass;
Game_Actor.prototype.changeClass = function(classId, keepExp) {
    keepExp = MageStudios.Param.CCCMaintainLv;
    if (keepExp) {
      this._exp[classId] = this._exp[this._classId];
      keepExp = false;
    }
    MageStudios.CCC.Game_Actor_changeClass.call(this, classId, keepExp);
...
Game_Actor.prototype.classLevel = function(classId) {
    if (MageStudios.Param.CCCMaintainLv) return this.level;
...
MageStudios.CCC.Game_Actor_setCharacterImage =
...
Game_Actor.prototype.setCharacterImage = function(name, index) {
    if (name !== '') {
      ...
      MageStudios.CCC.Game_Actor_setCharacterIMageStudios.call(this, name, index);
    }
};

MageStudios.CCC.Game_Actor_characterName = Game_Actor.prototype.characterName;
Game_Actor.prototype.characterName = function() {
    ...
    return MageStudios.CCC.Game_Actor_characterName.call(this);
};

MageStudios.CCC.Game_Actor_characterIndex = Game_Actor.prototype.characterIndex;
Game_Actor.prototype.characterIndex = function() {
    ...
    return MageStudios.CCC.Game_Actor_characterIndex.call(this);
};

MageStudios.CCC.Game_Actor_setFaceImage = Game_Actor.prototype.setFaceImage;
Game_Actor.prototype.setFaceImage = function(name, index) {
    if (name !== '') {
      ...
      MageStudios.CCC.Game_Actor_setFaceIMageStudios.call(this, name, index);
    }
};

MageStudios.CCC.Game_Actor_faceName = Game_Actor.prototype.faceName;
Game_Actor.prototype.faceName = function() {
    ...
    return MageStudios.CCC.Game_Actor_faceName.call(this);
};

MageStudios.CCC.Game_Actor_faceIndex = Game_Actor.prototype.faceIndex;
Game_Actor.prototype.faceIndex = function() {
    ...
    return MageStudios.CCC.Game_Actor_faceIndex.call(this);
};

MageStudios.CCC.Game_Actor_setBattlerImage = Game_Actor.prototype.setBattlerImage;
Game_Actor.prototype.setBattlerImage = function(name) {
    if (name !== '') {
      this._priorityBattlerName = name;
    } else {
      this._priorityBattlerName = undefined;
      MageStudios.CCC.Game_Actor_setBattlerIMageStudios.call(this, name);
    }
};

MageStudios.CCC.Game_Actor_battlerName = Game_Actor.prototype.battlerName;
Game_Actor.prototype.battlerName = function() {
    ...
    return MageStudios.CCC.Game_Actor_battlerName.call(this);
};
...
Game_Actor.prototype.checkLevelUnlockedClasses = function() {
    for (var i = 0; i < $dataClasses.length; ++i) {
      ...
      if (MageStudios.Util.isEmptyObj(item.levelUnlockRequirements)) continue;
...
MageStudios.CCC.Game_Actor_releaseUnequippableItems =
    Game_Actor.prototype.releaseUnequippableItems;
Game_Actor.prototype.releaseUnequippableItems = function(forcing) {
    if (MageStudios.CCC.PreventReleaseItem) return;
    MageStudios.CCC.Game_Actor_releaseUnequippableItems.call(this, forcing);
};
...
MageStudios.CCC.Game_Party_initialize = Game_Party.prototype.initialize;
Game_Party.prototype.initialize = function() {
    MageStudios.CCC.Game_Party_initialize.call(this);
    this.initClasses();
};

Game_Party.prototype.initClasses = function() {
    this._unlockedClasses = MageStudios.Param.CCCUnlock.slice();
    this._unlockedClasses.sort(function(a, b) { return a - b });
};
...
MageStudios.CCC.Game_Interpreter_pluginCommand =
    Game_Interpreter.prototype.pluginCommand;
Game_Interpreter.prototype.pluginCommand = function(command, args) {
    MageStudios.CCC.Game_Interpreter_pluginCommand.call(this, command, args)
...
MageStudios.CCC.Window_SkillStatus_refresh =
...
Window_SkillStatus.prototype.refresh = function() {
    ...
    MageStudios.CCC.Window_SkillStatus_refresh.call(this);
};
...
MageStudios.CCC.Window_MenuCommand_addOriginalCommands =
    Window_MenuCommand.prototype.addOriginalCommands;
Window_MenuCommand.prototype.addOriginalCommands = function() {
    MageStudios.CCC.Window_MenuCommand_addOriginalCommands.call(this);
    if (MageStudios.Param.CCCAutoAdd) this.addClassCommand();
};

Window_MenuCommand.prototype.addClassCommand = function() {
    if (!MageStudios.Param.CCCAutoPlace) return;
    if (!$gameSystem.isShowClass()) return;
    if (this.findSymbol('class') > -1) return;
    var text = MageStudios.Param.CCCCmdName;
...
Window_ClassCommand.prototype.itemTextAlign = function() {
    return MageStudios.Param.CCCTextAlign;
};
...
Window_ClassCommand.prototype.addClassCommand = function() {
    ...
    this.addCommand(MageStudios.Param.CCCClassCmd, 'class', enabled);
};
...
Window_ClassCommand.prototype.addSkillLearnCommand = function() {
    if (!Imported.MSEP_SkillLearnSystem) return;
    if (!MageStudios.Param.CCCShowLearn) return;
    var name = MageStudios.Param.SLSCommand;
    if (MageStudios.Param.SLSIntegrate) name = TextManager.skill;
...
Window_ClassCommand.prototype.addFinishCommand = function() {
    this.addCommand(MageStudios.Param.CCCFinishCmd, 'cancel', true);
};
...
Window_ClassList.prototype.changeClassNameColor = function(item) {
    if (item === this._actor.currentClass()) {
      this.changeTextColor(this.textColor(MageStudios.Param.CCCClassColor));
    } else {
...
Window_ClassList.prototype.drawClassLevel = function(item, x, y, width) {
    var level = MageStudios.Util.toGroup(this._actor.classLevel(item.id));
    var fmt = MageStudios.Param.CCCLvFmt;
    var text = fmt.format(level);
    this.resetFontSettings();
    this.changeTextColor(this.normalColor());
    this.contents.fontSize = MageStudios.Param.CCCLvFontSize;
...
MageStudios.CCC.Scene_Menu_createCommandWindow =
    Scene_Menu.prototype.createCommandWindow;
Scene_Menu.prototype.createCommandWindow = function() {
    MageStudios.CCC.Scene_Menu_createCommandWindow.call(this);
    this._commandWindow.setHandler('class', this.commandPersonal.bind(this));
};

MageStudios.CCC.Scene_Menu_onPersonalOk = Scene_Menu.prototype.onPersonalOk;
Scene_Menu.prototype.onPersonalOk = function() {
    if (this._commandWindow.currentSymbol() === 'class') {
      SceneManager.push(Scene_Class);
    } else {
      MageStudios.CCC.Scene_Menu_onPersonalOk.call(this);
    }
};
...
Scene_Class.prototype.commandLearnSkill = function() {
    if (MageStudios.Param.SLSIntegrate) {
...
Scene_Class.prototype.onItemOk = function() {
    ...
    this.actor().changeClass(classId, MageStudios.Param.CCCMaintainLv);
...
MageStudios.Util.isEmptyObj = function(obj) {
    var key;
    for (key in obj) {
      return false;
    }
