...
Imported.MSEP_Taunt = true;

var MageStudios = MageStudios || {};
MageStudios.Taunt = MageStudios.Taunt || {};
MageStudios.Taunt.version = 1.0;
...
MageStudios.Taunt.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function () {
  if (!MageStudios.Taunt.DataManager_isDatabaseLoaded.call(this)) return false;
  if (!MageStudios._loaded_MSEP_Taunt) {
    ...
    MageStudios._loaded_MSEP_Taunt = true;
  }
  return true;
};
...
MageStudios.Taunt.Game_Unit_aliveMembers = Game_Unit.prototype.aliveMembers;
Game_Unit.prototype.aliveMembers = function () {
  if (this._inBattle && $gameTemp._taunt) return this.tauntMembers();
  return MageStudios.Taunt.Game_Unit_aliveMembers.call(this);
};
...
MageStudios.Taunt.Game_Action_makeTargets = Game_Action.prototype.makeTargets;
Game_Action.prototype.makeTargets = function () {
  if (this.isValid() && this.isTauntable()) {
    $gameTemp._taunt = true;
    $gameTemp._tauntAction = this;
  }
  var value = MageStudios.Taunt.Game_Action_makeTargets.call(this);
  if (this.isValid() && this.isTauntable()) {
...
MageStudios.Taunt.Game_Action_targetsForOpponents =
  Game_Action.prototype.targetsForOpponents;
Game_Action.prototype.targetsForOpponents = function () {
  var targets = MageStudios.Taunt.Game_Action_targetsForOpponents.call(this);
...
MageStudios.Taunt.Scene_Battle_selectEnemySelection =
  Scene_Battle.prototype.selectEnemySelection;
Scene_Battle.prototype.selectEnemySelection = function () {
  $gameTemp._taunt = true;
  MageStudios.Taunt.Scene_Battle_selectEnemySelection.call(this);
  $gameTemp._taunt = false;
};
