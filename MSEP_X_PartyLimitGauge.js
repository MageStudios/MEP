//=============================================================================
// Mage Studios Engine Plugins - Skill Core Extension - Party Limit Gauge
// MSEP_X_PartyLimitGauge.js
//=============================================================================

var Imported = Imported || {};
Imported.MSEP_X_PartyLimitGauge = true;
 ...
 * @parent ---Limit Gain---
 * @desc Formula for how much Party Limit Gauge is gained
 * whenever a party member takes HP daMageStudios.
 * @default Math.floor(25 * damage / user.mhp).clamp(10, 25)
 *
 * @param Deal HP Damage
 * @parent ---Limit Gain---
 * @desc Formula for how much Party Limit Gauge is gained
 * whenever a party member deals HP daMageStudios.
 ...
 * @parent ---Limit Gain---
 * @desc Formula for how much Party Limit Gauge is gained
 * whenever a party member takes MP daMageStudios.
 * @default Math.floor(25 * damage / user.mmp).clamp(10, 25)
 *
 * @param Deal MP Damage
 * @parent ---Limit Gain---
 * @desc Formula for how much Party Limit Gauge is gained
 * whenever a party member deals MP daMageStudios.
 ...
 * ============================================================================
 *
 * This plugin requires MSEP_SkillCore.
 * Make sure this plugin is located under MSEP_SkillCore in the plugin list.
 *
...
MageStudios.Param.PLGIncrements = Math.max(1, MageStudios.Param.PLGIncrements);
MageStudios.Param.PLGIncrements = Math.floor(MageStudios.Param.PLGIncrements);
MageStudios.Param.PLGTextSize = Number(MageStudios.Parameters['Party Text Size']);
MageStudios.Param.PLGDrawIcon = eval(String(MageStudios.Parameters['Draw Cost Icon']));
MageStudios.Param.PLGCostColor = Number(MageStudios.Parameters['Cost Color']);
MageStudios.Param.PLGCostFmt = String(MageStudios.Parameters['Cost Format']);
MageStudios.Param.PLGCostSize = Number(MageStudios.Parameters['Cost Font Size']);

MageStudios.Param.PLGShowParty = eval(String(MageStudios.Parameters['Show Party Gauge']));
MageStudios.Param.PLGPerParty = String(MageStudios.Parameters['Per Party Member']);
MageStudios.Param.PLGPartyBonus = String(MageStudios.Parameters['Party Max Bonus']);
MageStudios.Param.PLGPartyX = String(MageStudios.Parameters['Party Gauge X']);
MageStudios.Param.PLGPartyY = String(MageStudios.Parameters['Party Gauge Y']);
MageStudios.Param.PLGPartyWidth = String(MageStudios.Parameters['Party Width']);
MageStudios.Param.PLGPartyColor1 = Number(MageStudios.Parameters['Party Gauge Color 1']);
MageStudios.Param.PLGPartyColor2 = Number(MageStudios.Parameters['Party Gauge Color 2']);
MageStudios.Param.PLGPartyIcon = Number(MageStudios.Parameters['Party Gauge Icon']);
MageStudios.Param.PLGPartyAlign = String(MageStudios.Parameters['Party Icon Align']);
MageStudios.Param.PLGPartyBufferX = Number(MageStudios.Parameters['Party Text Buffer X']);
MageStudios.Param.PLGPartyBufferY = Number(MageStudios.Parameters['Party Text Buffer Y']);

MageStudios.Param.PLGShowTroop = eval(String(MageStudios.Parameters['Show Troop Gauge']));
MageStudios.Param.PLGPerTroop = String(MageStudios.Parameters['Per Troop Member']);
MageStudios.Param.PLGTroopBonus = String(MageStudios.Parameters['Troop Max Bonus']);
MageStudios.Param.PLGTroopX = String(MageStudios.Parameters['Troop Gauge X']);
MageStudios.Param.PLGTroopY = String(MageStudios.Parameters['Troop Gauge Y']);
MageStudios.Param.PLGTroopWidth = String(MageStudios.Parameters['Troop Width']);
MageStudios.Param.PLGTroopColor1 = Number(MageStudios.Parameters['Troop Gauge Color 1']);
MageStudios.Param.PLGTroopColor2 = Number(MageStudios.Parameters['Troop Gauge Color 2']);
MageStudios.Param.PLGTroopIcon = Number(MageStudios.Parameters['Troop Gauge Icon']);
MageStudios.Param.PLGTroopAlign = String(MageStudios.Parameters['Troop Icon Align']);
MageStudios.Param.PLGTroopBufferX = Number(MageStudios.Parameters['Troop Text Buffer X']);
MageStudios.Param.PLGTroopBufferY = Number(MageStudios.Parameters['Troop Text Buffer Y']);

MageStudios.Param.PLGReset = eval(String(MageStudios.Parameters['Reset Gauge']));
MageStudios.Param.PLGBattleStart = String(MageStudios.Parameters['Battle Start']);
MageStudios.Param.PLGTakeHpDmg = String(MageStudios.Parameters['Take HP Damage']);
MageStudios.Param.PLGDealHpDmg = String(MageStudios.Parameters['Deal HP Damage']);
MageStudios.Param.PLGHealHpDmg = String(MageStudios.Parameters['Heal HP Damage']);
MageStudios.Param.PLGTakeMpDmg = String(MageStudios.Parameters['Take MP Damage']);
MageStudios.Param.PLGDealMpDmg = String(MageStudios.Parameters['Deal MP Damage']);
MageStudios.Param.PLGHealMpDmg = String(MageStudios.Parameters['Heal MP Damage']);
MageStudios.Param.PLGGainState = String(MageStudios.Parameters['Gain State']);
MageStudios.Param.PLGDealState = String(MageStudios.Parameters['Deal State']);
MageStudios.Param.PLGKillAlly = String(MageStudios.Parameters['Killed Ally']);
MageStudios.Param.PLGKillFoe = String(MageStudios.Parameters['Killed Foe']);
MageStudios.Param.PLGBattleWin = String(MageStudios.Parameters['Win Battle']);
MageStudios.Param.PLGBattleFlee = String(MageStudios.Parameters['Flee Battle']);
MageStudios.Param.PLGBattleLose = String(MageStudios.Parameters['Lose Battle']);

//=============================================================================
// DataManager
//=============================================================================

MageStudios.PLG.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function() {
  if (!MageStudios.PLG.DataManager_isDatabaseLoaded.call(this)) return false;
  if (!MageStudios._loaded_MSEP_X_PartyLimitGauge) {
    ...
    MageStudios._loaded_MSEP_X_PartyLimitGauge = true;
  }
  return true;
};
...
DataManager.processPLGNotetags1 = function(group, isActor) {
  for (var n = 1; n < group.length; n++) {
    ...
    if (isActor) {
      obj.partyLimitGaugeMax = MageStudios.Param.PLGPerParty;
    } else {
      obj.partyLimitGaugeMax = MageStudios.Param.PLGPerTroop;
    }
...
MageStudios.PLG.BattleManager_endBattle = BattleManager.endBattle;
BattleManager.endBattle = function(result) {
    if (result === 0) {
      var formula = MageStudios.Param.PLGBattleWin;
    } else if (result === 1) {
      var formula = MageStudios.Param.PLGBattleFlee;
    } else {
      var formula = MageStudios.Param.PLGBattleLose;
    }
    $gameParty.processPartyLimitGaugeEval(formula, null, null, null, 0);
    MageStudios.PLG.BattleManager_endBattle.call(this, result);
};
...
MageStudios.PLG.Game_System_initialize = Game_System.prototype.initialize;
Game_System.prototype.initialize = function() {
    MageStudios.PLG.Game_System_initialize.call(this);
    this.initPartyLimitGauge();
};

Game_System.prototype.initPartyLimitGauge = function() {
    this._showPartyLimitGauge = MageStudios.Param.PLGShowParty;
    this._showTroopLimitGauge = MageStudios.Param.PLGShowTroop;
};
...
MageStudios.PLG.Game_BattlerBase_refresh = Game_BattlerBase.prototype.refresh;
Game_BattlerBase.prototype.refresh = function() {
    this._partyLimitGaugeMax = undefined;
    MageStudios.PLG.Game_BattlerBase_refresh.call(this);
};

MageStudios.PLG.Game_BattlerBase_canPaySkillCost =
    Game_BattlerBase.prototype.canPaySkillCost;
Game_BattlerBase.prototype.canPaySkillCost = function(skill) {
    if (!this.canPayPartyLimitCost(skill)) return false;
    return MageStudios.PLG.Game_BattlerBase_canPaySkillCost.call(this, skill);
};
...
Game_BattlerBase.prototype.partyLimitCost = function(skill) {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, 'PARTY LIMIT COST ERROR');
    }
    return Math.ceil(cost * this.partyLimitCostRate());
};

MageStudios.PLG.Game_BattlerBase_paySkillCost =
    Game_BattlerBase.prototype.paySkillCost;
Game_BattlerBase.prototype.paySkillCost = function(skill) {
    MageStudios.PLG.Game_BattlerBase_paySkillCost.call(this, skill);
...
MageStudios.PLG.Game_Battler_addState = Game_Battler.prototype.addState;
Game_Battler.prototype.addState = function(stateId) {
  ...
  MageStudios.PLG.Game_Battler_addState.call(this, stateId);
  if ($gameParty.inBattle()) {
...
Game_Battler.prototype.chargePlGByDeath = function() {
    ...
    if (user && target && user.isEnemy() && target.isEnemy()) return;
    if (target) {
      formula = MageStudios.Param.PLGKillAlly;
      var unit = target.friendsUnit();
      unit.processPartyLimitGaugeEval(formula, user, target, null, 0);
    }
    if (user) {
      formula = MageStudios.Param.PLGKillFoe;
      var unit = user.friendsUnit();
      unit.processPartyLimitGaugeEval(formula, user, target, null, 0);
    }
};
...
Game_Actor.prototype.basePartyLimitGaugeMax = function() {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, 'BASE PARTY LIMIT GAUGE FORMULA ERROR');
      return 0;
    }
};
...
Game_Enemy.prototype.basePartyLimitGaugeMax = function() {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, 'PARTY LIMIT GAUGE FORMULA MAX ERROR');
      return 0;
    }
};
...
MageStudios.PLG.Game_Action_executeHpDamage = Game_Action.prototype.executeHpDamage;
Game_Action.prototype.executeHpDamage = function(target, value) {
    MageStudios.PLG.Game_Action_executeHpDaMageStudios.call(this, target, value);
    var user = this.subject();
    var dmg = target.result().hpDamage;
    if (dmg > 0) {
      target.friendsUnit().processPartyLimitGaugeEval(MageStudios.Param.PLGTakeHpDmg,
        user, target, this.item(), dmg);
      user.friendsUnit().processPartyLimitGaugeEval(MageStudios.Param.PLGDealHpDmg,
        user, target, this.item(), dmg);
    } else {
      target.friendsUnit().processPartyLimitGaugeEval(MageStudios.Param.PLGHealHpDmg,
        user, target, this.item(), dmg);
    }
};

MageStudios.PLG.Game_Action_executeMpDamage = Game_Action.prototype.executeMpDamage;
Game_Action.prototype.executeMpDamage = function(target, value) {
    MageStudios.PLG.Game_Action_executeMpDaMageStudios.call(this, target, value);
    var user = this.subject();
    var dmg = target.result().mpDamage;
    if (dmg > 0) {
      target.friendsUnit().processPartyLimitGaugeEval(MageStudios.Param.PLGTakeMpDmg,
        user, target, this.item(), dmg);
      user.friendsUnit().processPartyLimitGaugeEval(MageStudios.Param.PLGDealMpDmg,
        user, target, this.item(), dmg);
    } else {
      target.friendsUnit().processPartyLimitGaugeEval(MageStudios.Param.PLGHealMpDmg,
        user, target, this.item(), dmg);
    }
};

MageStudios.PLG.Game_Action_applyItemUserEffect =
    Game_Action.prototype.applyItemUserEffect;
Game_Action.prototype.applyItemUserEffect = function(target) {
    MageStudios.PLG.Game_Action_applyItemUserEffect.call(this, target);
...
Game_Action.prototype.partyGaugeGainEval = function(f1, c1, c2, value) {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, f1, 'PARTY GAUGE GAIN EVAL ERROR');
    }
    return value;
};
...
MageStudios.PLG.Game_Unit_initialize = Game_Unit.prototype.initialize;
Game_Unit.prototype.initialize = function() {
    MageStudios.PLG.Game_Unit_initialize.call(this);
    this.initPartyLimitGauge();
};

MageStudios.PLG.Game_Unit_onBattleStart = Game_Unit.prototype.onBattleStart;
Game_Unit.prototype.onBattleStart = function() {
    MageStudios.PLG.Game_Unit_onBattleStart.call(this);
    this._needPartyLimitRefresh = true;
    if (this.resetPartyLimitGauge()) this.setPartyLimitGauge(0);
    this.processPartyLimitGaugeEval(MageStudios.Param.PLGBattleStart);
};
...
Game_Unit.prototype.setPartyLimitGauge = function(value) {
    ...
    max *= MageStudios.Param.PLGIncrements;
...
Game_Unit.prototype.setPartyLimitGaugeIncrement = function(value) {
    if (this._partyLimit === undefined) this.initPartyLimitGauge();
    value *= MageStudios.Param.PLGIncrements;
...
Game_Unit.prototype.partyLimitGaugeMax = function(value) {
    ...
    return Math.max(value, MageStudios.Param.PLGIncrements);
};
...
Game_Unit.prototype.partyLimitGaugeCurrent = function() {
    ...
    value = Math.floor(value / MageStudios.Param.PLGIncrements);
    return value;
};
...
Game_Unit.prototype.partyLimitGaugeLastRates = function() {
    ...
    value -= this.partyLimitGaugeCurrent() * MageStudios.Param.PLGIncrements;
    value /= MageStudios.Param.PLGIncrements;
    rates.push(value);
...
Game_Unit.prototype.processPartyLimitGaugeEval = function(f1, c1, c2, c3, dmg) {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, f1, 'PARTY LIMIT GAUGE GAIN ERROR');
      var value = 0;
    }
    this.gainPartyLimitGauge(value)
};
...
Game_Party.prototype.partyLimitGaugeMaxBonus = function() {
  if (this._partyLimitGaugeMaxBonus === undefined) {
    var s = $gameSwitches._data;
    var v = $gameVariables._data;
    var code = MageStudios.Param.PLGPartyBonus;
    try {
      this._partyLimitGaugeMaxBonus = eval(code);
    } catch (e) {
      this._partyLimitGaugeMaxBonus = 0;
      MageStudios.Util.displayError(e, code, 'PARTY LIMIT GAUGE MAX ERROR');
    }
  }
...
Game_Troop.prototype.partyLimitGaugeMaxBonus = function() {
  if (this._partyLimitGaugeMaxBonus === undefined) {
    var s = $gameSwitches._data;
    var v = $gameVariables._data;
    var code = MageStudios.Param.PLGTroopBonus;
    try {
      this._partyLimitGaugeMaxBonus = eval(code);
    } catch (e) {
      this._partyLimitGaugeMaxBonus = 0;
      MageStudios.Util.displayError(e, code, 'PARTY LIMIT GAUGE MAX BONUS ERROR');
    }
  }
  return this._partyLimitGaugeMaxBonus;
};
...
MageStudios.PLG.Game_Interpreter_pluginCommand =
    Game_Interpreter.prototype.pluginCommand;
Game_Interpreter.prototype.pluginCommand = function(command, args) {
  MageStudios.PLG.Game_Interpreter_pluginCommand.call(this, command, args);
...
Window_Base.prototype.drawPartyLimitValue = function(unit, x, y, w, h) {
    ...
    var value = MageStudios.Util.toGroup(unit.partyLimitGaugeCurrent());
...
Window_PartyLimitGauge.prototype.initialize = function(unit) {
    ...
    if (Imported.MSEP_BattleEngineCore) {
      this._lowerWindows = MageStudios.Param.BECLowerWindows;
    } else {
...
Window_PartyLimitGauge.prototype.standardFontSize = function() {
    return MageStudios.Param.PLGTextSize;
};
...
Window_PartyLimitGauge.prototype.windowHeight = function() {
    var gaugeHeight = 6;
    if (Imported.MSEP_CoreEngine) gaugeHeight = MageStudios.Param.GaugeHeight;
...
MageStudios.PLG.Window_SkillList_drawTpCost = Window_SkillList.prototype.drawTpCost;
Window_SkillList.prototype.drawTpCost = function(skill, wx, wy, dw) {
    dw = this.drawPartyLimitCost(skill, wx, wy, dw);
    return MageStudios.PLG.Window_SkillList_drawTpCost.call(this, skill, wx, wy, dw);
};
...
Window_SkillList.prototype.drawPartyLimitCost = function(skill, wx, wy, dw) {
    ...
    if (MageStudios.Param.PLGDrawIcon && unit.partyLimitGaugeIcon() > 0) {
      var iw = wx + dw - Window_Base._iconWidth;
      var icon = unit.partyLimitGaugeIcon();
      this.drawIcon(icon, iw, wy + 2);
      dw -= Window_Base._iconWidth + 2;
    }
    this.changeTextColor(this.textColor(MageStudios.Param.PLGCostColor));
    var fmt = MageStudios.Param.PLGCostFmt;
    var cost = this._actor.partyLimitCost(skill);
    var text = fmt.format(MageStudios.Util.toGroup(cost),
      unit.partyLimitGaugeCurrent(), unit.partyLimitGaugeIncrements());
    this.contents.fontSize = MageStudios.Param.PLGCostSize;
...
MageStudios.PLG.Scene_Battle_createAllWindows =
    Scene_Battle.prototype.createAllWindows;
Scene_Battle.prototype.createAllWindows = function() {
    MageStudios.PLG.Scene_Battle_createAllWindows.call(this);
