...
if (Imported.MSEP_SkillCore) {
  ...
  MageStudios.Param.PLGIncrements = Number(
    MageStudios.Parameters["Gauge Increments"]
  );
  MageStudios.Param.PLGIncrements = Math.max(
    1,
    MageStudios.Param.PLGIncrements
  );
  MageStudios.Param.PLGIncrements = Math.floor(MageStudios.Param.PLGIncrements);
  MageStudios.Param.PLGTextSize = Number(
    MageStudios.Parameters["Party Text Size"]
  );
  MageStudios.Param.PLGDrawIcon = eval(
    String(MageStudios.Parameters["Draw Cost Icon"])
  );
  ...
  MageStudios.Param.PLGCostSize = Number(
    MageStudios.Parameters["Cost Font Size"]
  );

  MageStudios.Param.PLGShowParty = eval(
    String(MageStudios.Parameters["Show Party Gauge"])
  );
  MageStudios.Param.PLGPerParty = String(
    MageStudios.Parameters["Per Party Member"]
  );
  MageStudios.Param.PLGPartyBonus = String(
    MageStudios.Parameters["Party Max Bonus"]
  );
  ...
  MageStudios.Param.PLGPartyWidth = String(
    MageStudios.Parameters["Party Width"]
  );
  MageStudios.Param.PLGPartyColor1 = Number(
    MageStudios.Parameters["Party Gauge Color 1"]
  );
  MageStudios.Param.PLGPartyColor2 = Number(
    MageStudios.Parameters["Party Gauge Color 2"]
  );
  MageStudios.Param.PLGPartyIcon = Number(
    MageStudios.Parameters["Party Gauge Icon"]
  );
  MageStudios.Param.PLGPartyAlign = String(
    MageStudios.Parameters["Party Icon Align"]
  );
  MageStudios.Param.PLGPartyBufferX = Number(
    MageStudios.Parameters["Party Text Buffer X"]
  );
  MageStudios.Param.PLGPartyBufferY = Number(
    MageStudios.Parameters["Party Text Buffer Y"]
  );

  MageStudios.Param.PLGShowTroop = eval(
    String(MageStudios.Parameters["Show Troop Gauge"])
  );
  MageStudios.Param.PLGPerTroop = String(
    MageStudios.Parameters["Per Troop Member"]
  );
  MageStudios.Param.PLGTroopBonus = String(
    MageStudios.Parameters["Troop Max Bonus"]
  );
  ...
  MageStudios.Param.PLGTroopWidth = String(
    MageStudios.Parameters["Troop Width"]
  );
  MageStudios.Param.PLGTroopColor1 = Number(
    MageStudios.Parameters["Troop Gauge Color 1"]
  );
  MageStudios.Param.PLGTroopColor2 = Number(
    MageStudios.Parameters["Troop Gauge Color 2"]
  );
  MageStudios.Param.PLGTroopIcon = Number(
    MageStudios.Parameters["Troop Gauge Icon"]
  );
  MageStudios.Param.PLGTroopAlign = String(
    MageStudios.Parameters["Troop Icon Align"]
  );
  MageStudios.Param.PLGTroopBufferX = Number(
    MageStudios.Parameters["Troop Text Buffer X"]
  );
  MageStudios.Param.PLGTroopBufferY = Number(
    MageStudios.Parameters["Troop Text Buffer Y"]
  );

  MageStudios.Param.PLGReset = eval(
    String(MageStudios.Parameters["Reset Gauge"])
  );
  MageStudios.Param.PLGBattleStart = String(
    MageStudios.Parameters["Battle Start"]
  );
  MageStudios.Param.PLGTakeHpDmg = String(
    MageStudios.Parameters["Take HP Damage"]
  );
  MageStudios.Param.PLGDealHpDmg = String(
    MageStudios.Parameters["Deal HP Damage"]
  );
  MageStudios.Param.PLGHealHpDmg = String(
    MageStudios.Parameters["Heal HP Damage"]
  );
  MageStudios.Param.PLGTakeMpDmg = String(
    MageStudios.Parameters["Take MP Damage"]
  );
  MageStudios.Param.PLGDealMpDmg = String(
    MageStudios.Parameters["Deal MP Damage"]
  );
  MageStudios.Param.PLGHealMpDmg = String(
    MageStudios.Parameters["Heal MP Damage"]
  );
  ...
  MageStudios.Param.PLGBattleFlee = String(
    MageStudios.Parameters["Flee Battle"]
  );
  MageStudios.Param.PLGBattleLose = String(
    MageStudios.Parameters["Lose Battle"]
  );
    ...
    for (var n = 1; n < group.length; n++) {
      ...
      for (var i = 0; i < notedata.length; i++) {
        ...
        if (line.match(/<(?:PARTY LIMIT COST):[ ](\d+)>/i)) {
          ...
          obj.partyLimitGainFoeEval = obj.partyLimitGainFoeEval + line + "\n";
        }
      }
    }
  };
  ...
  Game_Actor.prototype.basePartyLimitGaugeMax = function () {
    ...
    try {
      ...
      MageStudios.Util.displayError(
        e,
        code,
        "BASE PARTY LIMIT GAUGE FORMULA ERROR"
      );
      return 0;
    }
  };
  ...
  Game_Enemy.prototype.basePartyLimitGaugeMax = function () {
    ...
    try {
      ...
      MageStudios.Util.displayError(
        e,
        code,
        "PARTY LIMIT GAUGE FORMULA MAX ERROR"
      );
      return 0;
    }
  };
  ...
  MageStudios.PLG.Game_Action_executeHpDamage =
    Game_Action.prototype.executeHpDamage;
  Game_Action.prototype.executeHpDamage = function (target, value) {
    MageStudios.PLG.Game_Action_executeHpDaMageStudios.call(
      this,
      target,
      value
    );
    ...
    if (dmg > 0) {
      target
        .friendsUnit()
        .processPartyLimitGaugeEval(
          MageStudios.Param.PLGTakeHpDmg,
          user,
          target,
          this.item(),
          dmg
      ...
      user
        .friendsUnit()
        .processPartyLimitGaugeEval(
          MageStudios.Param.PLGDealHpDmg,
          user,
          target,
          this.item(),
          dmg
      ...
      target
        .friendsUnit()
        .processPartyLimitGaugeEval(
          MageStudios.Param.PLGHealHpDmg,
          user,
          target,
          this.item(),
          dmg
  ...
  MageStudios.PLG.Game_Action_executeMpDamage =
    Game_Action.prototype.executeMpDamage;
  Game_Action.prototype.executeMpDamage = function (target, value) {
    MageStudios.PLG.Game_Action_executeMpDaMageStudios.call(
      this,
      target,
      value
    );
    ...
    if (dmg > 0) {
      target
        .friendsUnit()
        .processPartyLimitGaugeEval(
          MageStudios.Param.PLGTakeMpDmg,
          user,
          target,
          this.item(),
          dmg
      ...
      user
        .friendsUnit()
        .processPartyLimitGaugeEval(
          MageStudios.Param.PLGDealMpDmg,
          user,
          target,
          this.item(),
          dmg
      ...
      target
        .friendsUnit()
        .processPartyLimitGaugeEval(
          MageStudios.Param.PLGHealMpDmg,
          user,
          target,
          this.item(),
          dmg
  ...
  Game_Action.prototype.applyItemPartyGaugeEffect = function (target) {
    ...
    value = this.partyGaugeGainEval(
      this.item().partyLimitGainAllyEval,
      this.subject(),
      target,
      value
    );
    ...
    value = this.partyGaugeGainEval(
      this.item().partyLimitGainFoeEval,
      this.subject(),
      target,
      value
    );
  ...
  Game_Unit.prototype.processPartyLimitGaugeEval = function (
    f1,
    c1,
    c2,
    c3,
    ...
    if (this._partyLimitGaugeMaxBonus === undefined) {
      ...
      try {
        ...
        MageStudios.Util.displayError(
          e,
          code,
          "PARTY LIMIT GAUGE MAX BONUS ERROR"
        );
      }
    }
    return this._partyLimitGaugeMaxBonus;
  ...
  MageStudios.PLG.Window_SkillList_drawTpCost =
  ...
  Window_SkillList.prototype.drawTpCost = function (skill, wx, wy, dw) {
    ...
    return MageStudios.PLG.Window_SkillList_drawTpCost.call(
      this,
      skill,
      wx,
      wy,
