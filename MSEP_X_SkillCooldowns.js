...
if (Imported.MSEP_SkillCore) {
  ...
  Window_SkillList.prototype.drawCooldown = function (skill, wx, wy, dw) {
    ...
    this.changeTextColor(this.textColor(MageStudios.Param.CDTextColor));
    var fmt = MageStudios.Param.CDFmt;
  ...
  Window_SkillList.prototype.drawWarmup = function (skill, wx, wy, dw) {
    ...
    this.changeTextColor(this.textColor(MageStudios.Param.WUTextColor));
    var fmt = MageStudios.Param.WUFmt;
