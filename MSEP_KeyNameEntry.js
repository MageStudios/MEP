//=============================================================================
// Mage Studios Engine Plugins - Key Name Entry (American QWERTY English Keyboard)
// MSEP_KeyNameEntry.js
//=============================================================================

var Imported = Imported || {};
Imported.MSEP_KeyNameEntry = true;

var MageStudios = MageStudios || {};
MageStudios.KNE = MageStudios.KNE || {};
...
MageStudios.Param.KNEQwertyLayout = eval(MageStudios.Param.KNEQwertyLayout);

if (MageStudios.Param.KNEQwertyLayout) {
...
MageStudios.KNE.KeyboardSettingsAmericanEnglish = {
    8: 'backspace',
   13: 'enter',
   16: 'shift',
   32: 'space',
...
MageStudios.KNE.CheckKeysAmericanEnglish = [
...
MageStudios.KNE.Scene_Name_create = Scene_Name.prototype.create;
Scene_Name.prototype.create = function() {
  MageStudios.KNE.Scene_Name_create.call(this);
...
Scene_Name.prototype.setupKeyboard = function() {
  var setting = MageStudios.KNE.KeyboardSettingsAmericanEnglish;
  for (key in setting) {
    Input.keyMapper[key] = setting[key];
  }
};

MageStudios.KNE.Scene_Name_onInputOk = Scene_Name.prototype.onInputOk;
Scene_Name.prototype.onInputOk = function() {
  MageStudios.KNE.Scene_Name_onInputOk.call(this);
...
Window_NameInput.prototype.processKeyboardPress = function() {
  for (var i = 0; i < MageStudios.KNE.CheckKeysAmericanEnglish.length; ++i) {
    var key = MageStudios.KNE.CheckKeysAmericanEnglish[i];
