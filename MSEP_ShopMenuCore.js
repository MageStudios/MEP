//=============================================================================
// Mage Studios Engine Plugins - Shop Menu Core
// MSEP_ShopMenuCore.js
//=============================================================================

var Imported = Imported || {};
Imported.MSEP_ShopMenuCore = true;
 ...
 *
 * Version 1.04:
 * - Compatibility Update with MSEP_X_ItemPictureImg.js
 *
 * Version 1.03:
...
MageStudios.Param.ShopListWidth = String(MageStudios.Parameters['Shop List Width']);
MageStudios.Param.ShopCommandAlign = String(MageStudios.Parameters['Command Alignment']);

MageStudios.Param.ShopDefaultMode = String(MageStudios.Parameters['Default Mode']);
MageStudios.Param.ShopDefaultMode = MageStudios.Param.ShopDefaultMode.toLowerCase();
MageStudios.Param.ShopStatSwitch = eval(String(MageStudios.Parameters['Stat Switching']));
MageStudios.Param.ShopCantEquip = String(MageStudios.Parameters['Cannot Equip']);
MageStudios.Param.ShopStatFontSize = Number(MageStudios.Parameters['Stat Font Size']);
MageStudios.Param.ShopCantSize = Number(MageStudios.Parameters['Cannot Equip Font Size']);
...
MageStudios.Shop.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function() {
  if (!MageStudios.Shop.DataManager_isDatabaseLoaded.call(this)) return false;
  if (!MageStudios._loaded_MSEP_ShopMenuCore) {
    this.processShopNotetags($dataItems);
    this.processShopNotetags($dataWeapons);
    this.processShopNotetags($dataArmors);
    MageStudios._loaded_MSEP_ShopMenuCore = true;
  }
  return true;
};
...
Window_ShopCommand.prototype.makeCommandList = function() {
    this._commandOrder = MageStudios.Param.ShopCommandOrder.split(' ');
...
Window_ShopCommand.prototype.itemTextAlign = function() {
    return MageStudios.Param.ShopCommandAlign;
};
...
Window_ShopInfo.prototype.drawItemEntry = function() {
    var item = this._item;
    if (eval(MageStudios.Param.ItemShowIcon)) this.drawItemIcon(item);
...
Window_ShopNumber.prototype.windowWidth = function() {
    return Math.ceil(eval(MageStudios.Param.ShopListWidth));
};
...
Window_ShopNumber.prototype.drawTotalCurrency = function(ww, wy) {
    var value = MageStudios.Util.toGroup(this.getTotalCurrency());
...
Window_ShopNumber.prototype.cursorWidth = function() {
    ...
    var digitWidth = this.textWidth(MageStudios.Util.toGroup(value));
...
MageStudios.Shop.Window_ShopBuy_updateHelp = Window_ShopBuy.prototype.updateHelp;
Window_ShopBuy.prototype.updateHelp = function() {
    MageStudios.Shop.Window_ShopBuy_updateHelp.call(this);
...
MageStudios.Shop.Window_ShopSell_updateHelp = Window_ShopSell.prototype.updateHelp;
Window_ShopSell.prototype.updateHelp = function() {
    MageStudios.Shop.Window_ShopSell_updateHelp.call(this);
    if (this._infoWindow) this._infoWindow.setItem(this.item());
    if (this._statusWindow) this._statusWindow.setItem(this.item());
};

MageStudios.Shop.Window_ShopSell_isEnabled = Window_ShopSell.prototype.isEnabled;
Window_ShopSell.prototype.isEnabled = function(item) {
    ...
    return MageStudios.Shop.Window_ShopSell_isEnabled.call(this, item);
};
...
MageStudios.Shop.Window_ShopStatus_initialize = 
    Window_ShopStatus.prototype.initialize;
Window_ShopStatus.prototype.initialize = function(x, y, width, height) {
    MageStudios.Shop.Window_ShopStatus_initialize.call(this, x, y, width, height);
    if (MageStudios.Param.ShopStatSwitch) this._paramId = 2;
    this._displayMode = MageStudios.Param.ShopDefaultMode;
    this._actorIndex = 0;
...
Window_ShopStatus.prototype.drawStatDisplayed = function() {
    ...
    if (!MageStudios.Param.ShopStatSwitch) return;
    this.changeTextColor(this.systemColor());
    var text = '<<';
...
Window_ShopStatus.prototype.drawActorStatInfo = function(actor) {
    this.contents.fontSize = MageStudios.Param.ShopStatFontSize;
...
Window_ShopStatus.prototype.drawActorCantEquip = function(actor, rect) {
    this.changePaintOpacity(false);
    this.resetTextColor();
    this.contents.fontSize = MageStudios.Param.ShopCantSize;
    var text = '-';
...
Window_ShopStatus.prototype.drawActorChange = function(actor, rect, item1, i) {
    ...
    var text = (change > 0 ? '+' : '') + MageStudios.Util.toGroup(change);
    this.drawText(text, rect.x, rect.y, rect.width, 'right');
};
...
Window_ShopStatus.prototype.drawActorEquipInfo = function(x, y, actor) {
    ...
    if (enabled) {
      ...
      this.contents.fontSize = MageStudios.Param.ShopCantSize;
      var ww = this.contents.width - this.textPadding();
      this.drawText(MageStudios.Param.ShopCantEquip, x, y, ww, 'right');
    }
    this.changePaintOpacity(true);
};
...
MageStudios.Shop.Window_ShopStatus_update = Window_ShopStatus.prototype.update;
Window_ShopStatus.prototype.update = function() {
    MageStudios.Shop.Window_ShopStatus_update.call(this);
    if (this.isUpdateTrigger()) this.updateParamSwitch();
};

Window_ShopStatus.prototype.isUpdateTrigger = function() {
    if (this.isDefaultMode() && MageStudios.Param.ShopStatSwitch) return true;
...
MageStudios.Shop.Window_ShopStatus_paramId = Window_ShopStatus.prototype.paramId;
Window_ShopStatus.prototype.paramId = function() {
    if (MageStudios.Param.ShopStatSwitch) return this._paramId;
    return MageStudios.Shop.Window_ShopStatus_paramId.call(this);
};
...
Scene_Shop.prototype.createDummyWindow = function() {
    ...
    var ww = Math.ceil(eval(MageStudios.Param.ShopListWidth));
...
MageStudios.Shop.Scene_Shop_onBuyCancel = Scene_Shop.prototype.onBuyCancel;
Scene_Shop.prototype.onBuyCancel = function() {
    MageStudios.Shop.Scene_Shop_onBuyCancel.call(this);
    this._statusWindow.show();
    this._infoWindow.setItem(null);
};

Scene_Shop.prototype.doBuy = function(number) {
    if (Imported.MSEP_ItemCore) $gameTemp.enableVarianceStock();
    this.doBuyGold(number);
    this.doBuyItem(number);
    if (Imported.MSEP_ItemCore) $gameTemp.disableVarianceStock();
};
...
MageStudios.Shop.Scene_Shop_activateSellWindow = 
    Scene_Shop.prototype.activateSellWindow;
Scene_Shop.prototype.activateSellWindow = function() {
    MageStudios.Shop.Scene_Shop_activateSellWindow.call(this);
    this._statusWindow.show();
};

MageStudios.Shop.Scene_Shop_onSellCancel = Scene_Shop.prototype.onSellCancel;
Scene_Shop.prototype.onSellCancel = function() {
    MageStudios.Shop.Scene_Shop_onSellCancel.call(this);
    this._infoWindow.setItem(null);
};
...
MageStudios.Shop.Scene_Shop_sellingPrice = Scene_Shop.prototype.sellingPrice;
Scene_Shop.prototype.sellingPrice = function() {
    if (this._item && this._item.sellPrice !== undefined) {
      return this._item.sellPrice;
    }
    return MageStudios.Shop.Scene_Shop_sellingPrice.call(this);
};
