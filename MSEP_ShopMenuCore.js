...
MageStudios.Param.ShopCommandOrder = String(
  MageStudios.Parameters["Command Order"]
);
MageStudios.Param.ShopListWidth = String(
  MageStudios.Parameters["Shop List Width"]
);
MageStudios.Param.ShopCommandAlign = String(
  MageStudios.Parameters["Command Alignment"]
);

MageStudios.Param.ShopDefaultMode = String(
  MageStudios.Parameters["Default Mode"]
);
MageStudios.Param.ShopDefaultMode =
  MageStudios.Param.ShopDefaultMode.toLowerCase();
MageStudios.Param.ShopStatSwitch = eval(
  String(MageStudios.Parameters["Stat Switching"])
);
MageStudios.Param.ShopCantEquip = String(
  MageStudios.Parameters["Cannot Equip"]
);
MageStudios.Param.ShopStatFontSize = Number(
  MageStudios.Parameters["Stat Font Size"]
);
MageStudios.Param.ShopCantSize = Number(
  MageStudios.Parameters["Cannot Equip Font Size"]
);
...
if (Imported.MSEP_X_ItemPictureImg) {
  ...
  Window_ShopInfo.prototype.readyItemPictureImage = function (item) {
    ...
    if (bitmap.width <= 0) {
      return setTimeout(
        this.readyItemPictureIMageStudios.bind(this, item),
        250
      );
    } else {
...
MageStudios.Shop.Window_ShopBuy_updateHelp =
...
MageStudios.Shop.Window_ShopSell_updateHelp =
...
MageStudios.Shop.Window_ShopSell_isEnabled =
...
MageStudios.Shop.Window_ShopStatus_paramId =
