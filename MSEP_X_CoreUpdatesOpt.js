//=============================================================================
// Mage Studios Engine Plugins - Core Extension - Updates and Desktop Optimization
// MSEP_X_CoreUpdatesOpt.js
//=============================================================================

var Imported = Imported || {};
Imported.MSEP_X_CoreUpdatesOpt = true;
...
MageStudios.PluginRequirements = function() {
  return Imported.MSEP_CoreEngine &&
...
MageStudios.ParameterVersionCheck = function(version, key, parameter) {
  if (Utils.RPGMAKER_VERSION && Utils.RPGMAKER_VERSION === version) {
    MageStudios.Param[key] = false;
  } else if (Utils.RPGMAKER_VERSION && Utils.RPGMAKER_VERSION > version) {
    MageStudios.Param[key] = false;
  } else {
    MageStudios.Param[key] = eval(String(MageStudios.Parameters[parameter]));
  }
};

MageStudios.SetupParameters = function() {
  // Official Updates
  MageStudios.ParameterVersionCheck('1.1.0', 'Update110', '110_Updates');
  MageStudios.ParameterVersionCheck('1.2.0', 'Update120', '120_Updates');
  MageStudios.ParameterVersionCheck('1.3.0', 'Update130', '130_Updates');
  MageStudios.ParameterVersionCheck('1.3.1', 'Update131', '131_Updates');
  MageStudios.ParameterVersionCheck('1.3.2', 'Update132', '132_Updates');
  MageStudios.ParameterVersionCheck('1.3.3', 'Update133', '133_Updates');
  MageStudios.ParameterVersionCheck('1.3.4', 'Update134', '134_Updates');
  MageStudios.ParameterVersionCheck('1.4.0', 'Update140', '140_Updates');
  MageStudios.ParameterVersionCheck('1.5.0', 'Update150', '150_Updates');
  MageStudios.ParameterVersionCheck('1.5.1', 'Update151', '151_Updates');
  MageStudios.ParameterVersionCheck('1.5.2', 'Update152', '152_Updates');
  MageStudios.ParameterVersionCheck('1.6.1', 'Update161', '161_Updates');
  // Desktop Optimization
  MageStudios.Param.UpdateDesktop = eval(String(MageStudios.Parameters['Desktop_Updates']));
};
...
if (MageStudios.Param.Update110) {
...
if (MageStudios.Param.Update120) {
...
if (MageStudios.Param.Update130) {
...
Bitmap.load = function(url) {
    ...
    if(!Decrypter.checkImgIgnore(url) && Decrypter.hasEncryptedImages) {
        ...
        bitmap._iMageStudios.src = url;
        bitmap._iMageStudios.onload = Bitmap.prototype._onLoad.bind(bitmap);
        bitmap._iMageStudios.onerror = Bitmap.prototype._onError.bind(bitmap);
    }
...
Bitmap.prototype._onLoad = function() {
    if(Decrypter.hasEncryptedImages) {
        window.URL.revokeObjectURL(this._iMageStudios.src);
    }
    this._isLoading = false;
    this.resize(this._iMageStudios.width, this._iMageStudios.height);
...
Decrypter.decryptImg = function(url, bitmap) {
    ...
    requestFile.onload = function() {
        if(this.status < Decrypter._xhrOk) {
            ...
            bitmap._iMageStudios.src = Decrypter.createBlobUrl(arrayBuffer);
            bitmap._iMageStudios.onload = Bitmap.prototype._onLoad.bind(bitmap);
            bitmap._iMageStudios.onerror = Bitmap.prototype._onError.bind(bitmap);
        }
    };
...
if (MageStudios.Param.Update131) {
...
ScreenSprite.warnYep = function () {
    if (!ScreenSprite.YEPWarned) {
        console.log("Deprecation warning. Please update MSEP_CoreEngine. ScreenSprite is not a sprite, it has graphics inside.");
...
if (MageStudios.Param.Update132) {
...
if (MageStudios.Param.Update133) {
...
if (MageStudios.Param.Update134) {
...
if (MageStudios.Param.Update140) {
...
if (MageStudios.Param.Update150) {
...
Bitmap.prototype._createCanvas = function(width, height){
    ...
    if(this._image){
        var w = Math.max(this._iMageStudios.width || 0, 1);
        var h = Math.max(this._iMageStudios.height || 0, 1);
...
Bitmap.prototype._clearImgInstance = function(){
    this._iMageStudios.src = "";
    this._iMageStudios.onload = null;
    this._iMageStudios.onerror = null;
...
Bitmap.prototype._renewCanvas = function(){
    ...
    if(newImage && this.__canvas && (this.__canvas.width < newIMageStudios.width || this.__canvas.height < newIMageStudios.height)){
        this._createCanvas();
    }
};
...
Object.defineProperty(Bitmap.prototype, 'width', {
    get: function() {
        if(this.isReady()){
            return this._image? this._iMageStudios.width: this._canvas.width;
        }
...
Object.defineProperty(Bitmap.prototype, 'height', {
    get: function() {
        if(this.isReady()){
            return this._image? this._iMageStudios.height: this._canvas.height;
        }
...
Bitmap.prototype._onLoad = function() {
    this._iMageStudios.removeEventListener('load', this._loadListener);
    this._iMageStudios.removeEventListener('error', this._errorListener);
...
Bitmap.prototype.decode = function(){
    switch(this._loadingState){
        ...
        case 'requesting': case 'decrypting':
            ...
            if (!this._loader) {
                this._loader = ResourceHandler.createLoader(this._url, this._requestIMageStudios.bind(this, this._url), this._onError.bind(this));
                this._iMageStudios.removeEventListener('error', this._errorListener);
                this._iMageStudios.addEventListener('error', this._errorListener = this._loader);
            }
            break;
...
Bitmap.prototype._requestImage = function(url){
    ...
    if (this._decodeAfterRequest && !this._loader) {
        this._loader = ResourceHandler.createLoader(url, this._requestIMageStudios.bind(this, url), this._onError.bind(this));
    }
    ...
    if(!Decrypter.checkImgIgnore(url) && Decrypter.hasEncryptedImages) {
        ...
        this._iMageStudios.src = url;

        this._iMageStudios.addEventListener('load', this._loadListener = Bitmap.prototype._onLoad.bind(this));
        this._iMageStudios.addEventListener('error', this._errorListener = this._loader || Bitmap.prototype._onError.bind(this));
    }
};
...
Decrypter.decryptImg = function(url, bitmap) {
    ...
    requestFile.onload = function () {
        if(this.status < Decrypter._xhrOk) {
            var arrayBuffer = Decrypter.decryptArrayBuffer(requestFile.response);
            bitmap._iMageStudios.src = Decrypter.createBlobUrl(arrayBuffer);
            bitmap._iMageStudios.addEventListener('load', bitmap._loadListener = Bitmap.prototype._onLoad.bind(bitmap));
            bitmap._iMageStudios.addEventListener('error', bitmap._errorListener = bitmap._loader || Bitmap.prototype._onError.bind(bitmap));
        }
    };
...
if (MageStudios.Param.Update151) {
...
if (MageStudios.Param.Update152) {
...
if (MageStudios.Param.Update161) {
...
if (MageStudios.Param.UpdateDesktop) {

// Set up a flag to signify the Mage Desktop Optimization plugin is used.
// This is done for compatibility reasons.
Utils.RPGMAKER_VERSION.Mage = true;
...
}; // MageStudios.Param.UpdateDesktop
...
var text = '';
text += 'You are getting this error because you are trying to run MSEP_X_CoreUp';
