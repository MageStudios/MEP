...
if (Imported.MSEP_ItemCore) {
  if (MageStudios.Item.version && MageStudios.Item.version >= 1.26) {
    ...
    MageStudios.Param.ItemImageMaxWidth = Number(
      MageStudios.Parameters["Max Image Width"]
    );
    MageStudios.Param.ItemImageMaxHeight = Number(
      MageStudios.Parameters["Max Image Height"]
    );

    MageStudios.IPI.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
    DataManager.isDatabaseLoaded = function () {
      if (!MageStudios.IPI.DataManager_isDatabaseLoaded.call(this))
        return false;
    ...
    ItemManager.applyAugmentSetPictureImg = function (
      mainItem,
      img,
      slot,
      add
    ...
    ItemManager.applyAugmentSetPictureHue = function (
      mainItem,
      Hue,
      slot,
      add
