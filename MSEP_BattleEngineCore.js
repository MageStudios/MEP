//=============================================================================
// Mage Studios Engine Plugins - Battle Engine Core
// MSEP_BattleEngineCore.js
//=============================================================================
 ...
 * - New mechanic: Using Instant Skills/Items from MSEP_InstantCast.js will also
...
MageStudios.Parameters = PluginManager.parameters('MEP_BattleEngineCore');
...
MageStudios.Param.BECEscFail = String(MageStudios.Parameters['Fail Escape Boost']);
MageStudios.Param.CastCertHit = Number(MageStudios.Parameters['Certain Hit Animation']);
MageStudios.Param.CastPhysical = Number(MageStudios.Parameters['Physical Animation']);
MageStudios.Param.CastMagical = Number(MageStudios.Parameters['Magical Animation']);
MageStudios.Param.EnemyAtkAni = Number(MageStudios.Parameters['Enemy Attack Animation']);
MageStudios.Param.BECOptSpeed = String(MageStudios.Parameters['Optimize Speed']);
MageStudios.Param.BECOptSpeed = eval(MageStudios.Param.BECOptSpeed);
MageStudios.Param.BECEmergeText = String(MageStudios.Parameters['Show Emerge Text']);
MageStudios.Param.BECEmergeText = eval(MageStudios.Param.BECEmergeText);
MageStudios.Param.BECPreEmpText = String(MageStudios.Parameters['Show Pre-Emptive Text']);
MageStudios.Param.BECPreEmpText = eval(MageStudios.Param.BECPreEmpText);
MageStudios.Param.BECSurpText = String(MageStudios.Parameters['Show Surprise Text']);
MageStudios.Param.BECSurpText = eval(MageStudios.Param.BECSurpText);
MageStudios.Param.BECPopupOverlap = String(MageStudios.Parameters['Popup Overlap Rate']);
MageStudios.Param.BECPopupOverlap = eval(MageStudios.Param.BECPopupOverlap);
MageStudios.Param.BECNewPopBottom = String(MageStudios.Parameters['Newest Popup Bottom']);
MageStudios.Param.BECNewPopBottom = eval(MageStudios.Param.BECNewPopBottom);
MageStudios.Param.BECStartActCmd = String(MageStudios.Parameters['Start Actor Command']);
MageStudios.Param.BECStartActCmd = eval(MageStudios.Param.BECStartActCmd);
MageStudios.Param.BECCurMax = eval(String(MageStudios.Parameters['Current Max']));
MageStudios.Param.BECSelectHelp = String(MageStudios.Parameters['Select Help Window']);
MageStudios.Param.BECSelectHelp = eval(MageStudios.Param.BECSelectHelp);
MageStudios.Param.BECHelpUserTx = String(MageStudios.Parameters['User Help Text']);
MageStudios.Param.BECHelpAllyTx = String(MageStudios.Parameters['Ally Help Text']);
MageStudios.Param.BECHelpAlliesTx = String(MageStudios.Parameters['Allies Help Text']);
MageStudios.Param.BECHelpEnemyTx = String(MageStudios.Parameters['Enemy Help Text']);
MageStudios.Param.BECHelpEnemiesTx = String(MageStudios.Parameters['Enemies Help Text']);
MageStudios.Param.BECHelpAllTx = String(MageStudios.Parameters['All Help Text']);
MageStudios.Param.BECHelpRandTx = String(MageStudios.Parameters['Random Help Text']);
MageStudios.Param.BECFrontPosX = String(MageStudios.Parameters['Front Position X']);
MageStudios.Param.BECFrontPosY = String(MageStudios.Parameters['Front Position Y']);
MageStudios.Param.BECFrontSprite = String(MageStudios.Parameters['Front Actor Sprite']);
MageStudios.Param.BECFrontSprite = eval(MageStudios.Param.BECFrontSprite);
MageStudios.Param.BECFrSpPrio = String(MageStudios.Parameters['Front Sprite Priority']);
MageStudios.Param.BECHomePosX = String(MageStudios.Parameters['Home Position X']);
MageStudios.Param.BECHomePosY = String(MageStudios.Parameters['Home Position Y']);
MageStudios.Param.BECSideSpPrio = String(MageStudios.Parameters['Side Sprite Priority']);
MageStudios.Param.BECSideSpPrio = eval(MageStudios.Param.BECSideSpPrio);
MageStudios.Param.BECAnchorX = Number(MageStudios.Parameters['Default X Anchor']);
MageStudios.Param.BECAnchorY = Number(MageStudios.Parameters['Default Y Anchor']);
MageStudios.Param.BECStepDist = Number(MageStudios.Parameters['Step Distance']);
MageStudios.Param.BECFlinchDist = Number(MageStudios.Parameters['Flinch Distance']);
MageStudios.Param.BECShowShadows = String(MageStudios.Parameters['Show Shadows']);
MageStudios.Param.BECShowShadows = eval(MageStudios.Param.BECShowShadows);
MageStudios.Param.BECPopupDur = Number(MageStudios.Parameters['Popup Duration']);
MageStudios.Param.BECCritPopup = String(MageStudios.Parameters['Critical Popup']);
MageStudios.Param.BECCritDur = Number(MageStudios.Parameters['Critical Duration']);
MageStudios.Param.BECActionSpeed = String(MageStudios.Parameters['Action Speed']);
MageStudios.Param.BECReflectAni = Number(MageStudios.Parameters['Reflect Animation']);
MageStudios.Param.BECMotionWait = String(MageStudios.Parameters['Motion Waiting']);
MageStudios.Param.BECMotionWait = eval(MageStudios.Param.BECMotionWait);
MageStudios.Param.BECTimeStates = String(MageStudios.Parameters['Timed States']);
...
MageStudios.Param.BECAISelfTurn = eval(String(MageStudios.Parameters['AI Self Turns']));
MageStudios.Param.BECLowerWindows = String(MageStudios.Parameters['Lower Windows']);
MageStudios.Param.BECLowerWindows = eval(MageStudios.Param.BECLowerWindows);
MageStudios.Param.BECSelectMouseOver = eval(String(MageStudios.Parameters['Mouse Over']));
MageStudios.Param.BECEnemySelect = String(MageStudios.Parameters['Visual Enemy Select']);
MageStudios.Param.BECEnemySelect = eval(MageStudios.Param.BECEnemySelect);
MageStudios.Param.BECActorSelect = String(MageStudios.Parameters['Visual Actor Select']);
...
MageStudios.Param.BECEnemyFontSize = Number(MageStudios.Parameters['Enemy Font Size']);
MageStudios.Param.BECShowEnemyName = String(MageStudios.Parameters['Show Enemy Name']);
MageStudios.Param.BECShowEnemyName = eval(MageStudios.Param.BECShowEnemyName);
MageStudios.Param.BECShowSelectBox = String(MageStudios.Parameters['Show Select Box']);
MageStudios.Param.BECShowSelectBox = eval(MageStudios.Param.BECShowSelectBox);
MageStudios.Param.BECEnemyAutoSel = String(MageStudios.Parameters['Enemy Auto Select']);
MageStudios.Param.BECEnemyAutoSel = MageStudios.Param.BECEnemyAutoSel;
MageStudios.Param.BECCommandAlign = String(MageStudios.Parameters['Command Alignment']);
MageStudios.Param.BECCommandRows = Number(MageStudios.Parameters['Command Window Rows']);
MageStudios.Param.BECAniBaseDel = Number(MageStudios.Parameters['Animation Base Delay']);
MageStudios.Param.BECAniNextDel = Number(MageStudios.Parameters['Animation Next Delay']);

MageStudios.Param.BECFullActText = String(MageStudios.Parameters['Show Action Text']);
MageStudios.Param.BECFullActText = eval(MageStudios.Param.BECFullActText);
MageStudios.Param.BECShowCntText = String(MageStudios.Parameters['Show Counter Text']);
MageStudios.Param.BECShowCntText = eval(MageStudios.Param.BECShowCntText);
MageStudios.Param.BECShowRflText = String(MageStudios.Parameters['Show Reflect Text']);
MageStudios.Param.BECShowRflText = eval(MageStudios.Param.BECShowRflText);
MageStudios.Param.BECShowSubText = String(MageStudios.Parameters['Show Substitute Text']);
MageStudios.Param.BECShowSubText = eval(MageStudios.Param.BECShowSubText);
MageStudios.Param.BECShowFailText = String(MageStudios.Parameters['Show Fail Text']);
MageStudios.Param.BECShowFailText = eval(MageStudios.Param.BECShowFailText);
MageStudios.Param.BECShowCritText = String(MageStudios.Parameters['Show Critical Text']);
MageStudios.Param.BECShowCritText = eval(MageStudios.Param.BECShowCritText);
MageStudios.Param.BECShowMissText = String(MageStudios.Parameters['Show Miss Text']);
MageStudios.Param.BECShowMissText = eval(MageStudios.Param.BECShowMissText);
MageStudios.Param.BECShowEvaText = String(MageStudios.Parameters['Show Evasion Text']);
MageStudios.Param.BECShowEvaText = eval(MageStudios.Param.BECShowEvaText);
MageStudios.Param.BECShowHpText = String(MageStudios.Parameters['Show HP Text']);
MageStudios.Param.BECShowHpText = eval(MageStudios.Param.BECShowHpText);
MageStudios.Param.BECShowMpText = String(MageStudios.Parameters['Show MP Text']);
MageStudios.Param.BECShowMpText = eval(MageStudios.Param.BECShowMpText);
MageStudios.Param.BECShowTpText = String(MageStudios.Parameters['Show TP Text']);
MageStudios.Param.BECShowTpText = eval(MageStudios.Param.BECShowTpText);
MageStudios.Param.BECShowStateText = String(MageStudios.Parameters['Show State Text']);
MageStudios.Param.BECShowStateText = eval(MageStudios.Param.BECShowStateText);
MageStudios.Param.BECShowBuffText = String(MageStudios.Parameters['Show Buff Text']);
...
MageStudios.BEC.DefaultActionWhole = [
    ['PERFORM ACTION'],
];
MageStudios.BEC.DefaultActionTarget = [
    ['PERFORM ACTION'],
];
...
MageStudios.BEC.SeqType6 =
  /[ ]*(.*):[ ](.*),[ ](.*),[ ](.*),[ ](.*),[ ](.*),[ ](.*)/i;
MageStudios.BEC.SeqType5 =
  /[ ]*(.*):[ ](.*),[ ](.*),[ ](.*),[ ](.*),[ ](.*)/i;
MageStudios.BEC.SeqType4 =
  /[ ]*(.*):[ ](.*),[ ](.*),[ ](.*),[ ](.*)/i;
MageStudios.BEC.SeqType3 =
  /[ ]*(.*):[ ](.*),[ ](.*),[ ](.*)/i;
MageStudios.BEC.SeqType2 =
  /[ ]*(.*):[ ](.*),[ ](.*)/i;
MageStudios.BEC.SeqType1 =
  /[ ]*(.*):[ ](.*)/i;
MageStudios.BEC.SeqType0 =
  /[ ]*(.*)/i;
...
BattleManager.invokeMagicReflection = function(subject, target) {
    MageStudios.BEC.BattleManager_invokeMagicReflection.call(this, subject, target);
    if (subject.isDead()) subject.performCollapse();
};
  ...
  if (actionName.match(/ELSE[ ]IF[ ](.*)/i)) {
    ...
    if (this._conditionFlags[ci]) {
      ...
      try {
        ...
        MageStudios.Util.displayError(e, text, 'ACTION SEQUENCE IF CONDITION ERROR');
        this._conditionFlags[ci] = false;
...
BattleManager.actionImmortal = function(actionArgs) {
    var targets =
      this.makeActionTargets(actionArgs[0]).filter(MageStudios.Util.onlyUnique);
    try {
...
MageStudios.BEC.Sprite_Battler_initMembers = Sprite_Battler.prototype.initMembers;
...
MageStudios.BEC.Sprite_Actor_refreshMotion = Sprite_Actor.prototype.refreshMotion;
...
MageStudios.BEC.Sprite_Damage_initialize = Sprite_DaMageStudios.prototype.initialize;
...
MageStudios.BEC.Sprite_StateOverlay_update = Sprite_StateOverlay.prototype.update;
...
MageStudios.BEC.Game_Temp_clearCommonEvent = Game_Temp.prototype.clearCommonEvent;
...
MageStudios.BEC.Game_Action_needsSelection = Game_Action.prototype.needsSelection;
...
MageStudios.BEC.Game_BattlerBase_recoverAll = Game_BattlerBase.prototype.recoverAll;
...
MageStudios.BEC.Game_Battler_onBattleStart = Game_Battler.prototype.onBattleStart;
...
MageStudios.BEC.Game_Battler_regenerateAll = Game_Battler.prototype.regenerateAll;
...
MageStudios.BEC.Game_Battler_startAnimation = Game_Battler.prototype.startAnimation;
Game_Battler.prototype.startAnimation = function(animationId, mirror, delay) {
  if (!$dataAnimations[animationId]) return;
  MageStudios.BEC.Game_Battler_startAnimation.call(this, animationId, mirror, delay);
};
...
MageStudios.BEC.Scene_Battle_onActorCancel = Scene_Battle.prototype.onActorCancel;
...
MageStudios.BEC.Scene_Battle_onEnemyCancel = Scene_Battle.prototype.onEnemyCancel;
...
MageStudios.BEC.Scene_Battle_onSelectAction = Scene_Battle.prototype.onSelectAction;
...
MageStudios.BEC.Scene_Battle_onSkillOk =
...
MageStudios.BEC.Scene_Battle_onItemOk =
...
MageStudios.BEC.Scene_Battle_onItemCancel =
...
Window_BattleEnemy.prototype.autoSelect = function() {
    if (MageStudios.Param.BECEnemyAutoSel === 0 ||
...
Window_BattleLog.prototype.displayActionResults = function(subject, target) {
    if (MageStudios.Param.BECOptSpeed) {
      ...
      MageStudios.BEC.Window_BattleLog_displayActionResults.call(this, subject,
          target);
    }
...
function(subject, targets) {
    if ($gameSystem.isSideView()) {
      ...
      this.showNormalAnimation(targets, subject.attackAnimationId(), false);
      MageStudios.BEC.Window_BattleLog_showEnemyAttackAnimation.call(this, subject,
          targets);
    }
};
