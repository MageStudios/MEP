 ...
 * ============================================================================
 *
 * This plugin requires MSEP_GridFreeDoodads. Make sure this plugin is located
 * under MSEP_GridFreeDoodads in the plugin list.
 *
...
Sprite_Doodad.prototype.initCustomDataZ = function() {
  MageStudios.EDP1.Sprite_Doodad_initCustomDataZ.call(this);
...
MageStudios.EDP1.Sprite_Doodad_updateCustomA =
  Sprite_Doodad.prototype.updateCustomA;
Sprite_Doodad.prototype.updateCustomA = function() {
  this.resetOpacity();
  MageStudios.EDP1.Sprite_Doodad_updateCustomA.call(this);
};
...
MageStudios.EDP1.Sprite_Doodad_updateCustomZ = Sprite_Doodad.prototype.updateCustomZ;
Sprite_Doodad.prototype.updateCustomZ = function() {
  MageStudios.EDP1.Sprite_Doodad_updateCustomZ.call(this);
...
Window_GFD_Settings.prototype.addCustomCommands = function() {
  this.addLineCommand();
  MageStudios.EDP1.Window_GFD_Settings_addCustomCommands.call(this);
};

MageStudios.EDP1.Window_GFD_Settings_addCustomCommandsP =
  Window_GFD_Settings.prototype.addCustomCommandsP;
Window_GFD_Settings.prototype.addCustomCommandsP = function() {
  MageStudios.EDP1.Window_GFD_Settings_addCustomCommandsP.call(this);
...
MageStudios.EDP1.Window_GFD_Settings_addCustomCommandsS =
  Window_GFD_Settings.prototype.addCustomCommandsS;
Window_GFD_Settings.prototype.addCustomCommandsS = function() {
  MageStudios.EDP1.Window_GFD_Settings_addCustomCommandsS.call(this);
...
MageStudios.EDP1.Window_GFD_Settings_addCustomCommandsT =
  Window_GFD_Settings.prototype.addCustomCommandsT;
Window_GFD_Settings.prototype.addCustomCommandsT = function() {
  MageStudios.EDP1.Window_GFD_Settings_addCustomCommandsT.call(this);
...
MageStudios.EDP1.Window_GFD_Settings_drawItem =
  Window_GFD_Settings.prototype.drawItem;
Window_GFD_Settings.prototype.drawItem = function(index) {
  this.changeTextColor(this.normalColor());
  MageStudios.EDP1.Window_GFD_Settings_drawItem.call(this, index);
...
MageStudios.EDP1.DM_inputLeft = DoodadManager.inputLeft;
DoodadManager.inputLeft = function(doodad, symbol, value) {
  ...
  case 'toneGrey':
    ...
    break;
  default:
    return MageStudios.EDP1.DM_inputLeft.call(this, doodad, symbol, value);
    break;
  }
...
MageStudios.EDP1.DM_inputRight = DoodadManager.inputRight;
...
Scene_Map.prototype.createGFDSettingsWindow = function() {
  MageStudios.EDP1.Scene_Map_createGFDSettingsWindow.call(this);
...
MageStudios.EDP1.Scene_Map_createGFDSettingsSubwindows =
  Scene_Map.prototype.createGFDSettingsSubwindows;
Scene_Map.prototype.createGFDSettingsSubwindows = function() {
  MageStudios.EDP1.Scene_Map_createGFDSettingsSubwindows.call(this);
...
Scene_Map.prototype.cmdGFDSettToneRandomRed = function() {
  var doodad = this._gfdSettingsWindow._doodad;
  doodad.toneRed = MageStudios.Util.randomIntBetween(0, 255);
  DoodadManager.updateNewSettings();
  this._gfdSettingsWindow.activate();
  this._gfdSettingsWindow.refresh();
};
...
Scene_Map.prototype.cmdGFDSettToneRandomGreen = function() {
  var doodad = this._gfdSettingsWindow._doodad;
  doodad.toneGreen = MageStudios.Util.randomIntBetween(0, 255);
  DoodadManager.updateNewSettings();
  this._gfdSettingsWindow.activate();
  this._gfdSettingsWindow.refresh();
};
...
Scene_Map.prototype.cmdGFDSettToneRandomBlue = function() {
  var doodad = this._gfdSettingsWindow._doodad;
  doodad.toneBlue = MageStudios.Util.randomIntBetween(0, 255);
  DoodadManager.updateNewSettings();
  this._gfdSettingsWindow.activate();
  this._gfdSettingsWindow.refresh();
};
...
Scene_Map.prototype.cmdGFDSettToneRandomGrey = function() {
  var doodad = this._gfdSettingsWindow._doodad;
  doodad.toneGrey = MageStudios.Util.randomIntBetween(0, 255);
  DoodadManager.updateNewSettings();
  this._gfdSettingsWindow.activate();
  this._gfdSettingsWindow.refresh();
};
...
MageStudios.Util.randomIntBetween = function(min, max) {
