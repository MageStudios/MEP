//=============================================================================
// Mage Studios Engine Plugins - Battle Engine Extension - Turn Order Display
// MSEP_X_TurnOrderDisplay.js
//=============================================================================

var Imported = Imported || {};
Imported.MSEP_X_TurnOrderDisplay = true;
...
MageStudios.Param.TODShowDefault = eval(MageStudios.Param.TODShowDefault);

MageStudios.Param.TODIconSize = Number(MageStudios.Parameters['Icon Size']);
MageStudios.Param.TODPositionX = String(MageStudios.Parameters['Position X']);
MageStudios.Param.TODPositionY = Number(MageStudios.Parameters['Position Y']);
MageStudios.Param.TODTurnDirection = String(MageStudios.Parameters['Turn Direction']);
MageStudios.Param.TODPerformedSpace = String(MageStudios.Parameters['Performed Spacing']);
MageStudios.Param.TODPerformedSpace = eval(MageStudios.Param.TODPerformedSpace);

MageStudios.Param.TODColorAllyBr = Number(MageStudios.Parameters['Ally Border Color']);
MageStudios.Param.TODColorAllyBg = Number(MageStudios.Parameters['Ally Back Color']);
MageStudios.Param.TODAllyIcon = Number(MageStudios.Parameters['Ally Icon']);

MageStudios.Param.TODColorEnemyBr = Number(MageStudios.Parameters['Enemy Border Color']);
MageStudios.Param.TODColorEnemyBg = Number(MageStudios.Parameters['Enemy Back Color']);
MageStudios.Param.TODEnemyIcon = Number(MageStudios.Parameters['Enemy Icon']);
MageStudios.Param.TODEnemySVBattler = String(MageStudios.Parameters['Enemy SV Battlers']);
MageStudios.Param.TODEnemySVBattler = eval(MageStudios.Param.TODEnemySVBattler);

//=============================================================================
// DataManager
//=============================================================================

MageStudios.TOD.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function() {
  if (!MageStudios.TOD.DataManager_isDatabaseLoaded.call(this)) return false;

  if (!MageStudios._loaded_MSEP_X_TurnOrderDisplay) {
    this.processTODNotetagsC($dataClasses);
    this.processTODNotetags1($dataActors, true);
    this.processTODNotetags1($dataEnemies, false);
    MageStudios._loaded_MSEP_X_TurnOrderDisplay = true;
  }
...
DataManager.processTODNotetags1 = function(group, isActor) {
  for (var n = 1; n < group.length; n++) {
    ...
    if (isActor) {
      obj.turnOrderIcon = MageStudios.Param.TODAllyIcon;
      obj.turnOrderBorderColor = MageStudios.Param.TODColorAllyBr;
      obj.turnOrderBackgroundColor = MageStudios.Param.TODColorAllyBg;
      obj.turnOrderClassIcon = {};
    } else {
      obj.turnOrderIcon = MageStudios.Param.TODEnemyIcon;
      obj.turnOrderBorderColor = MageStudios.Param.TODColorEnemyBr;
      obj.turnOrderBackgroundColor = MageStudios.Param.TODColorEnemyBg;
    }
...
MageStudios.TOD.BattleManager_startBattle = BattleManager.startBattle;
BattleManager.startBattle = function() {
  MageStudios.TOD.BattleManager_startBattle.call(this);
...
BattleManager.isPreventUpdateTurnOrder = function() {
  if (Imported.MSEP_X_CounterControl && this.isCountering()) return true;
  if (Imported.MSEP_InstantCast && this._instantCasting) return true;
  return false;
};
...
MageStudios.TOD.BattleManager_makeActionOrders = BattleManager.makeActionOrders;
BattleManager.makeActionOrders = function() {
  MageStudios.TOD.BattleManager_makeActionOrders.call(this);
  this.updateTurnOrderDisplayX();
};

MageStudios.TOD.BattleManager_startInput = BattleManager.startInput;
BattleManager.startInput = function() {
  MageStudios.TOD.BattleManager_startInput.call(this);
  if (this.isDTB()) {
    this._performedBattlers = [];
  }
  this.updateTurnOrderDisplayX();
...
MageStudios.TOD.BattleManager_updateTurn = BattleManager.updateTurn;
BattleManager.updateTurn = function() {
  MageStudios.TOD.BattleManager_updateTurn.call(this);
  this.updateTurnOrderDisplayX();
};

MageStudios.TOD.BattleManager_endTurn = BattleManager.endTurn;
BattleManager.endTurn = function() {
  MageStudios.TOD.BattleManager_endTurn.call(this);
  this.updateTurnOrderDisplayX();
};

MageStudios.TOD.BattleManager_endAction = BattleManager.endAction;
BattleManager.endAction = function() {
  this.updateTurnOrderDisplayX();
  MageStudios.TOD.BattleManager_endAction.call(this);
};
...
MageStudios.TOD.Game_System_initialize = Game_System.prototype.initialize;
Game_System.prototype.initialize = function() {
  MageStudios.TOD.Game_System_initialize.call(this);
  this.initTurnOrderDisplaySettings();
};

Game_System.prototype.initTurnOrderDisplaySettings = function() {
  this._showTurnOrderDisplay = MageStudios.Param.TODShowDefault;
};
...
MageStudios.TOD.Game_BattlerBase_appear = Game_BattlerBase.prototype.appear;
Game_BattlerBase.prototype.appear = function() {
  MageStudios.TOD.Game_BattlerBase_appear.call(this);
...
MageStudios.TOD.Game_Battler_performCollapse =
  Game_Battler.prototype.performCollapse;
Game_Battler.prototype.performCollapse = function() {
  MageStudios.TOD.Game_Battler_performCollapse.call(this);
  BattleManager.refreshTurnOrderDisplay();
};
...
MageStudios.TOD.Game_Battler_setAction = Game_Battler.prototype.setAction;
Game_Battler.prototype.setAction = function(index, action) {
  MageStudios.TOD.Game_Battler_setAction.call(this, index, action);
  BattleManager.makeActionOrders();
};
...
Game_Enemy.prototype.turnOrderDisplayBitmap = function() {
  ...
  if (Imported.MSEP_X_AnimatedSVEnemies && this.hasSVBattler()) {
...
MageStudios.TOD.Game_Action_clear = Game_Action.prototype.clear;
Game_Action.prototype.clear = function() {
  MageStudios.TOD.Game_Action_clear.call(this);
  BattleManager.makeActionOrders();
};

MageStudios.TOD.Game_Action_setSkill = Game_Action.prototype.setSkill;
Game_Action.prototype.setSkill = function(skillId) {
  MageStudios.TOD.Game_Action_setSkill.call(this, skillId);
  BattleManager.makeActionOrders();
};

MageStudios.TOD.Game_Action_setItem = Game_Action.prototype.setItem;
Game_Action.prototype.setItem = function(itemId) {
  MageStudios.TOD.Game_Action_setItem.call(this, itemId);
  BattleManager.makeActionOrders();
};

MageStudios.TOD.Game_Action_setItemObject = Game_Action.prototype.setItemObject;
Game_Action.prototype.setItemObject = function(object) {
  MageStudios.TOD.Game_Action_setItemObject.call(this, object);
  BattleManager.makeActionOrders();
};
...
MageStudios.TOD.Game_Troop_increaseTurn = Game_Troop.prototype.increaseTurn;
Game_Troop.prototype.increaseTurn = function() {
  MageStudios.TOD.Game_Troop_increaseTurn.call(this);
...
MageStudios.TOD.Game_Interpreter_pluginCommand =
    Game_Interpreter.prototype.pluginCommand;
Game_Interpreter.prototype.pluginCommand = function(command, args) {
  MageStudios.TOD.Game_Interpreter_pluginCommand.call(this, command, args);
...
MageStudios.TOD.Scene_Battle_update = Scene_Battle.prototype.update;
Scene_Battle.prototype.update = function() {
  MageStudios.TOD.Scene_Battle_update.call(this);
...
MageStudios.TOD.Scene_Battle_startActorCommandSelection =
  Scene_Battle.prototype.startActorCommandSelection;
Scene_Battle.prototype.startActorCommandSelection = function() {
  MageStudios.TOD.Scene_Battle_startActorCommandSelection.call(this);
  this.updateTurnOrderDisplayX();
};

MageStudios.TOD.Scene_Battle_startPartyCommandSelection =
  Scene_Battle.prototype.startPartyCommandSelection;
Scene_Battle.prototype.startPartyCommandSelection = function() {
  MageStudios.TOD.Scene_Battle_startPartyCommandSelection.call(this);
  this.updateTurnOrderDisplayX();
};

if (Imported.MSEP_X_InBattleStatus) {

MageStudios.TOD.Scene_Battle_commandInBattleStatus =
  Scene_Battle.prototype.commandInBattleStatus;
Scene_Battle.prototype.commandInBattleStatus = function() {
  MageStudios.TOD.Scene_Battle_commandInBattleStatus.call(this);
  this.requestUpdateTurnOrderDisplayX();
};

MageStudios.TOD.Scene_Battle_onInBattleStatusCancel =
  Scene_Battle.prototype.onInBattleStatusCancel;
Scene_Battle.prototype.onInBattleStatusCancel = function() {
  MageStudios.TOD.Scene_Battle_onInBattleStatusCancel.call(this);
  this.requestUpdateTurnOrderDisplayX();
};

} // Imported.MSEP_X_InBattleStatus
...
Game_Temp.prototype.battleTurnOrder = function() {
  ...
  if (MageStudios.Param.TODPerformedSpace && this._battleTurnOrder.length > 0) {
...
Window_TurnOrderIcon.prototype.initialize = function(unit, battlerIndex) {
  ...
  var size = MageStudios.Param.TODIconSize + 8;
...
Window_TurnOrderIcon.prototype.initSettings = function(unit, battlerIndex) {
  ...
  this._position = MageStudios.Param.TODPositionX.toLowerCase();
  this._direction = MageStudios.Param.TODTurnDirection.toLowerCase();
...
Window_TurnOrderIcon.prototype.iconWidth = function() {
  return MageStudios.Param.TODIconSize;
};
...
Window_TurnOrderIcon.prototype.isUsingSVBattler = function() {
  ...
  return MageStudios.Param.TODEnemySVBattler;
};
...
Window_TurnOrderIcon.prototype.aliveMembersSize = function() {
  ...
  if (MageStudios.Param.TODPerformedSpace) value += 1;
  return value;
};
...
Window_TurnOrderIcon.prototype.turnOrderDisplayIndex = function() {
  ...
  if (performedBattlers.contains(this.battler())) {
    ...
    if (MageStudios.Param.TODPerformedSpace) index += 1;
    return index;
  } else {
...
Window_TurnOrderIcon.prototype.getActionBattlers = function() {
  var result = [];
  var battlers = MageStudios.Util.getUnique(BattleManager._actionBattlers);
...
Window_TurnOrderIcon.prototype.getPerformedBattlers = function() {
  var result = [];
  var battlers = MageStudios.Util.getUnique(BattleManager._performedBattlers);
  var length = battlers.length;
  for (var i = 0; i < length; ++i) {
    var battler = battlers[i];
    if (!battler) continue;
...
Window_TurnOrderIcon.prototype.destinationY = function() {
  var value = MageStudios.Param.TODPositionY;
...
Window_TurnOrderIcon.prototype.isReduceOpacity = function() {
  ...
  if (Imported.MSEP_X_InBattleStatus && scene._inBattleStatusWindow.visible) {
    return true;
  }
...
MageStudios.Util.getUnique = function(array) {
  var result = [];
  var length = array.length;
  for (var i = 0; i < length; ++i) {
    var element = array[i];
