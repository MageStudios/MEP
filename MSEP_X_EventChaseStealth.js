...
if (Imported.MSEP_EventChasePlayer) {
  ...
  MageStudios.Param.ECSPlayerTrans = Number(
    MageStudios.Parameters["Player Transparency"]
  );
  MageStudios.Param.ECSStealthDash = eval(
    String(MageStudios.Parameters["Disable Dash"])
  );
  MageStudios.Param.ECSMoveSpeed = Number(MageStudios.Parameters["Move Speed"]);

  MageStudios.Param.ECSRegions = String(
    MageStudios.Parameters["Stealth Regions"]
  );
  MageStudios.Param.ECSRegions = MageStudios.Param.ECSRegions.split(" ");
  for (
    MageStudios.i = 0;
    MageStudios.i < MageStudios.Param.ECSRegions.length;
    ++MageStudios.i
  ) {
    MageStudios.Param.ECSRegions[MageStudios.i] = parseInt(
      MageStudios.Param.ECSRegions[MageStudios.i]
    );
  }

  MageStudios.Param.ECSShowGauge = eval(
    String(MageStudios.Parameters["Show Gauge"])
  );
  MageStudios.Param.ECSSOpacity = Number(
    MageStudios.Parameters["Gauge Opacity"]
  );
  MageStudios.Param.ECSShowTimer = eval(
    String(MageStudios.Parameters["Show Timer"])
  );
  MageStudios.Param.ECSSUnlimited = String(
    MageStudios.Parameters["Unlimited Text"]
  );
  ...
  MageStudios.Param.ECSSGaugeColor1 = Number(
    MageStudios.Parameters["Gauge Color 1"]
  );
  MageStudios.Param.ECSSGaugeColor2 = Number(
    MageStudios.Parameters["Gauge Color 2"]
  );
  ...
  MageStudios.ECS.Game_CharacterBase_opacity =
    Game_CharacterBase.prototype.opacity;
  ...
  MageStudios.ECS.Game_Player_triggerAction =
  ...
  MageStudios.ECS.Game_Event_chaseConditions =
  ...
  MageStudios.ECS.Game_Event_fleeConditions =
    Game_Event.prototype.fleeConditions;
  ...
  MageStudios.ECS.Scene_Map_createAllWindows =
