//=============================================================================
// Mage Studios Engine Plugins - Class Change Core Extension - Subclass
// MSEP_X_Subclass.js
//=============================================================================
...
MageStudios.Param.SubclassShowCmd = String(MageStudios.Parameters['Show Command']);
MageStudios.Param.SubclassEnableCmd = String(MageStudios.Parameters['Enable Command']);
MageStudios.Param.SubclassFmt = String(MageStudios.Parameters['Name Format']);
MageStudios.Param.SubclassColor = Number(MageStudios.Parameters['Subclass Color']);
...
MageStudios.Param.SubclassSType = eval(String(MageStudios.Parameters['Skill Types']));
MageStudios.Param.SubParamRates = eval(String(MageStudios.Parameters['Param Rates']));
MageStudios.Param.SubXParamVal = eval(String(MageStudios.Parameters['X-Param Values']));
MageStudios.Param.SubSParamRates = eval(String(MageStudios.Parameters['S-Param Rates']));
MageStudios.Param.SubSEleRates = eval(String(MageStudios.Parameters['Element Rates']));
MageStudios.Param.SubDebuffRates = eval(String(MageStudios.Parameters['Debuff Rates']));
MageStudios.Param.SubStateRates = eval(String(MageStudios.Parameters['Debuff Rates']));
MageStudios.Param.SubStateRes = eval(String(MageStudios.Parameters['State Resist']));
MageStudios.Param.SubAttackEle = eval(String(MageStudios.Parameters['Attack Element']));
MageStudios.Param.SubAttackState = eval(String(MageStudios.Parameters['Attack State']));
MageStudios.Param.SubAddedSkills = eval(String(MageStudios.Parameters['Added Skills']));
MageStudios.Param.SubclassWeapons = eval(String(MageStudios.Parameters['Weapons']));
MageStudios.Param.SubclassArmors = eval(String(MageStudios.Parameters['Armors']));

//=============================================================================
// DataManager
//=============================================================================

MageStudios.Subclass.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function() {
  if (!MageStudios.Subclass.DataManager_isDatabaseLoaded.call(this)) return false;
...
MageStudios.Subclass.Game_System_initialize = Game_System.prototype.initialize;
...
Game_BattlerBase.prototype.addedSkillTypes = function() {
  var array = MageStudios.Subclass.Game_BattlerBase_addedSkillTypes.call(this);
...
Game_BattlerBase.prototype.paramRate = function(paramId) {
  var rate = MageStudios.Subclass.Game_BattlerBase_paramRate.call(this, paramId);
...
MageStudios.Subclass.Game_BattlerBase_xparam = Game_BattlerBase.prototype.xparam;
Game_BattlerBase.prototype.xparam = function(xparamId) {
  var value = MageStudios.Subclass.Game_BattlerBase_xparam.call(this, xparamId);
...
MageStudios.Subclass.Game_BattlerBase_sparam = Game_BattlerBase.prototype.sparam;
Game_BattlerBase.prototype.sparam = function(sparamId) {
  var rate = MageStudios.Subclass.Game_BattlerBase_sparam.call(this, sparamId);
...
Game_BattlerBase.prototype.elementRate = function(eleId) {
  var rate = MageStudios.Subclass.Game_BattlerBase_elementRate.call(this, eleId);
...
Game_BattlerBase.prototype.debuffRate = function(paramId) {
  var rate = MageStudios.Subclass.Game_BattlerBase_debuffRate.call(this, paramId);
...
Game_BattlerBase.prototype.stateRate = function(stateId) {
  var rate = MageStudios.Subclass.Game_BattlerBase_stateRate.call(this, stateId);
...
MageStudios.Subclass.Game_Actor_changeClass = Game_Actor.prototype.changeClass;
...
Game_Interpreter.prototype.pluginCommand = function(command, args) {
    MageStudios.Subclass.Game_Interpreter_pluginCommand.call(this, command, args);
...
Window_ClassList.prototype.changeClassNameColor = function(item) {
    if (item === this._actor.subclass()) {
      ...
      MageStudios.Subclass.Window_ClassList_changeClassNameColor.call(this, item);
    }
};
