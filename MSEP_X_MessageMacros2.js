//=============================================================================
// Mage Studios Engine Plugins - Message Core Extension - Message Macros 2
// MSEP_X_MessageMacros2.js
//=============================================================================

var Imported = Imported || {};
Imported.MSEP_X_MessageMacros2 = true;
...
//=============================================================================
 /*:
 * @plugindesc v1.00 (Requires MSEP_MessageCore.js) Adds macros 101 to 200
 ...
 * ============================================================================
 *
 * This plugin requires MSEP_MessageCore.js to run.
 * Place this plugin under MSEP_MessageCore.js in the plugin list.
 *
 ...
 * ============================================================================
 *
 * Refer to MSEP_X_MessageMacros1.js's help file for instructions.
 *
 * ============================================================================
 * Changelog
 * ============================================================================
...
MageStudios.Parameters = PluginManager.parameters('MEP_X_MessageMacros2');
MageStudios.Param = MageStudios.Param || {};

MageStudios.Param.MacroMax = 200;
for (MageStudios.i = 101; MageStudios.i < MageStudios.Param.MacroMax + 1; ++MageStudios.i) {
