 ...
 * - This rate affects how much damage the user will take from physical daMageStudios.
 ...
 * - This rate affects how much damage the user will take from magical daMageStudios.
 ...
 * at 100%, then the user takes the full daMageStudios. If FDR is at 50%, then only
...
DataManager.isDatabaseLoaded = function() {
  ...
  if (!MageStudios._loaded_MSEP_SpecialParamFormula) {
    ...
    MageStudios._loaded_MSEP_SpecialParamFormula = true;
  }
  return true;
};
