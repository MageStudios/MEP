...
MageStudios.Param.GabFontSize = Number(MageStudios.Parameters['Gab Font Size']);
MageStudios.Param.GabCharPosX = Number(MageStudios.Parameters['Character X Pos']);
MageStudios.Param.GabCharPosY = Number(MageStudios.Parameters['Character Y Pos']);
MageStudios.Param.GabBaseTime = Number(MageStudios.Parameters['Base Wait Time']);
MageStudios.Param.GabTimePerChar = Number(MageStudios.Parameters['Time Per Character']);
MageStudios.Param.GabFadeRate = Number(MageStudios.Parameters['Fade Rate']);
MageStudios.Param.GabAntiRepeat = Boolean(MageStudios.Parameters['Anti-Repeat']);

MageStudios.Param.GabMapYLoc = Number(MageStudios.Parameters['Map Y Location']);
MageStudios.Param.GabMapDim1 = String(MageStudios.Parameters['Map Dim Color 1']);
MageStudios.Param.GabMapDim2 = String(MageStudios.Parameters['Map Dim Color 2']);

MageStudios.Param.GabBattleYLoc = Number(MageStudios.Parameters['Battle Y Location']);
MageStudios.Param.GabBattleDim1 = String(MageStudios.Parameters['Battle Dim Color 1']);
MageStudios.Param.GabBattleDim2 = String(MageStudios.Parameters['Battle Dim Color 2']);

//=============================================================================
// Game_Interpreter
//=============================================================================

MageStudios.Gab.Game_Interpreter_clear = Game_Interpreter.prototype.clear;
Game_Interpreter.prototype.clear = function() {
    MageStudios.Gab.Game_Interpreter_clear.call(this);
    this.clearGabInformation();
};

MageStudios.Gab.Game_Interpreter_pluginCommand =
    Game_Interpreter.prototype.pluginCommand;
Game_Interpreter.prototype.pluginCommand = function(command, args) {
    MageStudios.Gab.Game_Interpreter_pluginCommand.call(this, command, args)
...
MageStudios.Gab.Game_Interpreter_updateWaitMode =
  Game_Interpreter.prototype.updateWaitMode;
Game_Interpreter.prototype.updateWaitMode = function() {
  if (this._waitMode === 'gab') {
    return this.isGabRunning();
  } else {
    return MageStudios.Gab.Game_Interpreter_updateWaitMode.call(this);
  }
};
...
Window_Gab.prototype.initialize = function(battle) {
    ...
    if (battle) {
      var wy = MageStudios.Param.GabBattleYLoc - this.standardPadding();
    } else {
      var wy = MageStudios.Param.GabMapYLoc - this.standardPadding();
    }
...
Window_Gab.prototype.standardFontFace = function() {
    return MageStudios.Param.GabFontName;
};

Window_Gab.prototype.standardFontSize = function() {
    return MageStudios.Param.GabFontSize;
};
...
Window_Gab.prototype.updateFadeIn = function() {
    this.contentsOpacity += MageStudios.Param.GabFadeRate;
};
...
Window_Gab.prototype.checkDuplicateGab = function(gabData) {
    if (!MageStudios.Param.GabAntiRepeat) return false;
...
MageStudios.Gab.WindowLayer_webglMaskWindow =
...
WindowLayer.prototype._webglMaskWindow = function(renderSession, win) {
    ...
    MageStudios.Gab.WindowLayer_webglMaskWindow.call(this, renderSession, win);
};

Window_Gab.prototype.startCountdown = function() {
    this._graphicLoading = false;
    this.contentsOpacity = 255;
    this._showCount = MageStudios.Param.GabBaseTime;
    var text = this._text.replace(/\\(.*?)\[(.*?)\]/gi, '');
    this._showCount += text.length * MageStudios.Param.GabTimePerChar;
};
...
Window_Gab.prototype.dimColor1 = function() {
    if ($gameParty.inBattle()) {
      return MageStudios.Param.GabBattleDim1;
    } else {
      return MageStudios.Param.GabMapDim1;
    }
};

Window_Gab.prototype.dimColor2 = function() {
    if ($gameParty.inBattle()) {
      return MageStudios.Param.GabBattleDim2;
    } else {
      return MageStudios.Param.GabMapDim2;
    }
};
...
Window_Gab.prototype.drawGabCharacter = function() {
    ...
    if (this._graphicType === 'character') {
      var wx = MageStudios.Param.GabCharPosX;
      var wy = MageStudios.Param.GabCharPosY;
...
Window_Gab.prototype.drawGabText = function() {
    var text = this._text;
    if (this._graphicType === 'character') {
      var wx = MageStudios.Param.GabCharPosX * 2;
    } else if (this._graphicType === 'face') {
...
MageStudios.Gab.SceneManager_push = SceneManager.push;
SceneManager.push = function(sceneClass) {
    if (this.isStoreGabs(sceneClass)) {
      this._scene._gabWindow.storeGabs();
    }
    MageStudios.Gab.SceneManager_push.call(this, sceneClass);
};
...
MageStudios.Gab.Scene_Battle_createAllWindows =
    Scene_Battle.prototype.createAllWindows;
Scene_Battle.prototype.createAllWindows = function() {
    MageStudios.Gab.Scene_Battle_createAllWindows.call(this);
...
MageStudios.Gab.Scene_Map_createAllWindows = Scene_Map.prototype.createAllWindows;
Scene_Map.prototype.createAllWindows = function() {
    MageStudios.Gab.Scene_Map_createAllWindows.call(this);
