...
MageStudios.Param.GabCharPosX = Number(
  MageStudios.Parameters["Character X Pos"]
);
MageStudios.Param.GabCharPosY = Number(
  MageStudios.Parameters["Character Y Pos"]
);
MageStudios.Param.GabBaseTime = Number(
  MageStudios.Parameters["Base Wait Time"]
);
MageStudios.Param.GabTimePerChar = Number(
  MageStudios.Parameters["Time Per Character"]
);
MageStudios.Param.GabFadeRate = Number(MageStudios.Parameters["Fade Rate"]);
MageStudios.Param.GabAntiRepeat = Boolean(
  MageStudios.Parameters["Anti-Repeat"]
);

MageStudios.Param.GabMapYLoc = Number(MageStudios.Parameters["Map Y Location"]);
MageStudios.Param.GabMapDim1 = String(
  MageStudios.Parameters["Map Dim Color 1"]
);
MageStudios.Param.GabMapDim2 = String(
  MageStudios.Parameters["Map Dim Color 2"]
);

MageStudios.Param.GabBattleYLoc = Number(
  MageStudios.Parameters["Battle Y Location"]
);
MageStudios.Param.GabBattleDim1 = String(
  MageStudios.Parameters["Battle Dim Color 1"]
);
MageStudios.Param.GabBattleDim2 = String(
  MageStudios.Parameters["Battle Dim Color 2"]
);
...
MageStudios.Gab.Scene_Map_createAllWindows =
