//=============================================================================
// Mage Studios Engine Plugins - Item Core
// MSEP_ItemCore.js
//=============================================================================

var Imported = Imported || {};
Imported.MSEP_ItemCore = true;
...
MageStudios.Param.ItemMaxWeapons = Number(MageStudios.Parameters['Max Weapons']);
MageStudios.Param.ItemMaxArmors = Number(MageStudios.Parameters['Max Armors']);
MageStudios.Param.ItemStartingId = Number(MageStudios.Parameters['Starting ID']);
MageStudios.Param.ItemRandomVariance = Number(MageStudios.Parameters['Random Variance']);
MageStudios.Param.ItemNegVar = eval(String(MageStudios.Parameters['Negative Variance']));
MageStudios.Param.ItemNameFmt = String(MageStudios.Parameters['Name Format']);
MageStudios.Param.ItemNameSpacing = String(MageStudios.Parameters['Name Spacing']);
MageStudios.Param.ItemBoostFmt = String(MageStudios.Parameters['Boost Format']);

MageStudios.Param.ItemSceneItem = String(MageStudios.Parameters['Updated Scene Item']);
MageStudios.Param.ItemSceneItem = eval(MageStudios.Param.ItemSceneItem);
MageStudios.Param.ItemShEquipped = String(MageStudios.Parameters['List Equipped Items']);
MageStudios.Param.ItemShEquipped = eval(MageStudios.Param.ItemShEquipped);
MageStudios.Param.ItemShowIcon = String(MageStudios.Parameters['Show Icon']);
MageStudios.Param.ItemShowIcon = eval(MageStudios.Param.ItemShowIcon);
MageStudios.Param.ItemIconSize = Number(MageStudios.Parameters['Icon Size']);
MageStudios.Param.ItemFontSize = Number(MageStudios.Parameters['Font Size']);
MageStudios.Param.ItemCmdAlign = String(MageStudios.Parameters['Command Alignment']);
MageStudios.Param.ItemRecoverFmt = String(MageStudios.Parameters['Recovery Format']);
MageStudios.Param.ItemAddState = String(MageStudios.Parameters['Add State']);
MageStudios.Param.ItemAddBuff = String(MageStudios.Parameters['Add Buff']);
MageStudios.Param.ItemRemoveState = String(MageStudios.Parameters['Remove State']);
MageStudios.Param.ItemRemoveBuff = String(MageStudios.Parameters['Remove Buff']);
MageStudios.Param.ItemMaxIcons = Number(MageStudios.Parameters['Maximum Icons']);
MageStudios.Param.ItemUseCmd = String(MageStudios.Parameters['Use Command']);
MageStudios.Param.ItemCarryFmt = String(MageStudios.Parameters['Carry Format']);

MageStudios.Param.ItemNoteParse = String(MageStudios.Parameters['Midgame Note Parsing']);
MageStudios.Param.ItemNoteParse = eval(MageStudios.Param.ItemNoteParse);

//=============================================================================
// DataManager
//=============================================================================

MageStudios.Item.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function() {
  if (!MageStudios.Item.DataManager_isDatabaseLoaded.call(this)) return false;
  if (!MageStudios._loaded_MSEP_ItemCore) {
    ...
    MageStudios._loaded_MSEP_ItemCore = true;
  }
  return true;
};
...
DataManager.processItemCoreNotetags = function(group) {
  ...
  for (var n = 1; n < group.length; n++) {
    ...
    obj.randomVariance = MageStudios.Param.ItemRandomVariance;
    obj.textColor = 0;
    if (Imported.MSEP_CoreEngine) obj.textColor = MageStudios.Param.ColorNormal;
...
MageStudios.Item.DataManager_createGameObjects =
    DataManager.createGameObjects;
DataManager.createGameObjects = function() {
    MageStudios.Item.DataManager_createGameObjects.call(this);
...
DataManager.setIndependentLength = function(group) {
    for (;;) {
      if (group.length > MageStudios.Param.ItemStartingId) break;
      group.push(null);
    }
};
...
MageStudios.Item.DataManager_makeSaveContents = DataManager.makeSaveContents;
DataManager.makeSaveContents = function() {
    var contents = MageStudios.Item.DataManager_makeSaveContents.call(this);
...
MageStudios.Item.DataManager_extractSaveContents =
    DataManager.extractSaveContents;
DataManager.extractSaveContents = function(contents) {
    MageStudios.Item.DataManager_extractSaveContents.call(this, contents);
...
DataManager.isIndependent = function(item) {
    ...
    if (DataManager.isItem(item)) return MageStudios.Param.ItemMaxItems > 0;
    if (DataManager.isWeapon(item)) return MageStudios.Param.ItemMaxWeapons > 0;
    if (DataManager.isArmor(item)) return MageStudios.Param.ItemMaxArmors > 0;
    return false;
};
...
ItemManager.setNewIndependentItem = function(baseItem, newItem) {
    ...
    if (!MageStudios.Param.ItemNoteParse) newItem.note = '';
};
...
ItemManager.randomizeInitialStats = function(baseItem, newItem) {
    ...
    for (var i = 0; i < 8; ++i) {
      ...
      if (!MageStudios.Param.ItemNegVar && baseItem.params[i] >= 0) {
...
ItemManager.setNamePrefix = function(item, value) {
    ...
    if (eval(MageStudios.Param.ItemNameSpacing) && item.namePrefix.length > 0) {
...
ItemManager.setNameSuffix = function(item, value) {
    ...
    if (eval(MageStudios.Param.ItemNameSpacing) && item.nameSuffix.length > 0) {
...
ItemManager.updateItemName = function(item) {
    ...
    var fmt = MageStudios.Param.ItemBoostFmt;
    var boostText = fmt.format(MageStudios.Util.toGroup(boostCount))
    if (boostText === fmt.format(0)) {
      boostText = '';
    } else if (eval(MageStudios.Param.ItemNameSpacing)) {
      boostText = ' ' + boostText;
    }
    fmt = MageStudios.Param.ItemNameFmt;
...
ItemManager.onCreationEval = function(baseItem, newItem) {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, 'ITEM CREATION CUSTOM CODE ERROR');
    }
    item.onCreationEval = '';
};
...
MageStudios.Item.Game_Actor_setup = Game_Actor.prototype.setup;
Game_Actor.prototype.setup = function(actorId) {
    MageStudios.Item.Game_Actor_setup.call(this, actorId);
...
MageStudios.Item.Game_Actor_hasWeapon = Game_Actor.prototype.hasWeapon;
Game_Actor.prototype.hasWeapon = function(weapon) {
    if (this.hasBaseItem(weapon)) return true;
    return MageStudios.Item.Game_Actor_hasWeapon.call(this, weapon);
};

MageStudios.Item.Game_Actor_hasArmor = Game_Actor.prototype.hasArmor;
Game_Actor.prototype.hasArmor = function(armor) {
    if (this.hasBaseItem(armor)) return true;
    return MageStudios.Item.Game_Actor_hasArmor.call(this, armor);
};
...
MageStudios.Item.Game_Actor_changeEquipById = Game_Actor.prototype.changeEquipById;
Game_Actor.prototype.changeEquipById = function(etypeId, itemId) {
    ...
    MageStudios.Item.Game_Actor_changeEquipById.call(this, etypeId, itemId)
};
...
MageStudios.Item.Game_Party_setupStartingMembers =
    Game_Party.prototype.setupStartingMembers;
Game_Party.prototype.setupStartingMembers = function() {
    MageStudios.Item.Game_Party_setupStartingMembers.call(this);
    $gameTemp.enableVarianceStock();
...
MageStudios.Item.Game_Party_gainItem = Game_Party.prototype.gainItem;
Game_Party.prototype.gainItem = function(item, amount, includeEquip) {
    if (DataManager.isIndependent(item)) {
      this.gainIndependentItem(item, amount, includeEquip);
    } else {
      MageStudios.Item.Game_Party_gainItem.call(this, item, amount, includeEquip);
    }
};
...
Game_Party.prototype.getIndependentItemTypeMax = function(item) {
    if (!item) return 0;
    if (DataManager.isItem(item)) return MageStudios.Param.ItemMaxItems;
    if (DataManager.isWeapon(item)) return MageStudios.Param.ItemMaxWeapons;
    if (DataManager.isArmor(item)) return MageStudios.Param.ItemMaxArmors;
};
...
MageStudios.Item.Game_Party_items = Game_Party.prototype.items;
Game_Party.prototype.items = function() {
    var results = MageStudios.Item.Game_Party_items.call(this);
    results.sort(this.independentItemSort);
    return results;
};

MageStudios.Item.Game_Party_weapons = Game_Party.prototype.weapons;
Game_Party.prototype.weapons = function() {
    var results = MageStudios.Item.Game_Party_weapons.call(this);
    results.sort(this.independentItemSort);
    return results;
};

MageStudios.Item.Game_Party_armors = Game_Party.prototype.armors;
Game_Party.prototype.armors = function() {
    var results = MageStudios.Item.Game_Party_armors.call(this);
    results.sort(this.independentItemSort);
    return results;
};
...
MageStudios.Item.Game_Party_maxItems = Game_Party.prototype.maxItems;
Game_Party.prototype.maxItems = function(item) {
    if (DataManager.isIndependent(item)) return 1;
    return MageStudios.Item.Game_Party_maxItems.call(this, item);
};

MageStudios.Item.Game_Party_hasItem = Game_Party.prototype.hasItem;
Game_Party.prototype.hasItem = function(item, includeEquip) {
    if (DataManager.isIndependent(item)) {
      if (this.numIndependentItems(item) > 0) return true;
    }
    return MageStudios.Item.Game_Party_hasItem.call(this, item, includeEquip);
};

MageStudios.Item.Game_Party_isAnyMemberEquipped =
...
Game_Party.prototype.isAnyMemberEquipped = function(item) {
    ...
    return MageStudios.Item.Game_Party_isAnyMemberEquipped.call(this, item);
};
...
Game_Party.prototype.clearAllMatchingBaseItems = function(baseItem, equipped) {
  if (!Imported.MSEP_ItemCore) return;
  for (;;) {
...
MageStudios.Item.Game_Interpreter_pluginCommand =
    Game_Interpreter.prototype.pluginCommand;
Game_Interpreter.prototype.pluginCommand = function(command, args) {
    MageStudios.Item.Game_Interpreter_pluginCommand.call(this, command, args)
    if (command === 'EnableVarianceStock') $gameTemp.enableVarianceStock();
    if (command === 'DisableVarianceStock') $gameTemp.disableVarianceStock();
};

MageStudios.Item.Game_Interpreter_gDO = Game_Interpreter.prototype.gameDataOperand;
Game_Interpreter.prototype.gameDataOperand = function(type, param1, param2) {
  ...
  case 2:
    ...
    break;
  default:
    return MageStudios.Item.Game_Interpreter_gDO.call(this, type, param1, param2);
    break;
  }
};
...
MageStudios.Item.Window_Base_drawItemName = Window_Base.prototype.drawItemName;
Window_Base.prototype.drawItemName = function(item, wx, wy, ww) {
    ww = ww || 312;
    this.setItemTextColor(item);
    MageStudios.Item.Window_Base_drawItemName.call(this, item, wx, wy, ww);
...
MageStudios.Item.Window_Base_normalColor = Window_Base.prototype.normalColor;
Window_Base.prototype.normalColor = function() {
    if (this._resetTextColor !== undefined) {
      return this.textColor(this._resetTextColor);
    }
    return MageStudios.Item.Window_Base_normalColor.call(this);
};
...
MageStudios.Item.Window_ItemList_drawItemNumber =
...
Window_ItemList.prototype.drawItemNumber = function(item, dx, dy, dw) {
    ...
    MageStudios.Item.Window_ItemList_drawItemNumber.call(this, item, dx, dy, dw);
};
...
Window_ItemList.prototype.drawItemCarryNumber = function(item, dx, dy, dw) {
    ...
    var fmt = MageStudios.Param.ItemCarryFmt;
    var text = fmt.format(MageStudios.Util.toGroup(index), MageStudios.Util.toGroup(max));
...
MageStudios.Item.Window_EquipItem_includes = Window_EquipItem.prototype.includes;
Window_EquipItem.prototype.includes = function(item) {
    if (this._actor && item !== null) {
      if (!item) return false;
    }
    return MageStudios.Item.Window_EquipItem_includes.call(this, item);
};
...
MageStudios.Item.Window_ShopBuy_isEnabled = Window_ShopBuy.prototype.isEnabled;
Window_ShopBuy.prototype.isEnabled = function(item) {
    ...
    return MageStudios.Item.Window_ShopBuy_isEnabled.call(this, item);
};
...
MageStudios.Item.Window_ShopStatus_drawPossession =
...
Window_ShopStatus.prototype.drawPossession = function(x, y) {
    ...
    MageStudios.Item.Window_ShopStatus_drawPossession.call(this, x, y);
};
...
Window_ShopStatus.prototype.drawIndependentPossession = function(x, y) {
    ...
    value = MageStudios.Util.toGroup(value);
...
MageStudios.Item.Scene_Equip_refreshActor = Scene_Equip.prototype.refreshActor;
Scene_Equip.prototype.refreshActor = function() {
    this.actor().releaseUnequippableItems();
    MageStudios.Item.Scene_Equip_refreshActor.call(this);
};
...
MageStudios.Item.Scene_Shop_doBuy = Scene_Shop.prototype.doBuy;
Scene_Shop.prototype.doBuy = function(number) {
    $gameTemp.enableVarianceStock();
    MageStudios.Item.Scene_Shop_doBuy.call(this, number);
    $gameTemp.disableVarianceStock();
};

MageStudios.Item.Scene_Shop_doSell = Scene_Shop.prototype.doSell;
Scene_Shop.prototype.doSell = function(number) {
    MageStudios.Item.Scene_Shop_doSell.call(this, number);
...
MageStudios.Item.Window_ItemCategory_windowWidth =
    Window_ItemCategory.prototype.windowWidth;
Window_ItemCategory.prototype.windowWidth = function() {
    if (SceneManager._scene instanceof Scene_Item) return 240;
    return MageStudios.Item.Window_ItemCategory_windowWidth.call(this);
};

MageStudios.Item.Window_ItemCategory_numVisibleRows =
...
Window_ItemCategory.prototype.numVisibleRows = function() {
    ...
    return MageStudios.Item.Window_ItemCategory_numVisibleRows.call(this);
};

MageStudios.Item.Window_ItemCategory_maxCols = Window_ItemCategory.prototype.maxCols;
Window_ItemCategory.prototype.maxCols = function() {
    if (SceneManager._scene instanceof Scene_Item) return 1;
    return MageStudios.Item.Window_ItemCategory_maxCols.call(this);
};

MageStudios.Item.Window_ItemCategory_itemTextAlign =
    Window_ItemCategory.prototype.itemTextAlign;
Window_ItemCategory.prototype.itemTextAlign = function() {
    if (SceneManager._scene instanceof Scene_Item) {
      return MageStudios.Param.ItemCmdAlign;
    }
    return MageStudios.Item.Window_ItemCategory_itemTextAlign.call(this);
};
...
MageStudios.Item.Window_ItemList_initialize = Window_ItemList.prototype.initialize;
Window_ItemList.prototype.initialize = function(x, y, width, height) {
    if (SceneManager._scene instanceof Scene_Item) {
      width = Graphics.boxWidth / 2;
    }
    MageStudios.Item.Window_ItemList_initialize.call(this, x, y, width, height);
};

MageStudios.Item.Window_ItemList_maxCols = Window_ItemList.prototype.maxCols;
Window_ItemList.prototype.maxCols = function() {
    if (SceneManager._scene instanceof Scene_Item) return 1;
    return MageStudios.Item.Window_ItemList_maxCols.call(this);
};

MageStudios.Item.Window_ItemList_isEnabled = Window_ItemList.prototype.isEnabled;
Window_ItemList.prototype.isEnabled = function(item) {
    if (!item) return false;
    if (SceneManager._scene instanceof Scene_Item) return true;
    return MageStudios.Item.Window_ItemList_isEnabled.call(this, item);
};
...
MageStudios.Item.Window_ItemList_updateHelp = Window_ItemList.prototype.updateHelp;
Window_ItemList.prototype.updateHelp = function() {
    MageStudios.Item.Window_ItemList_updateHelp.call(this);
...
Window_ItemStatus.prototype.refresh = function() {
    ...
    this.contents.fontSize = MageStudios.Param.ItemFontSize;
    this.drawItemEntry();
};

Window_ItemStatus.prototype.drawDarkRectEntries = function() {
    var rect = new Rectangle();
    if (MageStudios.Param.ItemShowIcon) {
...
Window_ItemStatus.prototype.drawItemEntry = function() {
    var item = this._item;
    if (MageStudios.Param.ItemShowIcon) this.drawItemIcon(item);
...
Window_ItemStatus.prototype.drawLargeIcon = function() {
    ...
    var dw = MageStudios.Param.ItemIconSize;
    var dh = MageStudios.Param.ItemIconSize;
...
Window_ItemStatus.prototype.drawEquipInfo = function(item) {
    var rect = new Rectangle();
    if (eval(MageStudios.Param.ItemShowIcon)) {
      rect.width = (this.contents.width - Window_Base._faceWidth) / 2;
    } else {
      rect.width = this.contents.width / 2;
    }
    for (var i = 0; i < 8; ++i) {
      ...
      var text = MageStudios.Util.toGroup(item.params[i]);
...
Window_ItemStatus.prototype.getItemInfoCategory = function(i) {
    var fmt = MageStudios.Param.ItemRecoverFmt;
    ...
    if (i === 4) return MageStudios.Param.ItemAddState;
    if (i === 5) return MageStudios.Param.ItemRemoveState;
    if (i === 6) return MageStudios.Param.ItemAddBuff;
    if (i === 7) return MageStudios.Param.ItemRemoveBuff;
    return '';
};
...
Window_ItemStatus.prototype.drawItemData = function(i, dx, dy, dw) {
    ...
    if (value === '---') {
      ...
      if (value > 0) pre = '+';
      value = MageStudios.Util.toGroup(parseInt(value));
...
Window_ItemStatus.prototype.getItemIcons = function(i, array) {
    ...
    array = array.slice(0, MageStudios.Param.ItemMaxIcons);
    return array;
};
...
Window_ItemInfo.prototype.preInfoEval = function() {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, 'ITEM WINDOW PRE INFO EVAL ERROR');
    }
};
...
Window_ItemActionCommand.prototype.addUseCommand = function() {
    ...
    var fmt = MageStudios.Param.ItemUseCmd;
...
MageStudios.Item.Scene_Item_createItemWindow = Scene_Item.prototype.createItemWindow;
Scene_Item.prototype.createItemWindow = function() {
    MageStudios.Item.Scene_Item_createItemWindow.call(this);
...
MageStudios.Item.Scene_Item_onItemCancel = Scene_Item.prototype.onItemCancel;
Scene_Item.prototype.onItemCancel = function() {
    MageStudios.Item.Scene_Item_onItemCancel.call(this);
...
MageStudios.Item.Scene_Item_applyItem = Scene_Item.prototype.applyItem;
Scene_Item.prototype.applyItem = function() {
    MageStudios.Item.Scene_Item_applyItem.call(this);
