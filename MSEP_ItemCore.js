...
MageStudios.Param.ItemMaxWeapons = Number(
  MageStudios.Parameters["Max Weapons"]
);
MageStudios.Param.ItemMaxArmors = Number(MageStudios.Parameters["Max Armors"]);
MageStudios.Param.ItemStartingId = Number(
  MageStudios.Parameters["Starting ID"]
);
MageStudios.Param.ItemRandomVariance = Number(
  MageStudios.Parameters["Random Variance"]
);
MageStudios.Param.ItemNegVar = eval(
  String(MageStudios.Parameters["Negative Variance"])
);
MageStudios.Param.ItemNameFmt = String(MageStudios.Parameters["Name Format"]);
MageStudios.Param.ItemNameSpacing = String(
  MageStudios.Parameters["Name Spacing"]
);
MageStudios.Param.ItemBoostFmt = String(MageStudios.Parameters["Boost Format"]);

MageStudios.Param.ItemSceneItem = String(
  MageStudios.Parameters["Updated Scene Item"]
);
MageStudios.Param.ItemSceneItem = eval(MageStudios.Param.ItemSceneItem);
MageStudios.Param.ItemShEquipped = String(
  MageStudios.Parameters["List Equipped Items"]
);
...
MageStudios.Param.ItemCmdAlign = String(
  MageStudios.Parameters["Command Alignment"]
);
MageStudios.Param.ItemRecoverFmt = String(
  MageStudios.Parameters["Recovery Format"]
);
...
MageStudios.Param.ItemRemoveState = String(
  MageStudios.Parameters["Remove State"]
);
MageStudios.Param.ItemRemoveBuff = String(
  MageStudios.Parameters["Remove Buff"]
);
MageStudios.Param.ItemMaxIcons = Number(
  MageStudios.Parameters["Maximum Icons"]
);
...
MageStudios.Param.ItemNoteParse = String(
  MageStudios.Parameters["Midgame Note Parsing"]
);
...
MageStudios.Item.DataManager_createGameObjects = DataManager.createGameObjects;
...
MageStudios.Item.Game_Actor_changeEquipById =
  Game_Actor.prototype.changeEquipById;
...
MageStudios.Item.Game_Interpreter_gDO =
...
Game_Interpreter.prototype.gameDataOperand = function (type, param1, param2) {
  switch (type) {
    ...
    case 2:
      ...
      break;
    default:
      return MageStudios.Item.Game_Interpreter_gDO.call(
        this,
        type,
        param1,
        param2
...
Window_ItemList.prototype.drawItemCarryNumber = function (item, dx, dy, dw) {
  ...
  var text = fmt.format(
    MageStudios.Util.toGroup(index),
    MageStudios.Util.toGroup(max)
  );
...
MageStudios.Item.Window_EquipItem_includes =
...
if (MageStudios.Param.ItemSceneItem) {
  ...
  MageStudios.Item.Window_ItemCategory_maxCols =
  ...
  MageStudios.Item.Window_ItemList_initialize =
  ...
  MageStudios.Item.Window_ItemList_isEnabled =
  ...
  MageStudios.Item.Window_ItemList_updateHelp =
  ...
  MageStudios.Item.Scene_Item_createItemWindow =
