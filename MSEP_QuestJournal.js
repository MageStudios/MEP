//=============================================================================
// Mage Studios Engine Plugins - Quest Journal System
// MSEP_QuestJournal.js
//=============================================================================
...
MageStudios.Param.QuestCmdEnable = eval(MageStudios.Parameters['Enable Command']);
MageStudios.Param.QuestCmdPlace = eval(MageStudios.Parameters['Auto Place Command']);

MageStudios.Param.QuestCategoryWindow = 
  JSON.parse(MageStudios.Parameters['Quest Category Window']);
MageStudios.Param.QuestListWindow = 
  JSON.parse(MageStudios.Parameters['Quest List Window']);
MageStudios.Param.QuestTitleWindow = 
  JSON.parse(MageStudios.Parameters['Quest Title Window']);
MageStudios.Param.QuestDataWindow = 
  JSON.parse(MageStudios.Parameters['Quest Data Window']);
MageStudios.Quest.LunaticMode = 
  JSON.parse(MageStudios.Parameters['Lunatic Mode']);
...
MageStudios.Quest.questAdd = 
  JSON.parse(MageStudios.Quest.LunaticMode['Quest Add']);
...
MageStudios.Quest.questRemove = 
  JSON.parse(MageStudios.Quest.LunaticMode['Quest Remove']);
...
MageStudios.Quest.questSetCompleted = 
  JSON.parse(MageStudios.Quest.LunaticMode['Quest Complete']);
...
MageStudios.Quest.questSetFailed = 
  JSON.parse(MageStudios.Quest.LunaticMode['Quest Fail']);
...
MageStudios.Quest.questSetAvailable = 
  JSON.parse(MageStudios.Quest.LunaticMode['Quest Available']);
...
MageStudios.Quest.questChangeDescriptionIndex = 
  JSON.parse(MageStudios.Quest.LunaticMode['Change Description']);
...
MageStudios.Quest.questObjectivesShow = 
  JSON.parse(MageStudios.Quest.LunaticMode['Show Objective']);
...
MageStudios.Quest.questObjectivesHide = 
  JSON.parse(MageStudios.Quest.LunaticMode['Hide Objective']);
...
MageStudios.Quest.questObjectivesNormal = 
  JSON.parse(MageStudios.Quest.LunaticMode['Normalize Objective']);
...
MageStudios.Quest.questObjectivesComplete = 
  JSON.parse(MageStudios.Quest.LunaticMode['Complete Objective']);
...
MageStudios.Quest.questObjectivesFail = 
  JSON.parse(MageStudios.Quest.LunaticMode['Fail Objective']);
...
MageStudios.Quest.questRewardsShow = 
  JSON.parse(MageStudios.Quest.LunaticMode['Show Reward']);
...
MageStudios.Quest.questRewardsHide = 
  JSON.parse(MageStudios.Quest.LunaticMode['Hide Reward']);
...
MageStudios.Quest.questRewardsNormal = 
  JSON.parse(MageStudios.Quest.LunaticMode['Normalize Reward']);
...
MageStudios.Quest.questRewardsClaim = 
  JSON.parse(MageStudios.Quest.LunaticMode['Claim Reward']);
...
MageStudios.Quest.questRewardsDeny = 
  JSON.parse(MageStudios.Quest.LunaticMode['Deny Reward']);
...
MageStudios.Quest.questChangeSubtextIndexEval = 
  JSON.parse(MageStudios.Quest.LunaticMode['Change Subtext']);
...
Window_QuestData._questNoDataFmt = 
  JSON.parse(MageStudios.Param.QuestDataWindow['No Data Text'] || "");
...
Window_QuestData.prototype.drawQuestData = function() {
  Window_QuestData._questDataFmt = 
    JSON.parse(MageStudios.Param.QuestDataWindow['Quest Data Format'] || "");
...
Window_QuestList.prototype.initialize = function(cw, dw, tw) {
  this._currentCategory =
    JSON.parse(MageStudios.Param.QuestCategoryWindow['Category Order'])[0];
...
MageStudios.Quest.createBefore = 
  JSON.parse(MageStudios.Quest.LunaticMode['Before Create Windows']);
MageStudios.Quest.createAfter = 
  JSON.parse(MageStudios.Quest.LunaticMode['After Create Windows']);
MageStudios.Quest.terminateMenu = 
  JSON.parse(MageStudios.Quest.LunaticMode['Close Quest Menu']);
