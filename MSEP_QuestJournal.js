...
Imported.MSEP_QuestJournal = true;

var MageStudios = MageStudios || {};
MageStudios.Quest = MageStudios.Quest || {};
MageStudios.Quest.version = 1.0;
 ...
 * over the world.
 *
 * Word Wrap Version (Requires MSEP_MessageCore.js):
 ...
 * manually. Go into the plugin parameters for MSEP_QuestJournal.js and look for
 ...
 *
 *       Name: MageStudios.Param.QuestCmdName
 *     Symbol: quest
 ...
 * @default {"---Quest Menu---":"","Before Create Windows":"\"
 *
 * @param ---Quest List---
 * @default
 *
...
if (Utils.RPGMAKER_VERSION && Utils.RPGMAKER_VERSION >= "1.3.5") {
  ...
  MageStudios.Param.QuestCmdName = String(
    MageStudios.Parameters["Quest Command"]
  );
  MageStudios.Param.QuestCmdShow = eval(MageStudios.Parameters["Show Command"]);
  MageStudios.Param.QuestCmdEnable = eval(
    MageStudios.Parameters["Enable Command"]
  );
  MageStudios.Param.QuestCmdPlace = eval(
    MageStudios.Parameters["Auto Place Command"]
  );

  MageStudios.Param.QuestCategoryWindow = JSON.parse(
    MageStudios.Parameters["Quest Category Window"]
  );
  MageStudios.Param.QuestListWindow = JSON.parse(
    MageStudios.Parameters["Quest List Window"]
  );
  MageStudios.Param.QuestTitleWindow = JSON.parse(
    MageStudios.Parameters["Quest Title Window"]
  );
  MageStudios.Param.QuestDataWindow = JSON.parse(
    MageStudios.Parameters["Quest Data Window"]
  );
  MageStudios.Quest.LunaticMode = JSON.parse(
    MageStudios.Parameters["Lunatic Mode"]
  );

  MageStudios.Quest.TouchInput_onMouseMove = TouchInput._onMouseMove;
  TouchInput._onMouseMove = function (event) {
    MageStudios.Quest.TouchInput_onMouseMove.call(this, event);
    this._mouseOverX = Graphics.pageToCanvasX(event.pageX);
    this._mouseOverY = Graphics.pageToCanvasY(event.pageY);
  };

  var $dataQuests = [null];
  MageStudios.Quest.totalCount = 0;
  ...
  DataManager.questDatabaseAdd = function (id, data) {
    ...
    $dataQuests[id] = quest;
    MageStudios.Quest.totalCount += 1;
  };
  ...
  MageStudios.Quest.Game_System_initialize = Game_System.prototype.initialize;
  Game_System.prototype.initialize = function () {
    MageStudios.Quest.Game_System_initialize.call(this);
    this.initQuestSettings();
  };

  Game_System.prototype.initQuestSettings = function () {
    this._showQuest = this._showQuest || MageStudios.Param.QuestCmdShow;
    this._enableQuest = this._enableQuest || MageStudios.Param.QuestCmdEnable;
  ...
  MageStudios.Quest.questAdd = JSON.parse(
    MageStudios.Quest.LunaticMode["Quest Add"]
  );
  Game_System.prototype.questAddCustomEval = function (questId) {
    eval(MageStudios.Quest.questAdd);
  };
  ...
  MageStudios.Quest.questRemove = JSON.parse(
    MageStudios.Quest.LunaticMode["Quest Remove"]
  );
  Game_System.prototype.questRemoveCustomEval = function (questId) {
    eval(MageStudios.Quest.questRemove);
  };
  ...
  MageStudios.Quest.questSetCompleted = JSON.parse(
    MageStudios.Quest.LunaticMode["Quest Complete"]
  );
  Game_System.prototype.questSetCompletedEval = function (questId) {
    eval(MageStudios.Quest.questSetCompleted);
  };
  ...
  MageStudios.Quest.questSetFailed = JSON.parse(
    MageStudios.Quest.LunaticMode["Quest Fail"]
  );
  Game_System.prototype.questSetFailedEval = function (questId) {
    eval(MageStudios.Quest.questSetFailed);
  };
  ...
  MageStudios.Quest.questSetAvailable = JSON.parse(
    MageStudios.Quest.LunaticMode["Quest Available"]
  );
  Game_System.prototype.questSetAvailableEval = function (questId) {
    eval(MageStudios.Quest.questSetAvailable);
  };
  ...
  Game_System.prototype.questChangeDescriptionIndex = function (
    questId,
    index
  ) {
    this.initQuestSettings();
  ...
  MageStudios.Quest.questChangeDescriptionIndex = JSON.parse(
    MageStudios.Quest.LunaticMode["Change Description"]
  );
  Game_System.prototype.questChangeDescIndexEval = function (questId, index) {
    eval(MageStudios.Quest.questChangeDescriptionIndex);
  };
  ...
  MageStudios.Quest.questObjectivesShow = JSON.parse(
    MageStudios.Quest.LunaticMode["Show Objective"]
  );
  Game_System.prototype.questObjectivesShowEval = function (questId, obj) {
    var objectiveId = obj;
    eval(MageStudios.Quest.questObjectivesShow);
  };
  ...
  MageStudios.Quest.questObjectivesHide = JSON.parse(
    MageStudios.Quest.LunaticMode["Hide Objective"]
  );
  Game_System.prototype.questObjectivesHideEval = function (questId, obj) {
    var objectiveId = obj;
    eval(MageStudios.Quest.questObjectivesHide);
  };
  ...
  Game_System.prototype.questObjectivesNormal = function (
    questId,
    objectiveId
  ) {
    this.initQuestSettings();
  ...
  MageStudios.Quest.questObjectivesNormal = JSON.parse(
    MageStudios.Quest.LunaticMode["Normalize Objective"]
  );
  Game_System.prototype.questObjectivesNormalEval = function (questId, obj) {
    var objectiveId = obj;
    eval(MageStudios.Quest.questObjectivesNormal);
  };
  ...
  Game_System.prototype.questObjectivesComplete = function (
    questId,
    objectiveId
  ) {
    this.initQuestSettings();
  ...
  MageStudios.Quest.questObjectivesComplete = JSON.parse(
    MageStudios.Quest.LunaticMode["Complete Objective"]
  );
  Game_System.prototype.questObjectivesCompleteEval = function (questId, obj) {
    var objectiveId = obj;
    eval(MageStudios.Quest.questObjectivesComplete);
  };

  Game_System.prototype.questObjectivesCompleteRange = function (
    questId,
    range
  ) {
    var length = range.length;
  ...
  MageStudios.Quest.questObjectivesFail = JSON.parse(
    MageStudios.Quest.LunaticMode["Fail Objective"]
  );
  Game_System.prototype.questObjectivesFailEval = function (questId, obj) {
    var objectiveId = obj;
    eval(MageStudios.Quest.questObjectivesFail);
  };
  ...
  MageStudios.Quest.questRewardsShow = JSON.parse(
    MageStudios.Quest.LunaticMode["Show Reward"]
  );
  Game_System.prototype.questRewardsShowEval = function (questId, rewardId) {
    eval(MageStudios.Quest.questRewardsShow);
  };
  ...
  MageStudios.Quest.questRewardsHide = JSON.parse(
    MageStudios.Quest.LunaticMode["Hide Reward"]
  );
  Game_System.prototype.questRewardsHideEval = function (questId, rewardId) {
    eval(MageStudios.Quest.questRewardsHide);
  };
  ...
  MageStudios.Quest.questRewardsNormal = JSON.parse(
    MageStudios.Quest.LunaticMode["Normalize Reward"]
  );
  Game_System.prototype.questRewardsNormalEval = function (questId, rewardId) {
    eval(MageStudios.Quest.questRewardsNormal);
  };
  ...
  MageStudios.Quest.questRewardsClaim = JSON.parse(
    MageStudios.Quest.LunaticMode["Claim Reward"]
  );
  Game_System.prototype.questRewardsClaimEval = function (questId, rewardId) {
    eval(MageStudios.Quest.questRewardsClaim);
  };
  ...
  MageStudios.Quest.questRewardsDeny = JSON.parse(
    MageStudios.Quest.LunaticMode["Deny Reward"]
  );
  Game_System.prototype.questRewardsDenyEval = function (questId, rewardId) {
    eval(MageStudios.Quest.questRewardsDeny);
  };
  ...
  MageStudios.Quest.questChangeSubtextIndexEval = JSON.parse(
    MageStudios.Quest.LunaticMode["Change Subtext"]
  );
  Game_System.prototype.questChangeSubtextIndexEval = function (
    questId,
    index
  ) {
    eval(MageStudios.Quest.questChangeSubtextIndexEval);
  };
  ...
  Game_System.prototype.totalQuestsInGame = function () {
    return MageStudios.Quest.totalCount;
  };
  ...
  Game_System.prototype.isQuestObjectiveUncleared = function (questId, objId) {
    if (this._questsKnown.contains(questId)) {
      return (
        !this.isQuestObjectiveCompleted(questId, objId) &&
  ...
  Game_System.prototype.isQuestRewardUnclaimed = function (questId, objId) {
    if (this._questsKnown.contains(questId)) {
      return (
        !this.isQuestRewardClaimed(questId, objId) &&
  ...
  MageStudios.Quest.Game_Interpreter_pluginCommand =
    Game_Interpreter.prototype.pluginCommand;
  Game_Interpreter.prototype.pluginCommand = function (command, args) {
    MageStudios.Quest.Game_Interpreter_pluginCommand.call(this, command, args);
  ...
  MageStudios.Quest.Window_MenuCommand_addOriginalCommands =
    Window_MenuCommand.prototype.addOriginalCommands;
  Window_MenuCommand.prototype.addOriginalCommands = function () {
    MageStudios.Quest.Window_MenuCommand_addOriginalCommands.call(this);
    this.addQuestCommand();
  };

  Window_MenuCommand.prototype.addQuestCommand = function () {
    if (!MageStudios.Param.QuestCmdPlace) return;
    if (!$gameSystem.isShowQuest()) return;
    if (this.findSymbol("quest") > -1) return;
    var text = MageStudios.Param.QuestCmdName;
  ...
  Window_QuestData.prototype.settings = function (key) {
    return MageStudios.Param.QuestDataWindow[key];
  };
  ...
  Window_QuestData._questNoDataFmt = JSON.parse(
    MageStudios.Param.QuestDataWindow["No Data Text"] || ""
  );
  ...
  Window_QuestData.prototype.drawQuestData = function () {
    Window_QuestData._questDataFmt = JSON.parse(
      MageStudios.Param.QuestDataWindow["Quest Data Format"] || ""
    );
  ...
  Window_QuestData.prototype.scrollOriginDown = function (speed) {
    var value =
      this.contentsHeight() - this.height + this.standardPadding() * 2;
  ...
  Window_QuestTitle.prototype.settings = function (key) {
    return MageStudios.Param.QuestTitleWindow[key];
  };
  ...
  Window_QuestCategories.prototype.settings = function (key) {
    return MageStudios.Param.QuestCategoryWindow[key];
  };
  ...
  Window_QuestCategories.prototype.makeCommandList = function () {
    ...
    for (var i = 0; i < length; ++i) {
      ...
      number = MageStudios.Util.toGroup(number);
  ...
  Window_QuestList.prototype.initialize = function (cw, dw, tw) {
    this._currentCategory = JSON.parse(
      MageStudios.Param.QuestCategoryWindow["Category Order"]
    )[0];
  ...
  Window_QuestList.prototype.settings = function (key) {
    return MageStudios.Param.QuestListWindow[key];
  };
  ...
  Window_QuestList.prototype.makeQuestList = function () {
    if (this.showType()) {
      ...
      for (var i = 0; i < length; ++i) {
        ...
        var number = $gameSystem.getTypeQuests(
  ...
  MageStudios.Quest.Scene_Menu_createCommandWindow =
    Scene_Menu.prototype.createCommandWindow;
  Scene_Menu.prototype.createCommandWindow = function () {
    MageStudios.Quest.Scene_Menu_createCommandWindow.call(this);
  ...
  Scene_Quest.prototype.create = function () {
    ...
    this.runCustomCode(MageStudios.Quest.createBefore);
    this.createDataWindow();
    this.createTitleWindow();
    this.createCategoryWindow();
    this.createListWindow();
    this.processQuestOpen();
    this.runCustomCode(MageStudios.Quest.createAfter);
  };

  MageStudios.Quest.createBefore = JSON.parse(
    MageStudios.Quest.LunaticMode["Before Create Windows"]
  );
  MageStudios.Quest.createAfter = JSON.parse(
    MageStudios.Quest.LunaticMode["After Create Windows"]
  );
  MageStudios.Quest.terminateMenu = JSON.parse(
    MageStudios.Quest.LunaticMode["Close Quest Menu"]
  );
  ...
  Scene_Quest.prototype.createListWindow = function () {
    this._listWindow = new Window_QuestList(
    ...
    this._listWindow.setHandler(
      "readQuest",
      this.dataWindowActivate.bind(this)
    );
    this.addWindow(this._listWindow);
  };

  Scene_Quest.prototype.onCategoryCancel = function () {
    this.runCustomCode(MageStudios.Quest.terminateMenu);
    this.popScene();
  };
