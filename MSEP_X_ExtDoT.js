//=============================================================================
// Mage Studios Engine Plugins - Buffs & States Extension - Extended Damage Over Time
// MSEP_X_ExtDoT.js
//=============================================================================
...
MageStudios.Param.EDoTDamageAni = Number(MageStudios.Parameters['DoT Animation']);
MageStudios.Param.EDoTDefVariance = Number(MageStudios.Parameters['Default Variance']);
MageStudios.Param.EDoTDefElement = Number(MageStudios.Parameters['Default Element']);
...
// Game_Battler
// ----------------------------------------------------------------------------
// Compatibility with MSEP_BuffsStatesCore
//=============================================================================

MageStudios.EDoT.Game_Battler_regenerateAll = Game_Battler.prototype.regenerateAll;
...
Game_Battler.prototype.processDamageOverTimeStateEffect = function(state) {
  ...
  try {
    ...
    MageStudios.Util.displayError(e, code, 'CUSTOM DOT ' + stateId + ' CODE ERROR');
  }
};
