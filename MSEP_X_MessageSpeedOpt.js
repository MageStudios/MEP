...
MageStudios.MsgSpdOpt.version = 1.0;
...
if (Imported.MSEP_MessageCore) {
  ...
  MageStudios.Param.MsgSpeedOptCmd = String(
    MageStudios.Parameters["OptionsCommand"]
  );
  MageStudios.Param.MsgSpeedOptDefault = Number(
    MageStudios.Parameters["DefaultSpeed"]
  );
  MageStudios.Param.MsgSpeedOptInstant = String(
    MageStudios.Parameters["InstantText"]
  );
  ...
  MageStudios.MsgSpdOpt.Window_Message_newPage =
  ...
  MageStudios.MsgSpdOpt.Window_Options_statusText =
  ...
  if (!Imported.MSEP_OptionsCore) {
    MageStudios.MsgSpdOpt.Window_Options_processOk =
