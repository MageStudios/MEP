//=============================================================================
// Mage Studios Engine Plugins - Core Engine
// MSEP_CoreEngine.js
//=============================================================================

var Imported = Imported || {};
Imported.MSEP_CoreEngine = true;
 ...
 * ============================================================================
 *
 * Mage Studios Engine Plugins - Core Engine is made for RPG Maker MV. This plugin
 ...
 * colors, and more.
 *
 * Just place this on top of all the other Mage Studios Engine Plugins.
...
MageStudios.Param.ScreenWidth  = Number(MageStudios.Parameters['Screen Width'] || 816);
MageStudios.Param.ScreenHeight = Number(MageStudios.Parameters['Screen Height'] || 624);
MageStudios.Param.ScaleBattleback = String(MageStudios.Parameters['Scale Battlebacks']);
MageStudios.Param.ScaleBattleback = eval(MageStudios.Param.ScaleBattleback);
MageStudios.Param.ScaleTitle = eval(String(MageStudios.Parameters['Scale Title']));
MageStudios.Param.ScaleGameOver = eval(String(MageStudios.Parameters['Scale Game Over']));
MageStudios.Param.OpenConsole = String(MageStudios.Parameters['Open Console']);
MageStudios.Param.OpenConsole = eval(MageStudios.Param.OpenConsole);
MageStudios.Param.ReposBattlers = String(MageStudios.Parameters['Reposition Battlers']);
MageStudios.Param.ReposBattlers = eval(MageStudios.Param.ReposBattlers);
MageStudios.Param.GameFontTimer = Number(MageStudios.Parameters['GameFont Load Timer']);
MageStudios.Param.UpdateRealScale = String(MageStudios.Parameters['Update Real Scale']);
MageStudios.Param.UpdateRealScale = eval(MageStudios.Param.UpdateRealScale);
MageStudios.Param.CollectionClear = String(MageStudios.Parameters['Collection Clear']);
MageStudios.Param.CollectionClear = eval(MageStudios.Param.CollectionClear);

MageStudios.Param.MaxGold = String(MageStudios.Parameters['Gold Max']);
MageStudios.Param.GoldFontSize = Number(MageStudios.Parameters['Gold Font Size']);
MageStudios.Icon.Gold = Number(MageStudios.Parameters['Gold Icon']);
MageStudios.Param.GoldOverlap = String(MageStudios.Parameters['Gold Overlap']);

MageStudios.Param.MaxItem = Number(MageStudios.Parameters['Default Max']);
MageStudios.Param.ItemQuantitySize = Number(MageStudios.Parameters['Quantity Text Size']);

MageStudios.Param.MaxLevel = Number(MageStudios.Parameters['Max Level']);
MageStudios.Param.EnemyMaxHp = Number(MageStudios.Parameters['Enemy MaxHP']);
MageStudios.Param.EnemyMaxMp = Number(MageStudios.Parameters['Enemy MaxMP']);
MageStudios.Param.EnemyParam = Number(MageStudios.Parameters['Enemy Parameter']);
MageStudios.Param.ActorMaxHp = Number(MageStudios.Parameters['Actor MaxHP']);
MageStudios.Param.ActorMaxMp = Number(MageStudios.Parameters['Actor MaxMP']);
MageStudios.Param.ActorParam = Number(MageStudios.Parameters['Actor Parameter']);

MageStudios.Param.AnimationRate = Number(MageStudios.Parameters['Animation Rate']);
MageStudios.Param.FlashTarget = eval(String(MageStudios.Parameters['Flash Target']));
MageStudios.Param.ShowEvTrans = String(MageStudios.Parameters['Show Events Transition']);
MageStudios.Param.ShowEvTrans = eval(MageStudios.Param.ShowEvTrans);
MageStudios.Param.ShowEvSnap = String(MageStudios.Parameters['Show Events Snapshot']);
MageStudios.Param.ShowEvSnap = eval(MageStudios.Param.ShowEvSnap);

MageStudios.Param.RefreshUpdateHp = String(MageStudios.Parameters['Refresh Update HP']);
MageStudios.Param.RefreshUpdateHp = eval(MageStudios.Param.RefreshUpdateHp);
MageStudios.Param.RefreshUpdateMp = String(MageStudios.Parameters['Refresh Update MP']);
MageStudios.Param.RefreshUpdateMp = eval(MageStudios.Param.RefreshUpdateMp);
MageStudios.Param.RefreshUpdateTp = String(MageStudios.Parameters['Refresh Update TP']);
MageStudios.Param.RefreshUpdateTp = eval(MageStudios.Param.RefreshUpdateTp);

MageStudios.Param.ChineseFont = String(MageStudios.Parameters['Chinese Font']);
MageStudios.Param.KoreanFont = String(MageStudios.Parameters['Korean Font']);
MageStudios.Param.DefaultFont = String(MageStudios.Parameters['Default Font']);
MageStudios.Param.FontSize = Number(MageStudios.Parameters['Font Size']);
MageStudios.Param.TextAlign = String(MageStudios.Parameters['Text Align']);

MageStudios.Param.DigitGroup = eval(String(MageStudios.Parameters['Digit Grouping']));
MageStudios.Param.LineHeight = Number(MageStudios.Parameters['Line Height']);
MageStudios.Param.IconWidth = Number(MageStudios.Parameters['Icon Width'] || 32);;
MageStudios.Param.IconHeight = Number(MageStudios.Parameters['Icon Height'] || 32);;
MageStudios.Param.FaceWidth = Number(MageStudios.Parameters['Face Width'] || 144);
MageStudios.Param.FaceHeight = Number(MageStudios.Parameters['Face Height'] || 144);
MageStudios.Param.WindowPadding = Number(MageStudios.Parameters['Window Padding']);
MageStudios.Param.TextPadding = Number(MageStudios.Parameters['Text Padding']);
MageStudios.Param.WindowOpacity = Number(MageStudios.Parameters['Window Opacity']);
MageStudios.Param.GaugeOutline = eval(String(MageStudios.Parameters['Gauge Outline']));
MageStudios.Param.GaugeHeight = Number(MageStudios.Parameters['Gauge Height']);
MageStudios.Param.MenuTpGauge = eval(String(MageStudios.Parameters['Menu TP Bar']));

MageStudios.Param.ColorNormal = Number(MageStudios.Parameters['Color: Normal']);
MageStudios.Param.ColorSystem = Number(MageStudios.Parameters['Color: System']);
MageStudios.Param.ColorCrisis = Number(MageStudios.Parameters['Color: Crisis']);
MageStudios.Param.ColorDeath = Number(MageStudios.Parameters['Color: Death']);
MageStudios.Param.ColorGaugeBack = Number(MageStudios.Parameters['Color: Gauge Back']);
MageStudios.Param.ColorHpGauge1 = Number(MageStudios.Parameters['Color: HP Gauge 1']);
MageStudios.Param.ColorHpGauge2 = Number(MageStudios.Parameters['Color: HP Gauge 2']);
MageStudios.Param.ColorMpGauge1 = Number(MageStudios.Parameters['Color: MP Gauge 1']);
MageStudios.Param.ColorMpGauge2 = Number(MageStudios.Parameters['Color: MP Gauge 2']);
MageStudios.Param.ColorMpCost = Number(MageStudios.Parameters['Color: MP Cost']);
MageStudios.Param.ColorPowerUp = Number(MageStudios.Parameters['Color: Power Up']);
MageStudios.Param.ColorPowerDown = Number(MageStudios.Parameters['Color: Power Down']);
MageStudios.Param.ColorTpGauge1 = Number(MageStudios.Parameters['Color: TP Gauge 1']);
MageStudios.Param.ColorTpGauge2 = Number(MageStudios.Parameters['Color: TP Gauge 2']);
MageStudios.Param.ColorTpCost = Number(MageStudios.Parameters['Color: TP Cost Color']);

//=============================================================================
// Bitmap
//=============================================================================

MageStudios.Core.Bitmap_initialize = Bitmap.prototype.initialize;
Bitmap.prototype.initialize = function(width, height) {
  MageStudios.Core.Bitmap_initialize.call(this, width, height);
  this.fontFace = MageStudios.Param.DefaultFont;
};

MageStudios.Core.Bitmap_blt = Bitmap.prototype.blt;
Bitmap.prototype.blt = function(source, sx, sy, sw, sh, dx, dy, dw, dh) {
    ...
    dw = Math.floor(dw);
    dh = Math.floor(dh);
    MageStudios.Core.Bitmap_blt.call(this, source, sx, sy, sw, sh, dx, dy, dw, dh);
};

MageStudios.Core.Bitmap_fillRect = Bitmap.prototype.fillRect;
Bitmap.prototype.fillRect = function(x, y, w, h, c) {
    x = Math.floor(x);
    y = Math.floor(y);
    w = Math.floor(w);
    h = Math.floor(h);
    MageStudios.Core.Bitmap_fillRect.call(this, x, y, w, h, c);
};

MageStudios.Core.Bitmap_gradientFillRect = Bitmap.prototype.gradientFillRect;
Bitmap.prototype.gradientFillRect = function(x, y, w, h, c1, c2, ve) {
    MageStudios.Core.Bitmap_gradientFillRect.call(this, x, y, w, h, c1, c2, ve);
};

MageStudios.Core.Bitmap_drawCircle = Bitmap.prototype.drawCircle;
Bitmap.prototype.drawCircle = function(x, y, r, c) {
    x = Math.floor(x);
    y = Math.floor(y);
    MageStudios.Core.Bitmap_drawCircle.call(this, x, y, r, c);
};

MageStudios.Core.Bitmap_drawText = Bitmap.prototype.drawText;
Bitmap.prototype.drawText = function(text, x, y, mW, l, align) {
    ...
    mW = Math.floor(mW);
    l = Math.floor(l);
    MageStudios.Core.Bitmap_drawText.call(this, text, x, y, mW, l, align);
};
...
if (MageStudios.Param.UpdateRealScale) {
...
}; // MageStudios.Param.UpdateRealScale
...
MageStudios.Core.Graphics_updateErrorPrinter = Graphics._updateErrorPrinter;
Graphics._updateErrorPrinter = function() {
  MageStudios.Core.Graphics_updateErrorPrinter.call(this);
...
MageStudios.Core.Input_shouldPreventDefault = Input._shouldPreventDefault;
Input._shouldPreventDefault = function(keyCode) {
  if (keyCode === 9) return true;
  return MageStudios.Core.Input_shouldPreventDefault.call(this, keyCode);
};
...
MageStudios.Core.Sprite_updateTransform = Sprite.prototype.updateTransform;
Sprite.prototype.updateTransform = function() {
  MageStudios.Core.Sprite_updateTransform.call(this);
...
MageStudios.Core.ScreenSprite_initialize = ScreenSprite.prototype.initialize;
ScreenSprite.prototype.initialize = function() {
  MageStudios.Core.ScreenSprite_initialize.call(this);
...
MageStudios.Core.Window_refreshAllParts = Window.prototype._refreshAllParts;
Window.prototype._refreshAllParts = function() {
  this._roundWhUp();
  MageStudios.Core.Window_refreshAllParts.call(this);
};
...
MageStudios.Core.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function() {
  if (!MageStudios.Core.DataManager_isDatabaseLoaded.call(this)) return false;
  if (!MageStudios._loaded_MSEP_CoreEngine) {
    ...
    MageStudios._loaded_MSEP_CoreEngine = true;
  }
  return true;
};
...
DataManager.processCORENotetags1 = function(group) {
  for (var n = 1; n < group.length; n++) {
    ...
    obj.maxItem = MageStudios.Param.MaxItem;
...
DataManager.processCORENotetags3 = function(group) {
  for (var n = 1; n < group.length; n++) {
    ...
    obj.maxLevel = MageStudios.Param.MaxLevel;
...
MageStudios.Core.AudioManager_playSe = AudioManager.playSe;
AudioManager.playSe = function(se) {
    this._frameSe = this._frameSe || [];
    if (this.uniqueCheckSe(se)) {
      MageStudios.Core.AudioManager_playSe.call(this, se);
...
MageStudios.Core.SceneManager_updateInputData = SceneManager.updateInputData;
SceneManager.updateInputData = function() {
    MageStudios.Core.SceneManager_updateInputData.call(this);
...
SceneManager._screenWidth  = MageStudios.Param.ScreenWidth;
SceneManager._screenHeight = MageStudios.Param.ScreenHeight;
SceneManager._boxWidth     = MageStudios.Param.ScreenWidth;
SceneManager._boxHeight    = MageStudios.Param.ScreenHeight

MageStudios.Core.SceneManager_run = SceneManager.run;
SceneManager.run = function(sceneClass) {
  MageStudios.Core.SceneManager_run.call(this, sceneClass);
  MageStudios.updateResolution();
  if (!Utils.isNwjs()) return;
  if (Utils.RPGMAKER_VERSION && Utils.RPGMAKER_VERSION >= "1.6.0") return;
  if (MageStudios.Param.OpenConsole) MageStudios.openConsole();
};

MageStudios.updateResolution = function() {
  var resizeWidth = MageStudios.Param.ScreenWidth - window.innerWidth;
  var resizeHeight = MageStudios.Param.ScreenHeight - window.innerHeight;
...
MageStudios.openConsole = function() {
  MageStudios._openedConsole = true;
...
MageStudios.Core.SceneManager_onKeyDown = SceneManager.onKeyDown;
SceneManager.onKeyDown = function(event) {
  ...
  MageStudios.Core.SceneManager_onKeyDown.call(this, event);
};
...
MageStudios.openConsole = function() {
  MageStudios._openedConsole = true;
  if (!MageStudios.Param.OpenConsole) return;
  if (Utils.isNwjs() && Utils.isOptionValid('test')) {
    var win = require('nw.gui').Window.get();
    win.showDevTools();
...
MageStudios.focusWindow = function(win) {
  win.focus();
};

MageStudios.Core.Scene_Map_update = Scene_Map.prototype.update;
Scene_Map.prototype.update = function() {
  MageStudios.Core.Scene_Map_update.call(this);
  if (!MageStudios._openedConsole) MageStudios.openConsole();
};

MageStudios.Core.Scene_Battle_update = Scene_Battle.prototype.update;
Scene_Battle.prototype.update = function() {
  MageStudios.Core.Scene_Battle_update.call(this);
  if (!MageStudios._openedConsole) MageStudios.openConsole();
};
...
MageStudios.Core.BattleManager_displayStartMessages =
    BattleManager.displayStartMessages;
BattleManager.displayStartMessages = function() {
  MageStudios.Core.BattleManager_displayStartMessages.call(this);
...
Game_BattlerBase.prototype.paramMax = function(paramId) {
    if (paramId === 0) {
        return MageStudios.Param.EnemyMaxHp;
    } else if (paramId === 1) {
        return MageStudios.Param.EnemyMaxMp;
    } else {
        return MageStudios.Param.EnemyParam;
    }
};

MageStudios.Core.Game_BattlerBase_refresh = Game_BattlerBase.prototype.refresh;

Game_BattlerBase.prototype.mapRegenUpdateCheck = function(type) {
  if ($gameParty.inBattle()) return true;
  if (type === 'hp') {
    return MageStudios.Param.RefreshUpdateHp;
  } else if (type === 'mp') {
    return MageStudios.Param.RefreshUpdateMp;
  } else if (type === 'tp') {
    return MageStudios.Param.RefreshUpdateTp;
  }
};
...
Game_BattlerBase.prototype.setHp = function(hp) {
  ...
  if (this.mapRegenUpdateCheck('hp')) {
    ...
    MageStudios.Core.Game_BattlerBase_refresh.call(this);
  }
};
...
MageStudios.Core.Game_Actor_isMaxLevel = Game_Actor.prototype.isMaxLevel;
Game_Actor.prototype.isMaxLevel = function() {
    if (this.maxLevel() === 0) return false;
    return MageStudios.Core.Game_Actor_isMaxLevel.call(this);
};

Game_Actor.prototype.paramMax = function(paramId) {
  if (paramId === 0) {
      return MageStudios.Param.ActorMaxHp;
  } else if (paramId === 1) {
      return MageStudios.Param.ActorMaxMp;
  } else {
      return MageStudios.Param.ActorParam;
  }
};

MageStudios.Core.Game_Actor_paramBase = Game_Actor.prototype.paramBase;
Game_Actor.prototype.paramBase = function(paramId) {
    ...
    return MageStudios.Core.Game_Actor_paramBase.call(this, paramId);
};
...
Game_Party.prototype.maxGold = function() {
    return eval(MageStudios.Param.MaxGold);
};
...
MageStudios.isPreventScreenJittering = function() {
  if (Utils.RPGMAKER_VERSION && Utils.RPGMAKER_VERSION >= '1.3.4') return false;
  return true;
};

if (MageStudios.isPreventScreenJittering()) {
...
}; // MageStudios.isPreventScreenJittering
...
MageStudios.Core.Game_Event_setMoveRoute =
    Game_Event.prototype.setMoveRoute;
Game_Character.prototype.setMoveRoute = function(moveRoute) {
    if (!this._moveRouteForcing) {
        MageStudios.Core.Game_Event_setMoveRoute.call(this, moveRoute);
    } else {
        this.queueMoveRoute(moveRoute);
    }
};

MageStudios.Core.Game_Character_processMoveCommand =
...
Game_Character.prototype.processMoveCommand = function(command) {
  ...
  case gc.ROUTE_SCRIPT:
    try {
      ...
      MageStudios.Util.displayError(e, params[0], 'MOVE ROUTE SCRIPT ERROR');
    }
    return;
    break;
  }
  return MageStudios.Core.Game_Character_processMoveCommand.call(this, command);
};
...
MageStudios.Core.Game_Action_testItemEffect = Game_Action.prototype.testItemEffect;
Game_Action.prototype.testItemEffect = function(target, effect) {
    switch (effect.code) {
    case Game_Action.EFFECT_LEARN_SKILL:
      return target.isActor() && !target._skills.contains(effect.dataId);
    default:
      return MageStudios.Core.Game_Action_testItemEffect.call(this, target, effect);
    }
};
...
Game_Action.prototype.evalDamageFormula = function(target) {
  ...
  try {
    var value = Math.max(eval(item.daMageStudios.formula), 0) * sign;
...
// Conditional Branch
MageStudios.Core.Game_Interpreter_command111 =
...
Game_Interpreter.prototype.command111 = function() {
  ...
  case 12:  // Script
    ...
    try {
      ...
      result = false;
      MageStudios.Util.displayError(e, code, 'CONDITIONAL BRANCH SCRIPT ERROR');
    }
    this._branch[this._indent] = result;
    if (this._branch[this._indent] === false) this.skipBranch();
    return true
  ...
  return MageStudios.Core.Game_Interpreter_command111.call(this);
};

// Control Variables
MageStudios.Core.Game_Interpreter_command122 =
...
Game_Interpreter.prototype.command122 = function() {
  ...
  case 4:  // Script
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, 'CONTROL VARIABLE SCRIPT ERROR');
    }
  ...
  return MageStudios.Core.Game_Interpreter_command122.call(this);
};
...
Game_Interpreter.prototype.command355 = function() {
  ...
  try {
    ...
    MageStudios.Util.displayError(e, script, 'SCRIPT CALL ERROR');
  }
  return true;
};

MageStudios.Core.Game_Interpreter_pluginCommand =
    Game_Interpreter.prototype.pluginCommand;
Game_Interpreter.prototype.pluginCommand = function(command, args) {
    MageStudios.Core.Game_Interpreter_pluginCommand.call(this, command, args);
    if (command === 'GainGold') {
...
if (MageStudios.Param.CollectionClear) {

MageStudios.Core.Scene_Base_terminate = Scene_Base.prototype.terminate;
Scene_Base.prototype.terminate = function() {
  MageStudios.Core.Scene_Base_terminate.call(this);
  if (this._bypassFirstClear) return;
  this.clearChildren();
};

MageStudios.Core.Scene_Title_terminate = Scene_Title.prototype.terminate;
Scene_Title.prototype.terminate = function() {
  this._bypassFirstClear = true;
  MageStudios.Core.Scene_Title_terminate.call(this);
  this.clearChildren();
};

MageStudios.Core.Scene_Map_terminate = Scene_Map.prototype.terminate;
Scene_Map.prototype.terminate = function() {
  this._bypassFirstClear = true;
  MageStudios.Core.Scene_Map_terminate.call(this);
  this.clearChildren();
};

MageStudios.Core.Scene_Battle_terminate = Scene_Battle.prototype.terminate;
Scene_Battle.prototype.terminate = function() {
  this._bypassFirstClear = true;
  MageStudios.Core.Scene_Battle_terminate.call(this);
  this.clearChildren();
};

MageStudios.Core.Scene_Options_terminate = Scene_Options.prototype.terminate;
Scene_Options.prototype.terminate = function() {
  this._bypassFirstClear = true;
  MageStudios.Core.Scene_Options_terminate.call(this);
  this.clearChildren();
};

MageStudios.Core.Scene_Load_terminate = Scene_Load.prototype.terminate;
Scene_Load.prototype.terminate = function() {
  this._bypassFirstClear = true;
  MageStudios.Core.Scene_Load_terminate.call(this);
  this.clearChildren();
};

MageStudios.Core.Scene_Gameover_terminate = Scene_Gameover.prototype.terminate;
Scene_Gameover.prototype.terminate = function() {
  this._bypassFirstClear = true;
  MageStudios.Core.Scene_Gameover_terminate.call(this);
  this.clearChildren();
};

}; // MageStudios.Param.CollectionClear
...
Scene_Boot.prototype.isGameFontLoaded = function() {
  if (Graphics.isFontLoaded('GameFont')) {
    return true;
  } else if (MageStudios.Param.GameFontTimer <= 0) {
    return false;
  } else {
    var elapsed = Date.now() - this._startDate;
    if (elapsed >= MageStudios.Param.GameFontTimer) {
...
MageStudios.Core.Scene_Title_start = Scene_Title.prototype.start;
Scene_Title.prototype.start = function() {
  MageStudios.Core.Scene_Title_start.call(this);
  if (MageStudios.Param.ScaleTitle) this.rescaleTitle();
};
...
if (MageStudios.Param.ShowEvTrans) {

Scene_Map.prototype.startEncounterEffect = function() {
  this._encounterEffectDuration = this.encounterEffectSpeed();
};

}; // MageStudios.Param.ShowEvTrans

MageStudios.Core.Scene_Map_snapForBattleBackground =
  Scene_Map.prototype.snapForBattleBackground;
Scene_Map.prototype.snapForBattleBackground = function() {
  if (!MageStudios.Param.ShowEvSnap) this._spriteset.hideCharacters();
  MageStudios.Core.Scene_Map_snapForBattleBackground.call(this);
  if (MageStudios.Param.ShowEvTrans) this._spriteset.showCharacters();
};
...
MageStudios.Core.Scene_Gameover_start = Scene_Gameover.prototype.start;
Scene_Gameover.prototype.start = function() {
    MageStudios.Core.Scene_Gameover_start.call(this);
    if (MageStudios.Param.ScaleGameOver) this.rescaleBackground();
};
...
Sprite_Animation.prototype.setupRate = function() {
  this._rate = MageStudios.Param.AnimationRate;
};
...
if (!MageStudios.Param.FlashTarget) {

MageStudios.Core.Sprite_Battler_updateSelectionEffect =
    Sprite_Battler.prototype.updateSelectionEffect;
Sprite_Battler.prototype.updateSelectionEffect = function() {
    if (this._battler.isActor()) {
      MageStudios.Core.Sprite_Battler_updateSelectionEffect.call(this);
    } else {
      if (this._battler.isSelected()) this.startEffect('whiten');
    }
};

}; // MageStudios.Param.FlashTarget

//=============================================================================
// Sprite_Actor
//=============================================================================

if (MageStudios.Param.ReposBattlers) {
  MageStudios.Core.Sprite_Actor_setActorHome = Sprite_Actor.prototype.setActorHome;
  Sprite_Actor.prototype.setActorHome = function(index) {
      MageStudios.Core.Sprite_Actor_setActorHome.call(this, index);
...
MageStudios.Core.Sprite_Enemy_setBattler = Sprite_Enemy.prototype.setBattler;
Sprite_Enemy.prototype.setBattler = function(battler) {
    MageStudios.Core.Sprite_Enemy_setBattler.call(this, battler);
...
}; // MageStudios.Param.ReposBattlers

//=============================================================================
// Sprite_StateIcon
//=============================================================================

Sprite_StateIcon._iconWidth  = MageStudios.Param.IconWidth;
Sprite_StateIcon._iconHeight = MageStudios.Param.IconHeight;
...
MageStudios.Core.Sprite_Character_updateHalfBodySprites =
  Sprite_Character.prototype.updateHalfBodySprites;
Sprite_Character.prototype.updateHalfBodySprites = function() {
  MageStudios.Core.Sprite_Character_updateHalfBodySprites.call(this);
...
if (MageStudios.Param.ScaleBattleback) {
...
MageStudios.Core.Spriteset_Battle_locateBattleback =
...
Spriteset_Battle.prototype.locateBattleback = function() {
  ...
  MageStudios.Core.Spriteset_Battle_locateBattleback.call(this);
...
} // MageStudios.Param.ScaleBattleback

//=============================================================================
// Window_Base
//=============================================================================

Window_Base._iconWidth   = MageStudios.Param.IconWidth;
Window_Base._iconHeight  = MageStudios.Param.IconHeight;
Window_Base._faceWidth   = MageStudios.Param.FaceWidth;
Window_Base._faceHeight  = MageStudios.Param.FaceHeight;

Window_Base.prototype.lineHeight = function() {
  return MageStudios.Param.LineHeight;
};
...
Window_Base.prototype.standardFontFace = function() {
    ...
    return MageStudios.Param.ChineseFont;
    } else if ($gameSystem.isKorean()) {
    return MageStudios.Param.KoreanFont;
    } else {
    return MageStudios.Param.DefaultFont;
    }
};

Window_Base.prototype.standardFontSize = function() {
    return MageStudios.Param.FontSize;
};

Window_Base.prototype.standardPadding = function() {
    return MageStudios.Param.WindowPadding;
};

Window_Base.prototype.textPadding = function() {
    return MageStudios.Param.TextPadding;
};

Window_Base.prototype.standardBackOpacity = function() {
    return MageStudios.Param.WindowOpacity;
};

Window_Base.prototype.normalColor = function() {
  return this.textColor(MageStudios.Param.ColorNormal);
};
Window_Base.prototype.systemColor = function() {
    return this.textColor(MageStudios.Param.ColorSystem);
};

Window_Base.prototype.crisisColor = function() {
    return this.textColor(MageStudios.Param.ColorCrisis);
};

Window_Base.prototype.deathColor = function() {
    return this.textColor(MageStudios.Param.ColorDeath);
};

Window_Base.prototype.gaugeBackColor = function() {
    return this.textColor(MageStudios.Param.ColorGaugeBack);
};

Window_Base.prototype.hpGaugeColor1 = function() {
    return this.textColor(MageStudios.Param.ColorHpGauge1);
};

Window_Base.prototype.hpGaugeColor2 = function() {
    return this.textColor(MageStudios.Param.ColorHpGauge2);
};

Window_Base.prototype.mpGaugeColor1 = function() {
    return this.textColor(MageStudios.Param.ColorMpGauge1);
};

Window_Base.prototype.mpGaugeColor2 = function() {
    return this.textColor(MageStudios.Param.ColorMpGauge2);
};

Window_Base.prototype.mpCostColor = function() {
    return this.textColor(MageStudios.Param.ColorMpCost);
};

Window_Base.prototype.powerUpColor = function() {
    return this.textColor(MageStudios.Param.ColorPowerUp);
};

Window_Base.prototype.powerDownColor = function() {
    return this.textColor(MageStudios.Param.ColorPowerDown);
};

Window_Base.prototype.tpGaugeColor1 = function() {
    return this.textColor(MageStudios.Param.ColorTpGauge1);
};

Window_Base.prototype.tpGaugeColor2 = function() {
    return this.textColor(MageStudios.Param.ColorTpGauge2);
};

Window_Base.prototype.tpCostColor = function() {
    return this.textColor(MageStudios.Param.ColorTpCost);
};
...
Window_Base.prototype.drawGauge = function(dx, dy, dw, rate, color1, color2) {
  ...
  if (MageStudios.Param.GaugeOutline) {
...
Window_Base.prototype.gaugeHeight = function() {
    return MageStudios.Param.GaugeHeight;
};
...
Window_Base.prototype.drawActorLevel = function(actor, x, y) {
    ...
    this.resetTextColor();
    var level = MageStudios.Util.toGroup(actor.level);
    var dw2 = this.textWidth(MageStudios.Util.toGroup(actor.maxLevel()));
...
Window_Base.prototype.drawCurrentAndMax = function(current, max, x, y,
    ...
    if (x3 >= x + labelWidth) {
        ...
        this.drawText(MageStudios.Util.toGroup(current), x3, y, valueWidth,
          'right');
        this.changeTextColor(color2);
        this.drawText('/', x2, y, slashWidth, 'right');
        this.drawText(MageStudios.Util.toGroup(max), x1, y, valueWidth, 'right');
    } else {
        this.changeTextColor(color1);
        this.drawText(MageStudios.Util.toGroup(current), x1, y, valueWidth,
          'right');
    }
};
...
Window_Base.prototype.drawActorTp = function(actor, x, y, width) {
    ...
    this.drawText(MageStudios.Util.toGroup(actor.tp), x + width - 64, y, 64,
      'right');
};

Window_Base.prototype.drawActorSimpleStatus = function(actor, x, y, width) {
    var lineHeight = this.lineHeight();
    var xpad = Window_Base._faceWidth + (2 * MageStudios.Param.TextPadding);
    var x2 = x + xpad;
...
Window_Base.prototype.drawCurrencyValue = function(value, unit, wx, wy, ww) {
    ...
    if (this.textWidth(text) > ww - cx) {
      text = MageStudios.Param.GoldOverlap;
    }
    this.drawText(text, wx, wy, ww - cx - 4, 'right');
    if (this.usingGoldIcon(unit)) {
      this.drawIcon(MageStudios.Icon.Gold, wx + ww - Window_Base._iconWidth, wy + 2);
    } else {
      this.changeTextColor(this.systemColor());
...
Window_Base.prototype.usingGoldIcon = function(unit) {
    ...
    return MageStudios.Icon.Gold > 0;
};
...
Window_Command.prototype.itemTextAlign = function() {
    return MageStudios.Param.TextAlign;
};
...
Window_MenuStatus.prototype.drawItemStatus = function(index) {
    var actor = $gameParty.members()[index];
    var rect = this.itemRect(index);
    var xpad = MageStudios.Param.WindowPadding + Window_Base._faceWidth;
    var x = rect.x + xpad;
    if (!MageStudios.Param.MenuTpGauge) {
...
Window_ItemList.prototype.drawItemNumber = function(item, x, y, width) {
    ...
    var numItems = MageStudios.Util.toGroup($gameParty.numItems(item));
...
Window_SkillList.prototype.drawSkillCost = function(skill, x, y, width) {
    if (this._actor.skillTpCost(skill) > 0) {
        ...
        var skillcost = MageStudios.Util.toGroup(this._actor.skillTpCost(skill));
        this.drawText(skillcost, x, y, width, 'right');
    } else if (this._actor.skillMpCost(skill) > 0) {
        this.changeTextColor(this.mpCostColor());
        var skillcost = MageStudios.Util.toGroup(this._actor.skillMpCost(skill));
        this.drawText(skillcost, x, y, width, 'right');
    }
};
...
Window_Status.prototype.drawParameters = function(x, y) {
    ...
    for (var i = 0; i < 6; i++) {
      ...
      this.resetTextColor();
      var actorParam = MageStudios.Util.toGroup(this._actor.param(paramId));
      var dw = this.textWidth(MageStudios.Util.toGroup(this._actor.paramMax(i + 2)));
...
Window_Status.prototype.drawExpInfo = function(x, y) {
    ...
    if (this._actor.isMaxLevel()) {
      ...
      value2 = MageStudios.Util.toGroup(value2);
    }
    this.changeTextColor(this.systemColor());
...
Window_ShopBuy.prototype.drawItem = function(index) {
    ...
    this.contents.fontSize = MageStudios.Param.GoldFontSize;
    var itemPrice = MageStudios.Util.toGroup(this.price(item));
...
Window_ShopNumber.prototype.drawNumber = function() {
    ...
    this.resetTextColor();
    var itemNumber = MageStudios.Util.toGroup(this._number);
...
MageStudios.Util.toGroup = function(inVal) {
  ...
  if (!MageStudios.Param.DigitGroup) return inVal;
