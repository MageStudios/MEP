...
MageStudios.Param.ScreenWidth = Number(
  MageStudios.Parameters["Screen Width"] || 816
);
MageStudios.Param.ScreenHeight = Number(
  MageStudios.Parameters["Screen Height"] || 624
);
MageStudios.Param.ScaleBattleback = String(
  MageStudios.Parameters["Scale Battlebacks"]
);
MageStudios.Param.ScaleBattleback = eval(MageStudios.Param.ScaleBattleback);
MageStudios.Param.ScaleTitle = eval(
  String(MageStudios.Parameters["Scale Title"])
);
MageStudios.Param.ScaleGameOver = eval(
  String(MageStudios.Parameters["Scale Game Over"])
);
...
MageStudios.Param.ReposBattlers = String(
  MageStudios.Parameters["Reposition Battlers"]
);
MageStudios.Param.ReposBattlers = eval(MageStudios.Param.ReposBattlers);
MageStudios.Param.GameFontTimer = Number(
  MageStudios.Parameters["GameFont Load Timer"]
);
MageStudios.Param.UpdateRealScale = String(
  MageStudios.Parameters["Update Real Scale"]
);
MageStudios.Param.UpdateRealScale = eval(MageStudios.Param.UpdateRealScale);
MageStudios.Param.CollectionClear = String(
  MageStudios.Parameters["Collection Clear"]
);
...
MageStudios.Param.GoldFontSize = Number(
  MageStudios.Parameters["Gold Font Size"]
);
...
MageStudios.Param.ItemQuantitySize = Number(
  MageStudios.Parameters["Quantity Text Size"]
);
...
MageStudios.Param.EnemyParam = Number(
  MageStudios.Parameters["Enemy Parameter"]
);
...
MageStudios.Param.ActorParam = Number(
  MageStudios.Parameters["Actor Parameter"]
);

MageStudios.Param.AnimationRate = Number(
  MageStudios.Parameters["Animation Rate"]
);
MageStudios.Param.FlashTarget = eval(
  String(MageStudios.Parameters["Flash Target"])
);
MageStudios.Param.ShowEvTrans = String(
  MageStudios.Parameters["Show Events Transition"]
);
MageStudios.Param.ShowEvTrans = eval(MageStudios.Param.ShowEvTrans);
MageStudios.Param.ShowEvSnap = String(
  MageStudios.Parameters["Show Events Snapshot"]
);
MageStudios.Param.ShowEvSnap = eval(MageStudios.Param.ShowEvSnap);

MageStudios.Param.RefreshUpdateHp = String(
  MageStudios.Parameters["Refresh Update HP"]
);
MageStudios.Param.RefreshUpdateHp = eval(MageStudios.Param.RefreshUpdateHp);
MageStudios.Param.RefreshUpdateMp = String(
  MageStudios.Parameters["Refresh Update MP"]
);
MageStudios.Param.RefreshUpdateMp = eval(MageStudios.Param.RefreshUpdateMp);
MageStudios.Param.RefreshUpdateTp = String(
  MageStudios.Parameters["Refresh Update TP"]
);
...
MageStudios.Param.DigitGroup = eval(
  String(MageStudios.Parameters["Digit Grouping"])
);
MageStudios.Param.LineHeight = Number(MageStudios.Parameters["Line Height"]);
MageStudios.Param.IconWidth = Number(
  MageStudios.Parameters["Icon Width"] || 32
);
MageStudios.Param.IconHeight = Number(
  MageStudios.Parameters["Icon Height"] || 32
);
MageStudios.Param.FaceWidth = Number(
  MageStudios.Parameters["Face Width"] || 144
);
MageStudios.Param.FaceHeight = Number(
  MageStudios.Parameters["Face Height"] || 144
);
MageStudios.Param.WindowPadding = Number(
  MageStudios.Parameters["Window Padding"]
);
MageStudios.Param.TextPadding = Number(MageStudios.Parameters["Text Padding"]);
MageStudios.Param.WindowOpacity = Number(
  MageStudios.Parameters["Window Opacity"]
);
MageStudios.Param.GaugeOutline = eval(
  String(MageStudios.Parameters["Gauge Outline"])
);
MageStudios.Param.GaugeHeight = Number(MageStudios.Parameters["Gauge Height"]);
MageStudios.Param.MenuTpGauge = eval(
  String(MageStudios.Parameters["Menu TP Bar"])
);
...
MageStudios.Param.ColorGaugeBack = Number(
  MageStudios.Parameters["Color: Gauge Back"]
);
MageStudios.Param.ColorHpGauge1 = Number(
  MageStudios.Parameters["Color: HP Gauge 1"]
);
MageStudios.Param.ColorHpGauge2 = Number(
  MageStudios.Parameters["Color: HP Gauge 2"]
);
MageStudios.Param.ColorMpGauge1 = Number(
  MageStudios.Parameters["Color: MP Gauge 1"]
);
MageStudios.Param.ColorMpGauge2 = Number(
  MageStudios.Parameters["Color: MP Gauge 2"]
);
MageStudios.Param.ColorMpCost = Number(
  MageStudios.Parameters["Color: MP Cost"]
);
MageStudios.Param.ColorPowerUp = Number(
  MageStudios.Parameters["Color: Power Up"]
);
MageStudios.Param.ColorPowerDown = Number(
  MageStudios.Parameters["Color: Power Down"]
);
MageStudios.Param.ColorTpGauge1 = Number(
  MageStudios.Parameters["Color: TP Gauge 1"]
);
MageStudios.Param.ColorTpGauge2 = Number(
  MageStudios.Parameters["Color: TP Gauge 2"]
);
MageStudios.Param.ColorTpCost = Number(
  MageStudios.Parameters["Color: TP Cost Color"]
);
...
Bitmap.prototype.blt = function (source, sx, sy, sw, sh, dx, dy, dw, dh) {
  ...
  dw = Math.floor(dw);
  dh = Math.floor(dh);
  MageStudios.Core.Bitmap_blt.call(
    this,
    source,
    sx,
    sy,
...
if (MageStudios.isPreventScreenJittering()) {
  Game_Map.prototype.displayX = function () {
    return (
      parseFloat(Math.floor(this._displayX * this.tileWidth())) /
      this.tileWidth()
    );
  };
...
MageStudios.Core.Game_Event_setMoveRoute = Game_Event.prototype.setMoveRoute;
...
MageStudios.Core.Game_Action_testItemEffect =
  Game_Action.prototype.testItemEffect;
Game_Action.prototype.testItemEffect = function (target, effect) {
  switch (effect.code) {
    case Game_Action.EFFECT_LEARN_SKILL:
      return target.isActor() && !target._skills.contains(effect.dataId);
    default:
      return MageStudios.Core.Game_Action_testItemEffect.call(
        this,
        target,
        effect
      );
...
if (MageStudios.Param.CollectionClear) {
  ...
  MageStudios.Core.Scene_Gameover_terminate =
    Scene_Gameover.prototype.terminate;
...
if (MageStudios.Param.ReposBattlers) {
  MageStudios.Core.Sprite_Actor_setActorHome =
...
Window_Base.prototype.drawActorTp = function (actor, x, y, width) {
  ...
  this.drawText(
    MageStudios.Util.toGroup(actor.tp),
    x + width - 64,
    y,
    64,
    "right"
...
Window_Status.prototype.drawParameters = function (x, y) {
  ...
  for (var i = 0; i < 6; i++) {
    ...
    var dw = this.textWidth(
      MageStudios.Util.toGroup(this._actor.paramMax(i + 2))
    );
