//=============================================================================
// Mage Studios Engine Plugins - Move Route Extension - Extended Move Pack 1
// MSEP_X_ExtMovePack1.js
//=============================================================================

if (Imported.MSEP_MoveRouteCore) {

var Imported = Imported || {};
Imported.MSEP_X_ExtMovePack1 = true;
 ...
 * ============================================================================
 *
 * This plugin requires MSEP_MoveRouteCore. Make sure this plugin is located
 * under MSEP_MoveRouteCore in the plugin list.
 *
...
MageStudios.EMvP1.Game_Character_processMoveRouteScriptCall =
...
Game_Character.prototype.processMoveRouteScriptCall = function(line) {
  ...
  // ELSE
    ...
    MageStudios.EMvP1.Game_Character_processMoveRouteScriptCall.call(this, line);
  }
};
