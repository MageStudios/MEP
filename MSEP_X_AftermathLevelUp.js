 ...
 * ============================================================================
 *
 * This plugin requires MSEP_VictoryAftermath.
 * Make sure this plugin is located under MSEP_VictoryAftermath in the plugin
 * list.
 *
...
Window_VictoryLevelUp.prototype.drawLearnedSkillsTitle = function() {
    ...
    this.changeTextColor(this.systemColor());
    if (total > 1) {
      var text = MageStudios.Param.ALUSkillPlur;
    } else {
      var text = MageStudios.Param.ALUSkillSing;
    }
