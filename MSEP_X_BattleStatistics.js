//=============================================================================
// Mage Studios Engine Plugins - Status Menu Extension - Battle Statistics
// MSEP_X_BattleStatistics.js
//=============================================================================
...
MageStudios.Param.BStatsBCountText = String(MageStudios.Parameters['Battle Count Text']);
MageStudios.Param.BStatsBCountFmt = String(MageStudios.Parameters['Battle Count Format']);
MageStudios.Param.BStatsKCountText = String(MageStudios.Parameters['Kill Count Text']);
MageStudios.Param.BStatsKCountFmt = String(MageStudios.Parameters['Kill Count Format']);
MageStudios.Param.BStatsDCountText = String(MageStudios.Parameters['Death Count Text']);
MageStudios.Param.BStatsDCountFmt = String(MageStudios.Parameters['Death Count Format']);
MageStudios.Param.BStatsACountText = String(MageStudios.Parameters['Assist Count Text']);
MageStudios.Param.BStatsACountFmt = String(MageStudios.Parameters['Assist Count Format']);
MageStudios.Param.BStatsDmgDealt = String(MageStudios.Parameters['Damage Dealt']);
MageStudios.Param.BStatsDmgTaken = String(MageStudios.Parameters['Damage Taken']);
MageStudios.Param.BStatsHealDealt = String(MageStudios.Parameters['Healing Dealt']);
MageStudios.Param.BStatsHealTaken = String(MageStudios.Parameters['Healing Taken']);
...
MageStudios.BStats.Game_Battler_onBattleStart = Game_Battler.prototype.onBattleStart;
...
Game_Action.prototype.executeHpDamage = function(target, value) {
    MageStudios.BStats.Game_Action_executeHpDaMageStudios.call(this, target, value);
...
Window_StatusInfo.prototype.drawKDARatios = function() {
		...
		var ratio = MageStudios.Util.toGroup(this._actor.killCountRatio().toFixed(2));
