...
if (Imported.MSEP_BattleEngineCore) {
  if (MageStudios.BEC.version && MageStudios.BEC.version >= 1.42) {
    ...
    MageStudios.Param.SVESmoothing = eval(
      String(MageStudios.Parameters["Sprite Smoothing"])
    );
    ...
    MageStudios.Param.SVEHeight = String(
      MageStudios.Parameters["Sprite Height"]
    );
    MageStudios.Param.SVEHeight = MageStudios.Param.SVEHeight.toLowerCase();
    MageStudios.Param.SVECollapse = eval(
      String(MageStudios.Parameters["Collapse"])
    );
    MageStudios.Param.SVEFrameSpeed = Number(
      MageStudios.Parameters["Frame Speed"]
    );
    MageStudios.Param.SVEOverlay = eval(
      String(MageStudios.Parameters["Show State Overlay"])
    );

    MageStudios.Param.SVEBreathing = Number(
      MageStudios.Parameters["Enable Breathing"]
    );
    MageStudios.Param.SVEBreathSpeed = Number(
      MageStudios.Parameters["Breathing Speed"]
    );
    MageStudios.Param.SVEBreathXRate = Number(
      MageStudios.Parameters["Breathing X Rate"]
    );
    MageStudios.Param.SVEBreathYRate = Number(
      MageStudios.Parameters["Breathing Y Rate"]
    );
    MageStudios.Param.SVELinkBreathing = eval(
      MageStudios.Parameters["HP Link Breathing"]
    );

    MageStudios.Param.SVEFloatSpeed = Number(
      MageStudios.Parameters["Floating Speed"]
    );
    MageStudios.Param.SVEFloatRate = Number(
      MageStudios.Parameters["Floating Rate"]
    );
    MageStudios.Param.SVEFloatHeight = Number(
      MageStudios.Parameters["Floating Height"]
    );
    MageStudios.Param.SVEFloatDeath = String(
      MageStudios.Parameters["Floating Death"]
    );
    MageStudios.Param.SVEFloatDeath = eval(MageStudios.Param.SVEFloatDeath);

    MageStudios.Param.SVEShowShadow = eval(
      String(MageStudios.Parameters["Show Shadow"])
    );
    MageStudios.Param.SVEShadowScaleX = String(
      MageStudios.Parameters["Shadow Scale X"]
    );
    MageStudios.Param.SVEShadowScaleY = String(
      MageStudios.Parameters["Shadow Scale Y"]
    );

    MageStudios.Param.SVEAttackMotion = String(
      MageStudios.Parameters["Attack Motion"]
    );
    MageStudios.Param.SVEIdleMotion = String(
      MageStudios.Parameters["Idle Motion"]
    );
    MageStudios.Param.SVEDmgMotion = String(
      MageStudios.Parameters["Damage Motion"]
    );
    MageStudios.Param.SVEEvadeMotion = String(
      MageStudios.Parameters["Evade Motion"]
    );
    MageStudios.Param.SVEEscMotion = String(
      MageStudios.Parameters["Escape Motion"]
    );
    MageStudios.Param.SVEGuardMotion = String(
      MageStudios.Parameters["Guard Motion"]
    );
    MageStudios.Param.SVEAbnMotion = String(
      MageStudios.Parameters["Abnormal Motion"]
    );
    MageStudios.Param.SVESleepMotion = String(
      MageStudios.Parameters["Sleep Motion"]
    );
    MageStudios.Param.SVEDyingMotion = String(
      MageStudios.Parameters["Dying Motion"]
    );
    MageStudios.Param.SVEDeadMotion = String(
      MageStudios.Parameters["Dead Motion"]
    );

    MageStudios.Param.SVEWeaponIndex = Number(
      MageStudios.Parameters["Weapon Image Index"]
    );
    MageStudios.Param.SVEWeaponMotion = {};
    MageStudios.Param.SVEWeaponAnimation = {};
    MageStudios.Param.SVEWeaponMotion[0] =
      MageStudios.Param.SVEAttackMotion.toLowerCase();
    for (MageStudios.i = 1; MageStudios.i < 31; ++MageStudios.i) {
      ...
      MageStudios.Param.SVEWeaponMotion[MageStudios.i] =
        MageStudios.s2.toLowerCase();
    ...
    DataManager.isDatabaseLoaded = function () {
      if (!MageStudios.SVE.DataManager_isDatabaseLoaded.call(this))
        return false;
    ...
    DataManager.processSVENotetags1 = function (group) {
      ...
      for (var n = 1; n < group.length; n++) {
        ...
        obj.sideviewBattler = [];
        obj.sideviewAttackMotion =
          MageStudios.Param.SVEAttackMotion.toLowerCase();
        obj.sideviewIdleMotion = [];
        obj.sideviewDmgMotion = MageStudios.Param.SVEDmgMotion.toLowerCase();
        obj.sideviewEvadeMotion =
          MageStudios.Param.SVEEvadeMotion.toLowerCase();
        obj.sideviewEscMotion = MageStudios.Param.SVEEscMotion.toLowerCase();
        obj.sideviewGuardMotion =
          MageStudios.Param.SVEGuardMotion.toLowerCase();
        obj.sideviewAbnMotion = MageStudios.Param.SVEAbnMotion.toLowerCase();
        obj.sideviewSleepMotion =
          MageStudios.Param.SVESleepMotion.toLowerCase();
        obj.sideviewDyingMotion =
          MageStudios.Param.SVEDyingMotion.toLowerCase();
        ...
        for (var i = 0; i < notedata.length; i++) {
          ...
          if (line.match(/<(?:SCALE SPRITE):[ ](\d+)([%％])>/i)) {
            ...
            obj.sideviewBreathing = [2, 3].contains(
              MageStudios.Param.SVEBreathing
            );
            ...
            line.match(/<(?:SIDEVIEW SHADOW WIDTH):[ ](\d+)([%％])>/i)
          ) {
            obj.sideviewShadowScaleX = parseFloat(RegExp.$1 * 0.01);
          } else if (
            line.match(/<(?:SIDEVIEW SHADOW HEIGHT):[ ](\d+)([%％])>/i)
          ) {
        ...
        if (obj.sideviewIdleMotion.length <= 0) {
          obj.sideviewIdleMotion = [
            MageStudios.Param.SVEIdleMotion.toLowerCase(),
          ];
        }
    ...
    MageStudios.SVE.Game_Battler_spriteWidth =
    ...
    MageStudios.SVE.Game_Battler_spriteHeight =
    ...
    Game_Enemy.prototype.setupSVAttributes = function () {
      ...
      if (this._svAttackAnimationId === undefined)
        this._svAttackAnimationId =
    ...
    MageStudios.SVE.Game_Enemy_performDamage =
      Game_Enemy.prototype.performDamage;
    ...
    MageStudios.SVE.Sprite_Enemy_initMembers =
    ...
    MageStudios.SVE.Sprite_Enemy_updateBitmap =
    ...
    MageStudios.SVE.Sprite_Enemy_updateFrame =
    ...
    MageStudios.SVE.Sprite_Enemy_updateCollapse =
      Sprite_Enemy.prototype.updateCollapse;
    ...
    Sprite_Enemy.prototype.startBossCollapse = function () {
      if (this._svBattlerEnabled) {
        this._effectDuration = Math.ceil(
          this._mainSprite.height * this.scale.y
        );
