...
if (Imported.MSEP_ItemCore && Imported.MSEP_EquipCore) {
  ...
  MageStudios.Param.EECEnable = String(
    MageStudios.Parameters["Default Enable"]
  );
  ...
  Game_Interpreter.prototype.pluginCommand = function (command, args) {
    ...
    if (command === "ShowEquipCustomize")
      $gameSystem.setEquipCustomizable(true);
    if (command === "HideEquipCustomize")
      $gameSystem.setEquipCustomizable(false);
  };
