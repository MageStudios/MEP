//=============================================================================
// Mage Studios Engine Plugins - Equip Core
// MSEP_EquipCore.js
//=============================================================================

var Imported = Imported || {};
Imported.MSEP_EquipCore = true;
...
MageStudios.Param.EquipTextAlign = String(MageStudios.Parameters['Text Align']);
MageStudios.Param.EquipFinishCmd = String(MageStudios.Parameters['Finish Command']);
MageStudios.Param.EquipRemoveText = String(MageStudios.Parameters['Remove Text']);
MageStudios.Icon.RemoveEquip = Number(MageStudios.Parameters['Remove Icon']);
MageStudios.Param.EquipEmptyText = String(MageStudios.Parameters['Empty Text']);
MageStudios.Icon.EmptyEquip = Number(MageStudios.Parameters['Empty Icon']);
MageStudios.Data = String(MageStudios.Parameters['Non-Removable Types']);
MageStudios.Data = MageStudios.Data.split(' ');
MageStudios.Param.EquipNonRemove = [];
for (MageStudios.i = 0; MageStudios.i < MageStudios.Data.length; ++MageStudios.i) {
  MageStudios.Param.EquipNonRemove.push(parseInt(MageStudios.Data[MageStudios.i]));
};
MageStudios.Data = String(MageStudios.Parameters['Non-Optimized Types']);
MageStudios.Data = MageStudios.Data.split(' ');
MageStudios.Param.EquipNonOptimized = [];
for (MageStudios.i = 0; MageStudios.i < MageStudios.Data.length; ++MageStudios.i) {
  MageStudios.Param.EquipNonOptimized.push(parseInt(MageStudios.Data[MageStudios.i]));
};
...
MageStudios.Equip.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function() {
  if (!MageStudios.Equip.DataManager_isDatabaseLoaded.call(this)) return false;
  if (!MageStudios._loaded_MSEP_EquipCore) {
    ...
    MageStudios._loaded_MSEP_EquipCore = true;
  }
  return true;
};
...
MageStudios.Equip.Game_Actor_equips = Game_Actor.prototype.equips;
Game_Actor.prototype.equips = function() {
    ...
    return MageStudios.Equip.Game_Actor_equips.call(this);
};

MageStudios.Equip.Game_Actor_changeEquip = Game_Actor.prototype.changeEquip;
Game_Actor.prototype.changeEquip = function(slotId, item) {
    if (!this._equips[slotId]) this._equips[slotId] = new Game_Item();
    MageStudios.Equip.Game_Actor_changeEquip.call(this, slotId, item);
};

MageStudios.Equip.Game_Actor_forceChangeEquip =
...
Game_Actor.prototype.forceChangeEquip = function(slotId, item) {
    ...
    MageStudios.Equip.Game_Actor_forceChangeEquip.call(this, slotId, item);
};

MageStudios.Equip.Game_Actor_isEquipChangeOk = Game_Actor.prototype.isEquipChangeOk;
Game_Actor.prototype.isEquipChangeOk = function(slotId) {
    if ($gameTemp._clearEquipments) {
      var typeId = this.equipSlots()[slotId];
      if (MageStudios.Param.EquipNonRemove.contains(typeId)) return false;
    }
    if ($gameTemp._optimizeEquipments) {
      var typeId = this.equipSlots()[slotId];
      if (MageStudios.Param.EquipNonOptimized.contains(typeId)) return false;
    }
    return MageStudios.Equip.Game_Actor_isEquipChangeOk.call(this, slotId);
};

MageStudios.Equip.Game_Actor_paramPlus = Game_Actor.prototype.paramPlus;
Game_Actor.prototype.paramPlus = function(paramId) {
    value = MageStudios.Equip.Game_Actor_paramPlus.call(this, paramId);
...
Game_Actor.prototype.evalParamPlus = function(item, paramId) {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, 'CUSTOM PARAMETER FORMULA ERROR');
    }
    switch (paramId) {
      case 0:
        value += hp + maxhp + mhp;
...
Window_EquipCommand.prototype.itemTextAlign = function() {
    return MageStudios.Param.EquipTextAlign;
};

MageStudios.Equip.Window_EquipCommand_makeCommandList =
    Window_EquipCommand.prototype.makeCommandList;
Window_EquipCommand.prototype.makeCommandList = function() {
    MageStudios.Equip.Window_EquipCommand_makeCommandList.call(this);
...
Window_EquipCommand.prototype.addFinishCommand = function() {
    if (MageStudios.Param.EquipFinishCmd === '') return;
    this.addCommand(MageStudios.Param.EquipFinishCmd, 'cancel');
};
...
MageStudios.Equip.Window_EquipSlot_setActor = Window_EquipSlot.prototype.setActor;
Window_EquipSlot.prototype.setActor = function(actor) {
    this.setSlotNameWidth(actor);
    MageStudios.Equip.Window_EquipSlot_setActor.call(this, actor);
};
...
Window_EquipSlot.prototype.isEnabled = function(index) {
    if (this._actor) {
      return MageStudios.Equip.Game_Actor_isEquipChangeOk.call(this._actor, index);
    } else {
      return false;
    }
};
...
Window_EquipSlot.prototype.drawEmptySlot = function(wx, wy, ww) {
    ...
    this.resetTextColor();
    this.drawIcon(MageStudios.Icon.EmptyEquip, wx + 2, wy + 2);
    var text = MageStudios.Param.EquipEmptyText;
...
MageStudios.Equip.Window_ItemList_updateHelp = Window_EquipSlot.prototype.updateHelp;
Window_EquipSlot.prototype.updateHelp = function() {
    MageStudios.Equip.Window_ItemList_updateHelp.call(this);
...
MageStudios.Equip.Window_EquipItem_setSlotId = Window_EquipItem.prototype.setSlotId;
Window_EquipItem.prototype.setSlotId = function(slotId) {
    // do nothing
};

MageStudios.Equip.Window_EquipItem_includes = Window_EquipItem.prototype.includes;
Window_EquipItem.prototype.includes = function(item) {
    if (item === null && this._actor && this._data.length > 0) {
      var typeId = this._actor.equipSlots()[this._slotId];
      if (MageStudios.Param.EquipNonRemove.contains(typeId)) return false;
    }
    return MageStudios.Equip.Window_EquipItem_includes.call(this, item);
};

MageStudios.Equip.Window_EquipItem_isEnabled =
...
Window_EquipItem.prototype.isEnabled = function(item) {
    ...
    return MageStudios.Equip.Window_EquipItem_isEnabled.call(this, item);
};

MageStudios.Equip.Window_EquipItem_drawItem = Window_EquipItem.prototype.drawItem;
Window_EquipItem.prototype.drawItem = function(index) {
    var item = this._data[index];
    if (item === null) {
      this.drawRemoveEquip(index);
    } else {
      MageStudios.Equip.Window_EquipItem_drawItem.call(this, index);
    }
};
...
Window_EquipItem.prototype.drawRemoveEquip = function(index) {
    ...
    var ibw = Window_Base._iconWidth + 4;
    this.resetTextColor();
    this.drawIcon(MageStudios.Icon.RemoveEquip, rect.x + 2, rect.y + 2);
    var text = MageStudios.Param.EquipRemoveText;
...
MageStudios.Equip.Window_ItemList_updateHelp = Window_EquipItem.prototype.updateHelp;
...
Scene_Equip.prototype.createCompareWindow = function() {
    ...
    if (Imported.MSEP_ItemCore && eval(MageStudios.Param.ItemSceneItem)) {
...
MageStudios.Equip.Scene_Equip_refreshActor = Scene_Equip.prototype.refreshActor;
Scene_Equip.prototype.refreshActor = function() {
    MageStudios.Equip.Scene_Equip_refreshActor.call(this);
    this._compareWindow.setActor(this.actor());
};

MageStudios.Equip.Scene_Equip_commandOptimize =
...
Scene_Equip.prototype.commandOptimize = function() {
    ...
    MageStudios.Equip.Scene_Equip_commandOptimize.call(this);
...
MageStudios.Equip.Scene_Equip_commandClear = Scene_Equip.prototype.commandClear;
Scene_Equip.prototype.commandClear = function() {
    $gameTemp._clearEquipments = true;
    var hpRate = this.actor().hp / Math.max(1, this.actor().mhp);
    var mpRate = this.actor().mp / Math.max(1, this.actor().mmp);
    MageStudios.Equip.Scene_Equip_commandClear.call(this);
...
MageStudios.Equip.Scene_Equip_onSlotOk = Scene_Equip.prototype.onSlotOk;
Scene_Equip.prototype.onSlotOk = function() {
    this._itemWindow._slotId = -1;
    var slotId = this._slotWindow.index();
    MageStudios.Equip.Window_EquipItem_setSlotId.call(this._itemWindow, slotId);
    MageStudios.Equip.Scene_Equip_onSlotOk.call(this);
    this._itemWindow.show();
};

MageStudios.Equip.Scene_Equip_onSlotCancel = Scene_Equip.prototype.onSlotCancel;
Scene_Equip.prototype.onSlotCancel = function() {
    MageStudios.Equip.Scene_Equip_onSlotCancel.call(this);
    if (this._infoWindow) this._infoWindow.setItem(null);
    this._compareWindow.setTempActor(null);
};

MageStudios.Equip.Scene_Equip_onItemOk = Scene_Equip.prototype.onItemOk;
Scene_Equip.prototype.onItemOk = function() {
    var hpRate = this.actor().hp / Math.max(1, this.actor().mhp);
    var mpRate = this.actor().mp / Math.max(1, this.actor().mmp);
    MageStudios.Equip.Scene_Equip_onItemOk.call(this);
    var max = this.actor().isDead() ? 0 : 1;
    var hpAmount = Math.max(max, parseInt(this.actor().mhp * hpRate));
    this.actor().setHp(hpAmount);
    this.actor().setMp(parseInt(this.actor().mmp * mpRate));
...
MageStudios.Equip.Scene_Equip_onItemCancel = Scene_Equip.prototype.onItemCancel;
Scene_Equip.prototype.onItemCancel = function() {
    MageStudios.Equip.Scene_Equip_onItemCancel.call(this);
    this._compareWindow.setTempActor(null);
    this._itemWindow.hide();
};
...
MageStudios.Equip.Scene_Equip_onActorChange = Scene_Equip.prototype.onActorChange;
Scene_Equip.prototype.onActorChange = function() {
    MageStudios.Equip.Scene_Equip_onActorChange.call(this);
    this._compareWindow.setTempActor(null);
    if (this._infoWindow) this._infoWindow.setItem(null);
};
