...
MageStudios.Param.EquipFinishCmd = String(
  MageStudios.Parameters["Finish Command"]
);
MageStudios.Param.EquipRemoveText = String(
  MageStudios.Parameters["Remove Text"]
);
...
for (
  MageStudios.i = 0;
  MageStudios.i < MageStudios.Data.length;
  ++MageStudios.i
) {
  MageStudios.Param.EquipNonRemove.push(
    parseInt(MageStudios.Data[MageStudios.i])
  );
}
...
for (
  ...
  MageStudios.Param.EquipNonOptimized.push(
    parseInt(MageStudios.Data[MageStudios.i])
  );
}
...
MageStudios.Equip.Game_Actor_isEquipChangeOk =
...
MageStudios.Equip.Window_EquipSlot_setActor =
  Window_EquipSlot.prototype.setActor;
...
Window_EquipSlot.prototype.isEnabled = function (index) {
  if (this._actor) {
    return MageStudios.Equip.Game_Actor_isEquipChangeOk.call(
      this._actor,
      index
    );
  } else {
...
MageStudios.Equip.Window_ItemList_updateHelp =
...
MageStudios.Equip.Window_EquipItem_setSlotId =
  Window_EquipItem.prototype.setSlotId;
Window_EquipItem.prototype.setSlotId = function (slotId) {};

MageStudios.Equip.Window_EquipItem_includes =
...
MageStudios.Equip.Window_EquipItem_drawItem =
...
MageStudios.Equip.Scene_Equip_onActorChange =
