...
Imported.MSEP_VictoryAftermath = true;

var MageStudios = MageStudios || {};
MageStudios.VA = MageStudios.VA || {};
MageStudios.VA.version = 1.0;
...
MageStudios.Param.VACheerWait = Number(MageStudios.Parameters["Cheer Wait"]);
MageStudios.Param.VABattleResults = String(
  MageStudios.Parameters["Battle Results Text"]
);
MageStudios.Param.VABattleDrops = String(
  MageStudios.Parameters["Battle Drops Text"]
);

MageStudios.Param.VABgmName = String(MageStudios.Parameters["Victory BGM"]);
MageStudios.Param.VABgmVol = Number(MageStudios.Parameters["BGM Volume"]);
MageStudios.Param.VABgmPitch = Number(MageStudios.Parameters["BGM Pitch"]);
MageStudios.Param.VABgmPan = Number(MageStudios.Parameters["BGM Pan"]);

MageStudios.Param.VAFontSize = Number(MageStudios.Parameters["Font Size"]);
MageStudios.Param.VALevelUp = String(MageStudios.Parameters["Level Up Text"]);
MageStudios.Param.VAMaxLv = String(MageStudios.Parameters["Max Level Text"]);
MageStudios.Param.VAShowSkills = String(
  MageStudios.Parameters["Show Skills Learned"]
);
MageStudios.Param.VAGainedExp = String(
  MageStudios.Parameters["Gained EXP Text"]
);
MageStudios.Param.VAGainedExpfmt = String(
  MageStudios.Parameters["Gained EXP Format"]
);
MageStudios.Param.ColorExp1 = Number(
  MageStudios.Parameters["EXP Gauge Color 1"]
);
MageStudios.Param.ColorExp2 = Number(
  MageStudios.Parameters["EXP Gauge Color 2"]
);
MageStudios.Param.ColorLv1 = Number(
  MageStudios.Parameters["Level Gauge Color 1"]
);
MageStudios.Param.ColorLv2 = Number(
  MageStudios.Parameters["Level Gauge Color 2"]
);
MageStudios.Param.VAGaugeTicks = Number(MageStudios.Parameters["Gauge Ticks"]);
MageStudios.Param.VATickName = String(MageStudios.Parameters["Tick SE"]);
MageStudios.Param.VATickVol = Number(MageStudios.Parameters["Tick Volume"]);
MageStudios.Param.VATickPitch = Number(MageStudios.Parameters["Tick Pitch"]);
MageStudios.Param.VATickPan = Number(MageStudios.Parameters["Tick Pan"]);

MageStudios.VA.BattleManager_initMembers = BattleManager.initMembers;
BattleManager.initMembers = function () {
  MageStudios.VA.BattleManager_initMembers.call(this);
...
BattleManager.isFinishedVictoryCheer = function () {
  return ++this._victoryCheerWait >= MageStudios.Param.VACheerWait;
};
...
MageStudios.VA.BattleManager_playVictoryMe = BattleManager.playVictoryMe;
BattleManager.playVictoryMe = function () {
  MageStudios.VA.BattleManager_playVictoryMe.call(this);
  this.playVictoryBGM();
};

BattleManager.playVictoryBGM = function () {
  var victoryBgm = {
    name: MageStudios.Param.VABgmName,
    volume: MageStudios.Param.VABgmVol,
    pitch: MageStudios.Param.VABgmPitch,
    pan: MageStudios.Param.VABgmPan,
  };
...
MageStudios.VA.Game_System_initialize = Game_System.prototype.initialize;
Game_System.prototype.initialize = function () {
  MageStudios.VA.Game_System_initialize.call(this);
...
MageStudios.VA.Game_Actor_shouldDisplayLevelUp =
  Game_Actor.prototype.shouldDisplayLevelUp;
Game_Actor.prototype.shouldDisplayLevelUp = function () {
  if ($gameParty.inBattle()) return false;
  return MageStudios.VA.Game_Actor_shouldDisplayLevelUp.call(this);
};
...
MageStudios.VA.Game_Actor_learnSkill = Game_Actor.prototype.learnSkill;
Game_Actor.prototype.learnSkill = function (skillId) {
  if (!this.isLearnedSkillRaw(skillId) && this._victoryPhase) {
    this._victorySkills.push(skillId);
  }
  MageStudios.VA.Game_Actor_learnSkill.call(this, skillId);
};
...
MageStudios.VA.Game_Interpreter_pluginCommand =
  Game_Interpreter.prototype.pluginCommand;
Game_Interpreter.prototype.pluginCommand = function (command, args) {
  MageStudios.VA.Game_Interpreter_pluginCommand.call(this, command, args);
...
Window_VictoryTitle.prototype.initialize = function () {
  ...
  this.refresh(MageStudios.Param.VABattleResults);
  this.openness = 0;
};
...
Window_VictoryExp.prototype.initialize = function () {
  ...
  var width = this.windowWidth();
  var height = this.windowHeight();
  this._showGainedSkills = eval(MageStudios.Param.VAShowSkills);
...
Window_VictoryExp.prototype.standardFontSize = function () {
  return MageStudios.Param.VAFontSize;
};
...
Window_VictoryExp.prototype.defineTickSound = function () {
  this._tickSound = {
    name: MageStudios.Param.VATickName,
    volume: MageStudios.Param.VATickVol,
    pitch: MageStudios.Param.VATickPitch,
    pan: MageStudios.Param.VATickPan,
  };
};
...
Window_VictoryExp.prototype.updateTicks = function () {
  if (this._tick >= MageStudios.Param.VAGaugeTicks) return;
  if (Graphics.frameCount % 4 !== 0) return;
  if (Input.isPressed("ok") || TouchInput.isPressed()) {
    this._tick = MageStudios.Param.VAGaugeTicks;
  } else {
    this._tick += 1;
  }
  this.drawAllGauges();
...
Window_VictoryExp.prototype.drawLevel = function (actor, rect) {
  ...
  if (this.actorExpRate(actor) >= 1.0) {
    var text = MageStudios.Util.toGroup(actor._postVictoryLv);
  } else {
    var text = MageStudios.Util.toGroup(actor._preVictoryLv);
  }
  this.drawText(text, rect.x + 2, rect.y, rect.width - 4, "right");
  var ww =
    rect.width -
    4 -
    this.textWidth("0" + MageStudios.Util.toGroup(actor.maxLevel()));
...
Window_VictoryExp.prototype.actorExpRate = function (actor) {
  ...
  var bonusExp =
    (1.0 * actor._expGained * this._tick) / MageStudios.Param.VAGaugeTicks;
...
Window_VictoryExp.prototype.drawExpGauge = function (actor, rect) {
  ...
  if (rate >= 1.0) {
    var color1 = this.textColor(MageStudios.Param.ColorLv1);
    var color2 = this.textColor(MageStudios.Param.ColorLv2);
  } else {
...
Window_VictoryExp.prototype.drawExpValues = function (actor, rect) {
  ...
  if (actorLv === actor.maxLevel()) {
    var text = MageStudios.Param.VAMaxLv;
  } else if (nowExp >= nextExp) {
    var text = MageStudios.Param.VALevelUp;
  } else {
    var text = MageStudios.Util.toGroup(parseInt(nextExp - nowExp));
  }
  this.changeTextColor(this.normalColor());
...
Window_VictoryExp.prototype.drawExpGained = function (actor, rect) {
  ...
  var bonusExp =
    (1.0 * actor._expGained * this._tick) / MageStudios.Param.VAGaugeTicks;
  var expParse = MageStudios.Util.toGroup(parseInt(bonusExp));
  var expText = MageStudios.Param.VAGainedExpfmt.format(expParse);
  this.changeTextColor(this.normalColor());
...
Window_VictoryExp.prototype.isReady = function () {
  return this._tick >= MageStudios.Param.VAGaugeTicks;
};
...
Window_VictoryDrop.prototype.drawItemNumber = function (item, x, y, width) {
  ...
  var numItems = MageStudios.Util.toGroup(this.numItems(item));
...
Window_VictoryDrop.prototype.numItems = function (item) {
  if (DataManager.isItem(item)) {
    return MageStudios.Util.getCount(item.id, this._dropItems);
  }
  if (DataManager.isWeapon(item)) {
    return MageStudios.Util.getCount(item.id, this._dropWeapons);
  }
  if (DataManager.isArmor(item)) {
    return MageStudios.Util.getCount(item.id, this._dropArmors);
  }
  return 0;
};

MageStudios.VA.Scene_Battle_update = Scene_Battle.prototype.update;
Scene_Battle.prototype.update = function () {
  MageStudios.VA.Scene_Battle_update.call(this);
...
Scene_Battle.prototype.createVictorySteps = function () {
  var steps = MageStudios.Param.VAOrder.split(" ");
  var array = [];
...
Scene_Battle.prototype.createVictoryExp = function () {
  this._victoryTitleWindow.refresh(MageStudios.Param.VABattleResults);
...
Scene_Battle.prototype.createVictoryDrop = function () {
  this._victoryTitleWindow.refresh(MageStudios.Param.VABattleDrops);
...
MageStudios.Util.getCount = function (value, arr) {
  var occur = 0;
