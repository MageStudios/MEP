//=============================================================================
// Mage Studios Engine Plugins - Victory Aftermath
// MSEP_VictoryAftermath.js
//=============================================================================
...
MageStudios.Param.VABattleResults = String(MageStudios.Parameters['Battle Results Text']);
MageStudios.Param.VABattleDrops = String(MageStudios.Parameters['Battle Drops Text']);
...
MageStudios.Param.VAShowSkills = String(MageStudios.Parameters['Show Skills Learned']);
MageStudios.Param.VAGainedExp = String(MageStudios.Parameters['Gained EXP Text']);
MageStudios.Param.VAGainedExpfmt = String(MageStudios.Parameters['Gained EXP Format']);
...
MageStudios.Param.ColorLv1 = Number(MageStudios.Parameters['Level Gauge Color 1']);
MageStudios.Param.ColorLv2 = Number(MageStudios.Parameters['Level Gauge Color 2']);
...
Window_VictoryExp.prototype.drawExpGained = function(actor, rect) {
    ...
    this.changeTextColor(this.systemColor());
    this.drawText(MageStudios.Param.VAGainedExp, rect.x + 2, wy, rect.width - 4,
      'left');
    var bonusExp = 1.0 * actor._expGained * this._tick /
      MageStudios.Param.VAGaugeTicks;
