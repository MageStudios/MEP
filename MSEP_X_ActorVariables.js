//=============================================================================
// Mage Studios Engine Plugins - Status Menu Extension - Actor Variables
// MSEP_X_ActorVariables.js
//=============================================================================
...
MageStudios.Param.AVarColumn1 = String(MageStudios.Parameters['Global Column 1']);
MageStudios.Param.AVarColumn2 = String(MageStudios.Parameters['Global Column 2']);
MageStudios.Param.AVarColumn3 = String(MageStudios.Parameters['Global Column 3']);
MageStudios.Param.AVarColumn4 = String(MageStudios.Parameters['Global Column 4']);
MageStudios.Param.AVarHidden = String(MageStudios.Parameters['Hidden Variables']);

if (Utils.RPGMAKER_VERSION && Utils.RPGMAKER_VERSION >= "1.5.0") {

MageStudios.SetupParameters = function() {
  var data = JSON.parse(MageStudios.Parameters['Global Column 1 1.5.0'] || '[]');
  ...
  data = JSON.parse(MageStudios.Parameters['Global Column 2 1.5.0'] || '[]');
  for (var i = 0; i < data.length; ++i) {
    var varId = data[i];
  ...
  data = JSON.parse(MageStudios.Parameters['Global Column 3 1.5.0'] || '[]');
  for (var i = 0; i < data.length; ++i) {
    var varId = data[i];
  ...
  var data = JSON.parse(MageStudios.Parameters['Global Column 4 1.5.0'] || '[]');
  for (var i = 0; i < data.length; ++i) {
    var varId = data[i];
  ...
  var data = JSON.parse(MageStudios.Parameters['Hidden Variables 1.5.0'] || '[]');
  for (var i = 0; i < data.length; ++i) {
    var varId = data[i];
...
MageStudios.Param.AVarColumn1 = MageStudios.Util.splitArray(MageStudios.Param.AVarColumn1);
MageStudios.Param.AVarColumn2 = MageStudios.Util.splitArray(MageStudios.Param.AVarColumn2);
MageStudios.Param.AVarColumn3 = MageStudios.Util.splitArray(MageStudios.Param.AVarColumn3);
MageStudios.Param.AVarColumn4 = MageStudios.Util.splitArray(MageStudios.Param.AVarColumn4);
