//=============================================================================
// Mage Studios Engine Plugins - Item Core Extension - Item Discard
// MSEP_X_ItemDiscard.js
//=============================================================================
...
MageStudios.Param.ItemDiscardDefault = String(MageStudios.Parameters['Default Discard']);
MageStudios.Param.ItemDiscardDefault = eval(MageStudios.Param.ItemDiscardDefault);
MageStudios.Param.ItemDiscardConfirm = String(MageStudios.Parameters['Confirm Discard']);
MageStudios.Param.ItemDiscardConfirm = eval(MageStudios.Param.ItemDiscardConfirm);
MageStudios.Param.ItemDiscardMessage = String(MageStudios.Parameters['Confirm Message']);
MageStudios.Param.ItemDiscardYes = String(MageStudios.Parameters['Confirm Yes']);
MageStudios.Param.ItemDiscardNo = String(MageStudios.Parameters['Confirm No']);
...
MageStudios.ItemDiscard.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function() {
  if (!MageStudios.ItemDiscard.DataManager_isDatabaseLoaded.call(this)) return false;
...
Window_ItemActionCommand.prototype.initialize = function(x, y) {
  MageStudios.ItemDiscard.Window_ItemActionCommand_initialize.call(this, x, y);
...
Window_ItemActionCommand.prototype.addCustomCommandsF = function() {
  MageStudios.ItemDiscard.Window_ItemActionCommand_addCustomCommandsF.call(this);
