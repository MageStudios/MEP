...
DataManager.isDatabaseLoaded = function() {
  ...
  if (!MageStudios.MSEP_BattleSelectCursor) {
...
DataManager.processBattleCursorNotetags1 = function(group, isActor) {
  for (var n = 1; n < group.length; n++) {
    ...
    if (isActor) {
      obj.battleSelectCursor = MageStudios.Param.BattleCursorAlly;
    } else {
      obj.battleSelectCursor = MageStudios.Param.BattleCursorEnemy;
    }
