//=============================================================================
// Mage Studios Engine Plugins - Enemy Levels Extension - Enemy Base Parameters
// MSEP_X_EnemyBaseParam.js
//=============================================================================

var Imported = Imported || {};
Imported.MSEP_X_EnemyBaseParam = true;
...
MageStudios.EBP.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function() {
  if (!MageStudios.EBP.DataManager_isDatabaseLoaded.call(this)) return false;

  if (!MageStudios._loaded_MSEP_X_EnemyBaseParam) {
    this.processEBPNotetags1($dataEnemies);
    MageStudios._loaded_MSEP_X_EnemyBaseParam = true;
  }
...
MageStudios.EBP.Game_Enemy_paramBase = Game_Enemy.prototype.paramBase;
Game_Enemy.prototype.paramBase = function(paramId) {
  ...
  if (this.enemy().classBasedParam[paramId] > 0) {
    ...
    return MageStudios.EBP.Game_Enemy_paramBase.call(this, paramId);
  }
};
...
Game_Enemy.prototype.classBasedParameterValue = function(paramId) {
  ...
  if (Imported.MSEP_X_ClassBaseParam && cl.baseParamFormula[paramId] !== '') {
...
Game_Enemy.prototype.customEnemyBaseParamFormula = function(f, p, l) {
  ...
  try {
    ...
    MageStudios.Util.displayError(e, code, 'ENEMY BASE PARAM FORMULA ERROR');
  }
  switch (paramId) {
  case 0:
    value += hp + maxhp + mhp;
...
MageStudios.EBP.Game_Enemy_exp = Game_Enemy.prototype.exp;
Game_Enemy.prototype.exp = function() {
  ...
  if (this.enemy().customBaseParamFormula[paramId] !== '') {
    ...
    return MageStudios.EBP.Game_Enemy_exp.call(this);
  }
};

MageStudios.EBP.Game_Enemy_gold = Game_Enemy.prototype.gold;
Game_Enemy.prototype.gold = function() {
  ...
  if (this.enemy().customBaseParamFormula[paramId] !== '') {
    ...
    return MageStudios.EBP.Game_Enemy_gold.call(this);
  }
};
