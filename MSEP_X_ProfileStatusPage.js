...
if (Imported.MSEP_StatusMenuCore) {
  ...
  MageStudios.Param.PSPDefaultProfile = String(
    MageStudios.Parameters["Default Profile"]
  );
  MageStudios.Param.PSPDefaultProfile = eval(
    MageStudios.Param.PSPDefaultProfile
  );
  MageStudios.Param.PSPImageAlign = String(
    MageStudios.Parameters["Image Align"]
  );
  ...
  MageStudios.PSP.Window_StatusInfo_maxItems =
  ...
  MageStudios.PSP.Window_StatusInfo_drawItem =
