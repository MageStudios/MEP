...
DataManager.processHDSNotetags1 = function (group) {
  for (var n = 1; n < group.length; n++) {
    ...
    if (obj.atypeId) {
      obj.hitDamageSound = MageStudios.Param.HitDamageSounds[obj.atypeId];
    }
...
SoundManager.playEnemyDamage = function () {
  if (!!$gameTemp.getHitDamageBattler()) {
    ...
    MageStudios.HDS.SoundManager_playEnemyDaMageStudios.call(this);
  }
};
...
SoundManager.playActorDamage = function () {
  if (!!$gameTemp.getHitDamageBattler()) {
    ...
    MageStudios.HDS.SoundManager_playActorDaMageStudios.call(this);
  }
};
...
SoundManager.playActorHitDamageSound = function () {
  ...
  if (sounds.length > 0) {
    ...
    if (!MageStudios.Param.HitDamageSoundsOnly) {
      MageStudios.HDS.SoundManager_playEnemyDaMageStudios.call(this);
    }
  } else {
    MageStudios.HDS.SoundManager_playActorDaMageStudios.call(this);
