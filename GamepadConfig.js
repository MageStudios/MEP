...
MageStudios.Param.GamepadConfigName = String(MageStudios.Parameters['Command Name']);
MageStudios.Param.GamepadConfigButton = String(MageStudios.Parameters['Button Name']);
MageStudios.Param.GamepadConfigOkTx = String(MageStudios.Parameters['OK Button']);
MageStudios.Param.GamepadConfigOkHelp = String(MageStudios.Parameters['OK Help']);
MageStudios.Param.GamepadConfigCancelTx = String(MageStudios.Parameters['Cancel Button']);
MageStudios.Param.GamepadConfigCancelHelp = String(MageStudios.Parameters['Cancel Help']);
MageStudios.Param.GamepadConfigShiftTx = String(MageStudios.Parameters['Shift Button']);
MageStudios.Param.GamepadConfigShiftHelp = String(MageStudios.Parameters['Shift Help']);
MageStudios.Param.GamepadConfigMenuTx = String(MageStudios.Parameters['Menu Button']);
MageStudios.Param.GamepadConfigMenuHelp = String(MageStudios.Parameters['Menu Help']);
MageStudios.Param.GamepadConfigPgUpTx = String(MageStudios.Parameters['PageUp Button']);
MageStudios.Param.GamepadConfigPgUpHelp = String(MageStudios.Parameters['PageUp Help']);
MageStudios.Param.GamepadConfigPgDnTx = String(MageStudios.Parameters['PageDown Button']);
MageStudios.Param.GamepadConfigPgDnHelp = String(MageStudios.Parameters['PageDown Help']);
MageStudios.Param.GamepadConfigResetTx = String(MageStudios.Parameters['Reset Default']);
MageStudios.Param.GamepadConfigResetHelp = String(MageStudios.Parameters['Reset Help']);
MageStudios.Param.GamepadConfigFinishTx = String(MageStudios.Parameters['Finish Config']);
MageStudios.Param.GamepadConfigFinishHelp = String(MageStudios.Parameters['Finish Help']);
