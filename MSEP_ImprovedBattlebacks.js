 ...
 *
 * If you are using MSEP_CoreEngine and MSEP_BattleEngineCore, place this plugin
 ...
 * MSEP_BattleEngineCore is installed in the plugin list above this plugin.
 *
 * ============================================================================
 * Plugin Commands
 * ============================================================================
...
Sprite_ImprovedBattleback.prototype.setup = function(bf, sp1) {
  ...
  this._sprite1 = sp1;
  var margin = MageStudios.Param.IBBMargin;
