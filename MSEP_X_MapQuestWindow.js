 ...
 * under MSEP_QuestJournal in the plugin list.
 *
 ...
 * - For those with MSEP_MessageCore.js installed, you can set whether or not
 ...
 *
 * Show/Hide:
 * show = Imported.MSEP_X_MapQuestWindow;
 *
 * Enable:
 * enabled = true;
 *
 ...
 * @on YES
 * @off NO
 * @desc Apply word wrap to objectives if you have MSEP_MessageCore?
 * @default true
 *
 * @param Default Show
 * @parent ---General---
