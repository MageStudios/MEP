...
MageStudios.SegGauge.version = 1.0;
...
if (Imported.MSEP_SectionedGauges) {
  var text =
    "================================================================\n";
  text +=
    "You are trying to use MSEP_SegmentedGauges with MSEP_SectionedGauges.\n";
  ...
  MageStudios.Param.SegmentGaugesHp = Number(
    MageStudios.Parameters["HP Gauge Segments"]
  );
  MageStudios.Param.SegmentGaugesMp = Number(
    MageStudios.Parameters["MP Gauge Segments"]
  );
  MageStudios.Param.SegmentGaugesTp = Number(
    MageStudios.Parameters["TP Gauge Segments"]
  );

  MageStudios.Param.SegmentGaugesExp = Number(
    MageStudios.Parameters["EXP Gauge Segments"]
  );
  MageStudios.Param.SegmentGaugesParam = Number(
    MageStudios.Parameters["Param Gauge Segments"]
  );

  MageStudios.SegGauge.Window_Base_initialize =
  ...
  MageStudios.SegGauge.Window_Base_drawActorHp =
  ...
  MageStudios.SegGauge.Window_Base_drawActorMp =
  ...
  MageStudios.SegGauge.Window_Base_drawActorTp =
  ...
  Window_Base.prototype.drawGauge = function (
    ...
    MageStudios.SegGauge.Window_Base_drawGauge.call(
      this,
      dx,
      dy,
      dw,
  ...
  if (Imported.MSEP_X_VisualHpGauge) {
    ...
    Window_VisualHPGauge.prototype.drawActorHp = function (actor, x, y, w) {
      this.setGaugeSegments(actor.mhp / MageStudios.Param.SegmentGaugesHp);
      MageStudios.SegGauge.Window_VisualHPGauge_drawActorHp.call(
        this,
        actor,
        x,
        y,
    ...
    Window_VisualHPGauge.prototype.drawGauge = function (
      ...
      MageStudios.SegGauge.Window_VisualHPGauge_drawGauge.call(
        this,
        dx,
        dy,
        dw,
  ...
  if (Imported.MSEP_StatusMenuCore) {
    ...
    Window_StatusInfo.prototype.drawExpGauge = function (actor, rate, rect) {
      ...
      MageStudios.SegGauge.Window_StatusInfo_drawExpGauge.call(
        this,
        actor,
        rate,
        rect
    ...
    Window_StatusInfo.prototype.drawParamGauge = function (
      ...
      var rate = MageStudios.SegGauge.Window_StatusInfo_drawParamGauge.call(
        this,
        dx,
        dy,
        dw,
