...
MageStudios.Param.MGWAutomatic = eval(
  String(MageStudios.Parameters["Automatic Open"])
);
MageStudios.Param.MGWPosition = Number(
  MageStudios.Parameters["Default Position"]
);
...
MageStudios.MGW.Window_Message_pEC =
