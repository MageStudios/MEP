//=============================================================================
// Mage Studios Engine Plugins - Battle Engine Extension - Counter Control
// MSEP_X_CounterControl.js
//=============================================================================
...
MageStudios.Param.CounterDefault = Number(MageStudios.Parameters['Counter Skill']);
MageStudios.Param.CounterEvade = eval(String(MageStudios.Parameters['Evade Counter']));
MageStudios.Param.CounterFmt = String(MageStudios.Parameters['Counter Name']);
MageStudios.Param.CounterIcon = Number(MageStudios.Parameters['Counter Icon']);
MageStudios.Param.CounterTotal = Number(MageStudios.Parameters['Counter Total']);
MageStudios.Param.CounterAllyCnt = eval(String(MageStudios.Parameters['Ally Counter']));
...
MageStudios.Counter.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function() {
  if (!MageStudios.Counter.DataManager_isDatabaseLoaded.call(this)) return false;
  ...
  if (target.canCounter()) {
    ...
    if (this._counterSkill === null) {
      if (this._action.isPhysical() && target.canMove()) {
        MageStudios.Counter.BattleManager_invokeCounter.call(this, subject, target);
      } else {
...
BattleManager.processActionSequence = function(actionName, actionArgs) {
    ...
    return MageStudios.Counter.BattleManager_processActionSequence.call(this,
...
MageStudios.Counter.Game_Battler_onTurnStart = Game_Battler.prototype.onTurnStart;
