...
Imported.MSEP_X_CounterControl = true;

var MageStudios = MageStudios || {};
MageStudios.Counter = MageStudios.Counter || {};
MageStudios.Counter.version = 1.0;
 ...
 *
 * If you are using Imported.MSEP_X_BattleSysATB or Imported.MSEP_X_BattleSysCTB,
...
if (Imported.MSEP_BattleEngineCore) {
  ...
  MageStudios.Param.CounterMaxQueue = Number(
    MageStudios.Parameters["Queue Max"]
  );

  MageStudios.Param.CounterDefault = Number(
    MageStudios.Parameters["Counter Skill"]
  );
  MageStudios.Param.CounterEvade = eval(
    String(MageStudios.Parameters["Evade Counter"])
  );
  MageStudios.Param.CounterFmt = String(MageStudios.Parameters["Counter Name"]);
  MageStudios.Param.CounterIcon = Number(
    MageStudios.Parameters["Counter Icon"]
  );
  MageStudios.Param.CounterTotal = Number(
    MageStudios.Parameters["Counter Total"]
  );
  MageStudios.Param.CounterAllyCnt = eval(
    String(MageStudios.Parameters["Ally Counter"])
  );

  MageStudios.Param.CounterConditions = [];
  if (eval(String(MageStudios.Parameters["Physical"]))) {
    MageStudios.Param.CounterConditions.push("PHYSICAL HIT");
  }
  if (eval(String(MageStudios.Parameters["Single Target"]))) {
    MageStudios.Param.CounterConditions.push("SINGLE TARGET");
  }
  if (eval(String(MageStudios.Parameters["Not Counter"]))) {
    MageStudios.Param.CounterConditions.push("NOT COUNTER HIT");
  }

  MageStudios.Counter.DataManager_isDatabaseLoaded =
    DataManager.isDatabaseLoaded;
  DataManager.isDatabaseLoaded = function () {
    if (!MageStudios.Counter.DataManager_isDatabaseLoaded.call(this))
      return false;
    if (!MageStudios._loaded_MSEP_X_CounterControl) {
      ...
      MageStudios._loaded_MSEP_X_CounterControl = true;
    }
    return true;
  };
  ...
  DataManager.processCounterNotetags1 = function (group) {
    for (var n = 1; n < group.length; n++) {
      ...
      obj.defaultCounter = MageStudios.Param.CounterDefault;
      obj.counterTotal = MageStudios.Param.CounterTotal;
  ...
  DataManager.processCounterNotetags3 = function (group) {
    for (var n = 1; n < group.length; n++) {
      ...
      obj.evadeCounter = MageStudios.Param.CounterEvade;
      obj.counterName = MageStudios.Param.CounterFmt.format(obj.name);
      obj.counterIcon = MageStudios.Param.CounterIcon || obj.iconIndex;
      obj.cannotCounter = false;
      var evalMode = "none";
      obj.counterConditions = MageStudios.Param.CounterConditions.slice();
      ...
      for (var i = 0; i < notedata.length; i++) {
        ...
        if (line.match(/<(?:EVADE COUNTER|COUNTER EVADE)>/i)) {
          ...
          line.match(/<\/(?:COUNTER CONDITION|COUNTER CONDITIONS)>/i)
        ) {
          evalMode = "none";
  ...
  DataManager.processCounterNotetags4 = function (group) {
    for (var n = 1; n < group.length; n++) {
      ...
      obj.allyCounter = MageStudios.Param.CounterAllyCnt;
      obj.cannotCounter = false;
      obj.counterRate = 1;
      obj.counterMod = 0;
      var evalMode = "none";
  ...
  MageStudios.Counter.BattleManager_initMembers = BattleManager.initMembers;
  BattleManager.initMembers = function () {
    MageStudios.Counter.BattleManager_initMembers.call(this);
    this._counterQueue = [];
  ...
  MageStudios.Counter.BattleManager_invokeCounter =
    ...
    if (target.canCounter()) {
      ...
      if (this._counterSkill === null) {
        if (this._action.isPhysical() && target.canMove()) {
          MageStudios.Counter.BattleManager_invokeCounter.call(
            this,
            subject,
            target
          );
  ...
  BattleManager.meetCounterConditionsEval = function (skill, subject, target) {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, "COUNTER CONDITIONS EVAL ERROR");
    }
    return condition;
  };
  ...
  BattleManager.checkCounterEval = function (code, skill, subject, target) {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, "COUNTER CHECK ERROR");
      return false;
    }
  };
  ...
  BattleManager.checkCounterElement = function (value) {
    if (value.match(/(\d+)/i)) {
      ...
      var elementId = MageStudios.ElementIdRef[value.toUpperCase()];
      if (!elementId) return true;
    }
    var actionElement = this._action.item().daMageStudios.elementId;
    if (actionElement < 0) {
  ...
  BattleManager.checkCounterSkill = function (value) {
    ...
    if (value.match(/(\d+)/i)) {
      ...
      var skillId = MageStudios.SkillIdRef[value.toUpperCase()];
    }
  ...
  BattleManager.checkCounterStype = function (value) {
    ...
    if (value.match(/(\d+)/i)) {
      ...
      var stypeId = MageStudios.STypeIdRef[value.toUpperCase()];
    }
  ...
  BattleManager.checkCounterItem = function (value) {
    ...
    if (value.match(/(\d+)/i)) {
      ...
      var itemId = MageStudios.SkillIdRef[value.toUpperCase()];
    }
    var skill = $dataSkills[skillId];
    return this._action.item() === skill;
  };

  BattleManager.checkCounterAttacker = function (
    v1,
    v2,
    skill,
    subject,
  ...
  BattleManager.checkCounterDefender = function (
    v1,
    v2,
    skill,
    subject,
  ...
  MageStudios.Counter.BattleManager_createFinishActions =
    BattleManager.createFinishActions;
  BattleManager.createFinishActions = function () {
    MageStudios.Counter.BattleManager_createFinishActions.call(this);
    this._actionList.push(["START COUNTER PHASE"]);
  };

  MageStudios.Counter.BattleManager_processActionSequence =
    BattleManager.processActionSequence;
  BattleManager.processActionSequence = function (actionName, actionArgs) {
    if (actionName === "START COUNTER PHASE") {
      return this.actionStartCounterPhase();
    }
    return MageStudios.Counter.BattleManager_processActionSequence.call(
      this,
      actionName,
      actionArgs
    );
  ...
  BattleManager.isMaxCounterQueue = function () {
    return this._counterSequence > MageStudios.Param.CounterMaxQueue;
  };
  ...
  MageStudios.Counter.Game_BattlerBase_updateStateActionStart =
  ...
  Game_BattlerBase.prototype.updateStateActionStart = function () {
    ...
    MageStudios.Counter.Game_BattlerBase_updateStateActionStart.call(this);
  };

  MageStudios.Counter.Game_Battler_refresh = Game_Battler.prototype.refresh;
  Game_Battler.prototype.refresh = function () {
    this._counterTotalCache = undefined;
    MageStudios.Counter.Game_Battler_refresh.call(this);
  };
  ...
  Game_Battler.prototype.makeCounterSkills = function () {
    ...
    for (var i = 0; i < length; ++i) {
      ...
      if (obj.counterSkills) {
        MageStudios.Util.extend(this._counterSkills, obj.counterSkills);
      }
  ...
  Game_Battler.prototype.extendCounterSkillsEval = function (obj) {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, "COUNTER SKILLS ERROR");
    }
    MageStudios.Util.extend(this._counterSkills, obj.counterSkills);
  };

  MageStudios.Counter.Game_Battler_onBattleStart =
    Game_Battler.prototype.onBattleStart;
  Game_Battler.prototype.onBattleStart = function () {
    MageStudios.Counter.Game_Battler_onBattleStart.call(this);
    this._counters = 0;
  };

  MageStudios.Counter.Game_Battler_onTurnStart =
    Game_Battler.prototype.onTurnStart;
  Game_Battler.prototype.onTurnStart = function () {
    MageStudios.Counter.Game_Battler_onTurnStart.call(this);
    this._counters = 0;
  };

  Game_Battler.prototype.counterTotal = function () {
    var value = MageStudios.Param.CounterTotal;
    var length = this.states().length;
    for (var i = 0; i < length; ++i) {
      var obj = this.states()[i];
      if (!obj) continue;
  ...
  Game_Battler.prototype.getCounterTotalEval = function (obj) {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, "COUNTER TOTAL ERROR");
    }
    return value;
  };
  ...
  Game_Battler.prototype.getTargetCntRateEval = function (
    obj,
    rate,
    trg,
    item
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, "TARGET COUNTER RATE ERROR");
    }
    return rate;
  };
  ...
  Game_Actor.prototype.targetCounterRateEval = function (rate, target, item) {
    var rate = Game_Battler.prototype.targetCounterRateEval.call(
      this,
      rate,
      target,
      item
  ...
  Game_Action.prototype.customCounterRateEval = function (rate, target) {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, "COUNTER RATE ERROR");
    }
    return rate;
  };

  if (Imported.MSEP_X_BattleSysCTB) {
    MageStudios.Counter.Game_Action_rebalanceCTBSpeed =
      Game_Action.prototype.rebalanceCTBSpeed;
    Game_Action.prototype.rebalanceCTBSpeed = function (target) {
      if (BattleManager.isCountering()) return;
      MageStudios.Counter.Game_Action_rebalanceCTBSpeed.call(this, target);
    };
  }

  MageStudios.Counter.Game_Action_clear = Game_Action.prototype.clear;
  Game_Action.prototype.clear = function () {
    MageStudios.Counter.Game_Action_clear.call(this);
  ...
  MageStudios.Counter.Window_BattleLog_displayIcon =
  ...
  Window_BattleLog.prototype.displayIcon = function (item) {
    ...
    return MageStudios.Counter.Window_BattleLog_displayIcon.call(this, item);
  };

  MageStudios.Counter.Window_BattleLog_displayText =
  ...
  Window_BattleLog.prototype.displayText = function (item) {
    ...
    return MageStudios.Counter.Window_BattleLog_displayText.call(this, item);
  };
