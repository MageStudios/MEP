//=============================================================================
// Mage Studios Engine Plugins - Visual ATB Gauge
// MSEP_X_VisualATBGauge.js
//=============================================================================
...
MageStudios.Param.VATBMinWidth = Number(MageStudios.Parameters['Minimum Gauge Width']);
MageStudios.Param.VATBAlwaysShow = eval(String(MageStudios.Parameters['Always Show']));
MageStudios.Param.VATBGaugePOS = eval(String(MageStudios.Parameters['Gauge Position']));
MageStudios.Param.VATBYBuffer = Number(MageStudios.Parameters['Y Buffer']);
MageStudios.Param.VATBThick = eval(String(MageStudios.Parameters['Use Thick Gauges']));
