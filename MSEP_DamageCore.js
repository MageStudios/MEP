 ...
 * @parent ---Damage Steps---
 * @desc This is the next step in the damage flow.
 * @default value = this.applyVariance(value, item.daMageStudios.variance);
 *
 ...
 *
 * If you have MSEP_BattleEngineCore.js installed, place this plugin under
 * MSEP_BattleEngineCore.js if you wish to make use of the extra features this
 * plugin has to offer.
 *
 * ============================================================================
 * Notetags
 ...
 *   regular value of the calculated daMageStudios. This will cancel out any damage
 ...
 *     }
 *     value = this.applyVariance(value, item.daMageStudios.variance);
 ...
 * If you use a variable, it is added onto the daMageStudios.
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
Game_Action.prototype.evalDamageFormula = function(target) {
  try {
    ...
    if (item.daMageStudios.custom) {
      ...
      value = Math.max(eval(item.daMageStudios.formula), 0) * sign;
    }
    return value;
  } catch (e) {
    if (item.daMageStudios.custom) {
