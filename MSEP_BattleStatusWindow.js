...
MageStudios.Param.BSWNameFontSize = Number(
  MageStudios.Parameters["Name Font Size"]
);
MageStudios.Param.BSWParamFontSize = Number(
  MageStudios.Parameters["Param Font Size"]
);
MageStudios.Param.BSWParamYBuffer = Number(
  MageStudios.Parameters["Param Y Buffer"]
);
MageStudios.Param.BSWCurrentMax = String(
  MageStudios.Parameters["Param Current Max"]
);
MageStudios.Param.BSWCurrentMax = eval(MageStudios.Param.BSWCurrentMax);
MageStudios.Param.BSWAdjustCol = eval(
  String(MageStudios.Parameters["Adjust Columns"])
);
MageStudios.Param.BSWStateIconRow = Number(
  MageStudios.Parameters["State Icons Row"]
);

MageStudios.Param.BSWLfRt = eval(
  String(MageStudios.Parameters["Left / Right"])
);
MageStudios.Param.BSWPageUpDn = eval(
  String(MageStudios.Parameters["PageUp / PageDown"])
);
MageStudios.Param.BSWTurnSkip = eval(
  String(MageStudios.Parameters["Allow Turn Skip"])
);

MageStudios.Param.BSWShowAni = eval(
  String(MageStudios.Parameters["Show Animations"])
);
MageStudios.Param.BSWShowSprite = eval(
  String(MageStudios.Parameters["Show Sprites"])
);
MageStudios.Param.BSWAlignAni = eval(
  String(MageStudios.Parameters["Align Animations"])
);
...
MageStudios.BSW.Game_Actor_isSpriteVisible =
  Game_Actor.prototype.isSpriteVisible;
...
MageStudios.BSW.Game_Actor_setFaceImage = Game_Actor.prototype.setFaceImage;
Game_Actor.prototype.setFaceImage = function (faceName, faceIndex) {
  MageStudios.BSW.Game_Actor_setFaceIMageStudios.call(
    this,
    faceName,
    faceIndex
  );
...
Window_BattleStatus.prototype.drawFace = function (
  fn,
  fi,
  x,
  y,
...
Window_BattleStatus.prototype.drawCurrentAndMax = function (
  ...
  if (this._currentMax) {
    Window_Selectable.prototype.drawCurrentAndMax.call(
      this,
      current,
      max,
      x,
...
Window_BattleStatus.prototype.drawItemGaugeIcon = function (iconIndex, wx, wy) {
  ...
  var iconHeight = Imported.MSEP_CoreEngine
    ? MageStudios.Param.GaugeHeight
    : 32;
...
MageStudios.BSW.Scene_Battle_onActorCancel =
...
MageStudios.BSW.Scene_Battle_onEnemyCancel =
...
MageStudios.BSW.Scene_Battle_onSkillCancel =
