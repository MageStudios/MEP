//=============================================================================
// Mage Studios Engine Plugins - Battle System - Active Turn Battle
// MSEP_X_BattleSysATB.js
//=============================================================================

var Imported = Imported || {};
Imported.MSEP_X_BattleSysATB = true;
 ...
 * Mage Studios Engine Plugins' Battle Engine Core. This extension plugin will not
 ...
 *
 * ============================================================================
 * Mage Studios Engine Plugins - Battle Engine Extension - Action Sequence Commands
 * ============================================================================
 *
 ...
 *
 * Show/Hide:
 * if (Imported.MSEP_X_BattleSysATB) {
...
MageStudios.Param.ATBInitSpeed = String(MageStudios.Parameters['Initial Speed']);
MageStudios.Param.ATBFullGauge = String(MageStudios.Parameters['Full Gauge']);
MageStudios.Param.ATBChargeGauge = String(MageStudios.Parameters['Charge Gauge']);
MageStudios.Param.ATBPreEmptive = Number(MageStudios.Parameters['Pre-Emptive Bonuses']);
MageStudios.Param.ATBSurprise = Number(MageStudios.Parameters['Surprise Bonuses']);
MageStudios.Param.ATBEscapeRatio = String(MageStudios.Parameters['Escape Ratio']);
MageStudios.Param.ATBEscapeBoost = String(MageStudios.Parameters['Fail Escape Boost']);
MageStudios.Param.ATBFullTurn = String(MageStudios.Parameters['Full Turn']);
MageStudios.Param.ATBTurnStructure = false;
MageStudios.Param.ATBFlashEnemy = eval(String(MageStudios.Parameters['Flash Enemy']));
MageStudios.Param.ATBRubberband = String(MageStudios.Parameters['Enable Rubberband']);
MageStudios.Param.ATBMinSpeed = String(MageStudios.Parameters['Minimum Speed']);
MageStudios.Param.ATBMaxSpeed = String(MageStudios.Parameters['Maximum Speed']);
MageStudios.Param.ATBReadyName = String(MageStudios.Parameters['Ready Sound']);
MageStudios.Param.ATBReadyVol = Number(MageStudios.Parameters['Ready Volume']);
MageStudios.Param.ATBReadyPitch = Number(MageStudios.Parameters['Ready Pitch']);
MageStudios.Param.ATBReadyPan = Number(MageStudios.Parameters['Ready Pan']);
MageStudios.Param.ATBOptionSpeedTx = String(MageStudios.Parameters['ATB Speed Text']);
MageStudios.Param.ATBDefaultSpeed = Number(MageStudios.Parameters['Default ATB Speed']);
MageStudios.Param.ATBLockStatusWin = String(MageStudios.Parameters['Lock Status Window']);
MageStudios.Param.ATBGaugeStyle = Number(MageStudios.Parameters['Gauge Style']);
MageStudios.Param.ATBGaugeText = String(MageStudios.Parameters['Gauge Text']);
MageStudios.Param.ATBGaugeAlign = String(MageStudios.Parameters['Gauge Text Align']);
MageStudios.Param.ATBColorAtb1 = Number(MageStudios.Parameters['ATB Gauge Color 1']);
MageStudios.Param.ATBColorAtb2 = Number(MageStudios.Parameters['ATB Gauge Color 2']);
MageStudios.Param.ATBColorSlow1 = Number(MageStudios.Parameters['Slow Gauge Color 1']);
MageStudios.Param.ATBColorSlow2 = Number(MageStudios.Parameters['Slow Gauge Color 2']);
MageStudios.Param.ATBColorFast1 = Number(MageStudios.Parameters['Fast Gauge Color 1']);
MageStudios.Param.ATBColorFast2 = Number(MageStudios.Parameters['Fast Gauge Color 2']);
MageStudios.Param.ATBColorStop1 = Number(MageStudios.Parameters['Stop Gauge Color 1']);
MageStudios.Param.ATBColorStop2 = Number(MageStudios.Parameters['Stop Gauge Color 2']);
MageStudios.Param.ATBColorFull1 = Number(MageStudios.Parameters['Full Gauge Color 1']);
MageStudios.Param.ATBColorFull2 = Number(MageStudios.Parameters['Full Gauge Color 2']);
MageStudios.Param.ATBColorChar1 = Number(MageStudios.Parameters['Charge Gauge Color 1']);
MageStudios.Param.ATBColorChar2 = Number(MageStudios.Parameters['Charge Gauge Color 2']);

//=============================================================================
// DataManager
//=============================================================================

MageStudios.ATB.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function() {
  if (!MageStudios.ATB.DataManager_isDatabaseLoaded.call(this)) return false;
  if (!MageStudios._loaded_MSEP_X_BattleSysATB) {
    ...
    MageStudios._loaded_MSEP_X_BattleSysATB = true;
  }
  return true;
};
...
ConfigManager.atbSpeed = MageStudios.Param.ATBDefaultSpeed;

MageStudios.ATB.ConfigManager_makeData = ConfigManager.makeData;
ConfigManager.makeData = function() {
    var config = MageStudios.ATB.ConfigManager_makeData.call(this);
    config.atbSpeed = this.atbSpeed;
    return config;
};

MageStudios.ATB.ConfigManager_applyData = ConfigManager.applyData;
ConfigManager.applyData = function(config) {
    MageStudios.ATB.ConfigManager_applyData.call(this, config);
...
ConfigManager.readConfigATBSpeed = function(config, name) {
    ...
    if (value !== undefined) {
        ...
        return MageStudios.Param.ATBDefaultSpeed.clamp(1, 10);
    }
};
...
MageStudios.ATB.BattleManager_isTurnBased = BattleManager.isTurnBased;
BattleManager.isTurnBased = function() {
    if (this.isATB()) return false;
    return MageStudios.ATB.BattleManager_isTurnBased.call(this);
};

MageStudios.ATB.BattleManager_tickRate = BattleManager.tickRate;
BattleManager.tickRate = function() {
    var rate = MageStudios.ATB.BattleManager_tickRate.call(this);
...
MageStudios.ATB.BattleManager_makeEscapeRatio = BattleManager.makeEscapeRatio;
BattleManager.makeEscapeRatio = function() {
  if (this.isATB()) {
    var code = MageStudios.Param.ATBEscapeRatio;
    try {
      this._escapeRatio = eval(code);
    } catch (e) {
      this._escapeRatio = 0;
      MageStudios.Util.displayError(e, code, 'ATB ESCAPE RATIO ERROR');
    }
    var code = MageStudios.Param.ATBEscapeBoost;
    try {
      this._escapeFailBoost = eval(code);
    } catch (e) {
      this._escapeFailBoost = 0;
      MageStudios.Util.displayError(e, code, 'ATB ESCAPE BOOST ERROR');
    }
  } else {
    this._escapeFailBoost = 0.1;
    MageStudios.ATB.BattleManager_makeEscapeRatio.call(this);
  }
};

MageStudios.ATB.BattleManager_startBattle = BattleManager.startBattle;
BattleManager.startBattle = function() {
    MageStudios.ATB.BattleManager_startBattle.call(this);
    if (this.isATB()) {
      this._phase = null;
...
MageStudios.ATB.BattleManager_endBattle = BattleManager.endBattle;
BattleManager.endBattle = function(result) {
    MageStudios.ATB.BattleManager_endBattle.call(this, result);
    this.clearATBData();
};
...
BattleManager.startATB = function() {
    ...
    this.clearATBData();
    this._atbTarget = Math.max(1, eval(MageStudios.Param.ATBFullGauge));
    this._atbCharge = Math.max(1, eval(MageStudios.Param.ATBChargeGauge));
    this._atbFullTurn = Math.max(1, eval(MageStudios.Param.ATBFullTurn));
    this._atbRubberband = eval(MageStudios.Param.ATBRubberband);
    if (this.atbRubberband()) {
      this._atbMinimumSpeed = Math.max(1, eval(MageStudios.Param.ATBMinSpeed));
      this._atbMaximumSpeed = Math.max(1, eval(MageStudios.Param.ATBMaxSpeed));
    }
    this._atbTicks = this._atbFullTurn;
    this._atbReadySound = {
      name: MageStudios.Param.ATBReadyName,
      volume: MageStudios.Param.ATBReadyVol,
      pitch: MageStudios.Param.ATBReadyPitch,
      pan: MageStudios.Param.ATBReadyPan
    }
...
MageStudios.ATB.BattleManager_update = BattleManager.update;
BattleManager.update = function() {
    if (this.isATB()) {
      if (this.isBusy()) return;
      if (this.updateEvent()) return;
      if (this._phase === 'battleEnd') {
        return MageStudios.ATB.BattleManager_update.call(this);
      }
      if (this.checkBattleEnd()) return;
      if (this._phase === 'atb') {
        this.updateATBPhase();
      } else {
        MageStudios.ATB.BattleManager_update.call(this);
      }
    } else {
      MageStudios.ATB.BattleManager_update.call(this);
    }
...
MageStudios.ATB.BattleManager_updateEventMain = BattleManager.updateEventMain;
BattleManager.updateEventMain = function() {
    if (this.isATB()) {
      ...
      return MageStudios.ATB.BattleManager_updateEventMain.call(this);
    }
};
...
MageStudios.ATB.BattleManager_startInput = BattleManager.startInput;
BattleManager.startInput = function() {
    if (this.isATB()) {
      this.setATBPhase();
    } else {
      MageStudios.ATB.BattleManager_startInput.call(this);
    }
};

MageStudios.ATB.BattleManager_selectNextCommand = BattleManager.selectNextCommand;
BattleManager.selectNextCommand = function() {
    if (this.isATB()) {
      ...
      MageStudios.ATB.BattleManager_selectNextCommand.call(this);
    }
};
...
MageStudios.ATB.BattleManager_selectPreviousCommand =
...
BattleManager.selectPreviousCommand = function() {
    if (this.isATB()) {
      ...
      MageStudios.ATB.BattleManager_selectPreviousCommand.call(this);
    }
};

MageStudios.ATB.BattleManager_startTurn = BattleManager.startTurn;
BattleManager.startTurn = function() {
    if (this.isATB() && !this.isTurnBased()) return;
    MageStudios.ATB.BattleManager_startTurn.call(this);
};

MageStudios.ATB.BattleManager_updateTurnEnd = BattleManager.updateTurnEnd;
BattleManager.updateTurnEnd = function() {
    if (this.isATB()) {
      this.setATBPhase();
    } else {
      MageStudios.ATB.BattleManager_updateTurnEnd.call(this);
    }
};
...
BattleManager.startATBInput = function(battler) {
    ...
    if (battler.isEnemy()) {
      battler.setupATBCharge();
      if (MageStudios.Param.ATBFlashEnemy) battler.requestEffect('whiten');
      var chargedBattler = this.getChargedATBBattler();
...
MageStudios.ATB.BattleManager_processForcedAction =
...
BattleManager.processForcedAction = function() {
    ...
    MageStudios.ATB.BattleManager_processForcedAction.call(this);
    if (forced) this._subject.setAction(0, action);
};

MageStudios.ATB.BattleManager_endAction = BattleManager.endAction;
BattleManager.endAction = function() {
    if (this.isATB()) {
      this.endATBAction();
    } else {
      MageStudios.ATB.BattleManager_endAction.call(this);
    }
};
...
MageStudios.ATB.BattleManager_invokeCounterAttack =
    BattleManager.invokeCounterAttack;
BattleManager.invokeCounterAttack = function(subject, target) {
    if (this.isATB()) this._counterAttacking = true;
    MageStudios.ATB.BattleManager_invokeCounterAttack.call(this, subject, target);
...
MageStudios.ATB.BattleManager_processEscape = BattleManager.processEscape;
BattleManager.processEscape = function() {
    if (this.isATB()) {
      return this.processEscapeATB();
    } else {
      return MageStudios.ATB.BattleManager_processEscape.call(this);
    }
};
...
MageStudios.ATB.BattleManager_processActionSequence =
...
BattleManager.processActionSequence = function(actionName, actionArgs) {
  ...
  return MageStudios.ATB.BattleManager_processActionSequence.call(this,
...
MageStudios.ATB.Game_Action_applyItemUserEffect =
    Game_Action.prototype.applyItemUserEffect;
Game_Action.prototype.applyItemUserEffect = function(target) {
    MageStudios.ATB.Game_Action_applyItemUserEffect.call(this, target);
...
Game_Action.prototype.applyItemATBEvalEffect = function(target) {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, 'ATB EVAL ERROR');
    }
...
Game_Action.prototype.applyItemATBInterruptEval = function(target) {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, 'ATB INTERRUPT EVAL ERROR');
    }
...
MageStudios.ATB.Game_BattlerBase_refresh = Game_BattlerBase.prototype.refresh;
Game_BattlerBase.prototype.refresh = function() {
    MageStudios.ATB.Game_BattlerBase_refresh.call(this);
    if (BattleManager.isATB() && $gameParty.inBattle()) {
      this._atbTickValue = undefined;
    }
};

MageStudios.ATB.Game_BattlerBase_die = Game_BattlerBase.prototype.die;
Game_BattlerBase.prototype.die = function() {
    MageStudios.ATB.Game_BattlerBase_die.call(this);
...
Game_Battler.prototype.onATBStart = function() {
    this._atbSpeed = eval(MageStudios.Param.ATBInitSpeed);
...
Game_Battler.prototype.applyPreemptiveBonusATB = function() {
    ...
    var rate = MageStudios.Param.ATBPreEmptive;
...
Game_Battler.prototype.applySurpriseBonusATB = function() {
    ...
    var rate = MageStudios.Param.ATBSurprise;
    this._atbSpeed += rate * BattleManager.atbTarget();
};

MageStudios.ATB.Game_Battler_onBattleEnd = Game_Battler.prototype.onBattleEnd;
Game_Battler.prototype.onBattleEnd = function() {
    MageStudios.ATB.Game_Battler_onBattleEnd.call(this);
    this._atbSpeed = 0;
    this._atbCharge = 0;
    this._atbCharging = false;
    this._atbChargeMod = 0;
...
MageStudios.ATB.Game_Battler_updateTick = Game_Battler.prototype.updateTick;
Game_Battler.prototype.updateTick = function() {
    MageStudios.ATB.Game_Battler_updateTick.call(this);
...
Game_Battler.prototype.atbTickValue = function() {
    ...
    var user = this;
    var subject = this;
    this._atbTickValue = eval(MageStudios.Param.ATBPerTick);
...
MageStudios.ATB.Game_Battler_removeState = Game_Battler.prototype.removeState;
Game_Battler.prototype.removeState = function(stateId) {
    if (BattleManager.isATB()) {
      var confuseCondition = this.isConfused();
    }
    MageStudios.ATB.Game_Battler_removeState.call(this, stateId);
    if (BattleManager.isATB()) {
...
MageStudios.ATB.Game_Party_performEscape = Game_Party.prototype.performEscape;
Game_Party.prototype.performEscape = function() {
    if (BattleManager.isATB()) return;
    MageStudios.ATB.Game_Party_performEscape.call(this);
};
...
MageStudios.ATB.Game_Troop_increaseTurn = Game_Troop.prototype.increaseTurn;
Game_Troop.prototype.increaseTurn = function() {
    MageStudios.ATB.Game_Troop_increaseTurn.call(this);
...
Window_Base.prototype.atbGaugeStyle = function() {
    return MageStudios.Param.ATBGaugeStyle
};

Window_Base.prototype.atbGaugeColor1 = function(actor) {
    if (actor.atbRate() < 1) {
      if (actor.atbSpeedRate() === 0) {
        return this.textColor(MageStudios.Param.ATBColorStop1);
      } else if (actor.atbSpeedRate() > 1) {
        return this.textColor(MageStudios.Param.ATBColorFast1);
      } else if (actor.atbSpeedRate() < 1) {
        return this.textColor(MageStudios.Param.ATBColorSlow1);
      } else {
        return this.textColor(MageStudios.Param.ATBColorAtb1);
      }
    } else if (actor.atbRate() >= 1 && actor.atbChargeRate() >= 0) {
      return this.textColor(MageStudios.Param.ATBColorFull1);
    } else {
...
Window_Base.prototype.atbGaugeColor2 = function(actor) {
    if (actor.atbRate() < 1) {
      if (actor.atbSpeedRate() === 0) {
        return this.textColor(MageStudios.Param.ATBColorStop2);
      } else if (actor.atbSpeedRate() > 1) {
        return this.textColor(MageStudios.Param.ATBColorFast2);
      } else if (actor.atbSpeedRate() < 1) {
        return this.textColor(MageStudios.Param.ATBColorSlow2);
      } else {
        return this.textColor(MageStudios.Param.ATBColorAtb2);
      }
    } else if (actor.atbRate() >= 1 && actor.atbChargeRate() >= 0) {
      return this.textColor(MageStudios.Param.ATBColorFull2);
    } else {
      return this.gaugeBackColor();
    }
};
...
Window_Base.prototype.drawActorAtbGauge = function(actor, wx, wy, ww) {
    ...
    if (this.atbGaugeStyle() === 2) {
      var text = MageStudios.Param.ATBGaugeText;
      var align =MageStudios.Param.ATBGaugeAlign;
      if (actor.atbRate() >= 1) {
...
Window_Base.prototype.drawAtbChargeGauge = function(actor, wx, wy, ww) {
    var color1 = this.textColor(MageStudios.Param.ATBColorChar1);
    var color2 = this.textColor(MageStudios.Param.ATBColorChar2);
...
MageStudios.ATB.Window_Help_setItem = Window_Help.prototype.setItem;
Window_Help.prototype.setItem = function(item) {
    if (this.meetATBConditions(item)) return this.setText(item.atbHelp);
    MageStudios.ATB.Window_Help_setItem.call(this, item);
};
...
MageStudios.ATB.Window_BattleStatus_drawBasicArea =
    Window_BattleStatus.prototype.drawBasicArea;
Window_BattleStatus.prototype.drawBasicArea = function(rect, actor) {
    if (this.isATBGaugeStyle(1)) {
      this.drawActorAtbGauge(actor, rect.x, rect.y, rect.width);
    }
    MageStudios.ATB.Window_BattleStatus_drawBasicArea.call(this, rect, actor);
};

MageStudios.ATB.Window_BattleStatus_drawGaugeAreaWithTp =
...
Window_BattleStatus.prototype.drawGaugeAreaWithTp = function(rect, actor) {
  if (this.isATBGaugeStyle(2)) {
    ...
    MageStudios.ATB.Window_BattleStatus_drawGaugeAreaWithTp.call(this, rect, actor);
  }
};

MageStudios.ATB.Window_BattleStatus_drawGaugeAreaWOTp =
...
Window_BattleStatus.prototype.drawGaugeAreaWithoutTp = function(rect, actor) {
  if (this.isATBGaugeStyle(2)) {
    ...
    MageStudios.ATB.Window_BattleStatus_drawGaugeAreaWOTp.call(this, rect, actor);
  }
};
...
MageStudios.ATB.Window_Options_addGeneralOptions =
    Window_Options.prototype.addGeneralOptions;
Window_Options.prototype.addGeneralOptions = function() {
    MageStudios.ATB.Window_Options_addGeneralOptions.call(this);
...
Window_Options.prototype.addATBOptions = function() {
    var text = MageStudios.Param.ATBOptionSpeedTx;
    this.addCommand(text, 'atbSpeed');
};

MageStudios.ATB.Window_Options_statusText = Window_Options.prototype.statusText;
Window_Options.prototype.statusText = function(index) {
    var symbol = this.commandSymbol(index);
    if (symbol === 'atbSpeed') {
      return this.getConfigValue('atbSpeed');
    } else {
      return MageStudios.ATB.Window_Options_statusText.call(this, index);
    }
};

if (!Imported.MSEP_OptionsCore) {

MageStudios.ATB.Window_Options_processOk = Window_Options.prototype.processOk;
Window_Options.prototype.processOk = function() {
    ...
    if (symbol === 'atbSpeed') {
      ...
      MageStudios.ATB.Window_Options_processOk.call(this);
    }
};

MageStudios.ATB.Window_Options_cursorRight = Window_Options.prototype.cursorRight;
Window_Options.prototype.cursorRight = function(wrap) {
    ...
    if (symbol === 'atbSpeed') {
      ...
      MageStudios.ATB.Window_Options_cursorRight.call(this, wrap);
    }
};

MageStudios.ATB.Window_Options_cursorLeft = Window_Options.prototype.cursorLeft;
Window_Options.prototype.cursorLeft = function(wrap) {
    ...
    if (symbol === 'atbSpeed') {
      ...
      MageStudios.ATB.Window_Options_cursorLeft.call(this, wrap);
    }
};
...
MageStudios.ATB.Scene_Battle_updateWindowPositions =
    Scene_Battle.prototype.updateWindowPositions;
Scene_Battle.prototype.updateWindowPositions = function() {
    if (BattleManager.isATB() && !this._atbLockStatusWin) {
      this._atbLockStatusWin = eval(MageStudios.Param.ATBLockStatusWin);
    }
    if (BattleManager.isATB() && this._atbLockStatusWin) {
      this.updateWindowPositionsATB();
    } else {
      MageStudios.ATB.Scene_Battle_updateWindowPositions.call(this);
    }
};

MageStudios.ATB.Scene_Battle_isStartActorCommand =
...
Scene_Battle.prototype.isStartActorCommand = function() {
    ...
    return MageStudios.ATB.Scene_Battle_isStartActorCommand.call(this);
};
...
MageStudios.ATB.Scene_Battle_commandFight = Scene_Battle.prototype.commandFight;
Scene_Battle.prototype.commandFight = function() {
    if (BattleManager.isATB()) {
      this.startActorCommandSelection();
      BattleManager._phase = 'input';
    } else {
      MageStudios.ATB.Scene_Battle_commandFight.call(this);
    }
};

MageStudios.ATB.Scene_Battle_startActorCommandSelection =
    Scene_Battle.prototype.startActorCommandSelection;
Scene_Battle.prototype.startActorCommandSelection = function() {
    MageStudios.ATB.Scene_Battle_startActorCommandSelection.call(this);
    if (BattleManager.isATB()) {
