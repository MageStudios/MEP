...
if (Imported.MSEP_BattleEngineCore) {
  if (MageStudios.BEC.version && MageStudios.BEC.version >= 1.42) {
    ...
    MageStudios.Param.ATBInitSpeed = String(
      MageStudios.Parameters["Initial Speed"]
    );
    MageStudios.Param.ATBFullGauge = String(
      MageStudios.Parameters["Full Gauge"]
    );
    MageStudios.Param.ATBChargeGauge = String(
      MageStudios.Parameters["Charge Gauge"]
    );
    MageStudios.Param.ATBPreEmptive = Number(
      MageStudios.Parameters["Pre-Emptive Bonuses"]
    );
    MageStudios.Param.ATBSurprise = Number(
      MageStudios.Parameters["Surprise Bonuses"]
    );
    MageStudios.Param.ATBEscapeRatio = String(
      MageStudios.Parameters["Escape Ratio"]
    );
    MageStudios.Param.ATBEscapeBoost = String(
    ...
    MageStudios.Param.ATBFlashEnemy = eval(
      String(MageStudios.Parameters["Flash Enemy"])
    );
    MageStudios.Param.ATBRubberband = String(
      MageStudios.Parameters["Enable Rubberband"]
    );
    MageStudios.Param.ATBMinSpeed = String(
      MageStudios.Parameters["Minimum Speed"]
    );
    MageStudios.Param.ATBMaxSpeed = String(
      MageStudios.Parameters["Maximum Speed"]
    );
    MageStudios.Param.ATBReadyName = String(
      MageStudios.Parameters["Ready Sound"]
    );
    MageStudios.Param.ATBReadyVol = Number(
      MageStudios.Parameters["Ready Volume"]
    );
    MageStudios.Param.ATBReadyPitch = Number(
      MageStudios.Parameters["Ready Pitch"]
    );
    MageStudios.Param.ATBReadyPan = Number(MageStudios.Parameters["Ready Pan"]);
    MageStudios.Param.ATBOptionSpeedTx = String(
      MageStudios.Parameters["ATB Speed Text"]
    );
    MageStudios.Param.ATBDefaultSpeed = Number(
      MageStudios.Parameters["Default ATB Speed"]
    );
    MageStudios.Param.ATBLockStatusWin = String(
      MageStudios.Parameters["Lock Status Window"]
    );
    MageStudios.Param.ATBGaugeStyle = Number(
      MageStudios.Parameters["Gauge Style"]
    );
    MageStudios.Param.ATBGaugeText = String(
      MageStudios.Parameters["Gauge Text"]
    );
    MageStudios.Param.ATBGaugeAlign = String(
      MageStudios.Parameters["Gauge Text Align"]
    );
    MageStudios.Param.ATBColorAtb1 = Number(
      MageStudios.Parameters["ATB Gauge Color 1"]
    );
    MageStudios.Param.ATBColorAtb2 = Number(
      MageStudios.Parameters["ATB Gauge Color 2"]
    );
    MageStudios.Param.ATBColorSlow1 = Number(
      MageStudios.Parameters["Slow Gauge Color 1"]
    );
    MageStudios.Param.ATBColorSlow2 = Number(
      MageStudios.Parameters["Slow Gauge Color 2"]
    );
    MageStudios.Param.ATBColorFast1 = Number(
      MageStudios.Parameters["Fast Gauge Color 1"]
    );
    MageStudios.Param.ATBColorFast2 = Number(
      MageStudios.Parameters["Fast Gauge Color 2"]
    );
    MageStudios.Param.ATBColorStop1 = Number(
      MageStudios.Parameters["Stop Gauge Color 1"]
    );
    MageStudios.Param.ATBColorStop2 = Number(
      MageStudios.Parameters["Stop Gauge Color 2"]
    );
    MageStudios.Param.ATBColorFull1 = Number(
      MageStudios.Parameters["Full Gauge Color 1"]
    );
    MageStudios.Param.ATBColorFull2 = Number(
      MageStudios.Parameters["Full Gauge Color 2"]
    );
    MageStudios.Param.ATBColorChar1 = Number(
      MageStudios.Parameters["Charge Gauge Color 1"]
    );
    MageStudios.Param.ATBColorChar2 = Number(
      MageStudios.Parameters["Charge Gauge Color 2"]
    );

    MageStudios.ATB.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
    DataManager.isDatabaseLoaded = function () {
      if (!MageStudios.ATB.DataManager_isDatabaseLoaded.call(this))
        return false;
    ...
    MageStudios.ATB.BattleManager_makeEscapeRatio =
    ...
    BattleManager.startATB = function () {
      ...
      if (this.atbRubberband()) {
        this._atbMinimumSpeed = Math.max(
          1,
          eval(MageStudios.Param.ATBMinSpeed)
        );
        this._atbMaximumSpeed = Math.max(
          1,
          eval(MageStudios.Param.ATBMaxSpeed)
        );
      }
    ...
    MageStudios.ATB.BattleManager_updateEventMain =
    ...
    MageStudios.ATB.BattleManager_selectNextCommand =
    ...
    BattleManager.invokeCounterAttack = function (subject, target) {
      ...
      MageStudios.ATB.BattleManager_invokeCounterAttack.call(
        this,
        subject,
        target
      );
    ...
    BattleManager.processActionSequence = function (actionName, actionArgs) {
      if (this.isATB()) {
        ...
        if (actionName === "ATB GAUGE") {
          return (
            this.actionATBCharge(actionArgs) && this.actionATBSpeed(actionArgs)
          );
        }
      ...
      return MageStudios.ATB.BattleManager_processActionSequence.call(
        this,
        actionName,
        actionArgs
      );
    ...
    Game_Action.prototype.applyItemATBSetEffects = function (target) {
      ...
      if (value !== undefined && target.isActor())
        BattleManager.statusUpdateATB();
    };
    ...
    MageStudios.ATB.Game_BattlerBase_refresh =
    ...
    MageStudios.ATB.Game_Battler_onBattleEnd =
    ...
    Game_Battler.prototype.setEndActionATBSpeed = function () {
      ...
      var item = action.item();
      if (item) {
        if (item.afterATBFlat !== undefined)
          this.setATBSpeed(item.afterATBFlat);
    ...
    MageStudios.ATB.Game_Battler_removeState =
    ...
    MageStudios.ATB.Game_Party_performEscape =
    ...
    Window_BattleStatus.prototype.drawGaugeAreaWithTp = function (rect, actor) {
      if (this.isATBGaugeStyle(2)) {
        ...
        MageStudios.ATB.Window_BattleStatus_drawGaugeAreaWithTp.call(
          this,
          rect,
          actor
        );
    ...
    Window_BattleStatus.prototype.drawGaugeAreaWithoutTp = function (
      ...
      if (this.isATBGaugeStyle(2)) {
        ...
        MageStudios.ATB.Window_BattleStatus_drawGaugeAreaWOTp.call(
          this,
          rect,
          actor
        );
    ...
    MageStudios.ATB.Window_Options_statusText =
    ...
    if (!Imported.MSEP_OptionsCore) {
      MageStudios.ATB.Window_Options_processOk =
      ...
      MageStudios.ATB.Window_Options_cursorRight =
      ...
      MageStudios.ATB.Window_Options_cursorLeft =
    ...
    MageStudios.ATB.Scene_Battle_commandFight =
