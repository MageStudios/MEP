//=============================================================================
// Mage Studios Engine Plugins - Buffs & States Core
// MSEP_BuffsStatesCore.js
//=============================================================================
...
MageStudios.Param.BSCTurnAlign = String(MageStudios.Parameters['Turn Alignment']);
MageStudios.Param.BSCTurnBufferX = Number(MageStudios.Parameters['Turn Buffer X']);
MageStudios.Param.BSCTurnBufferY = Number(MageStudios.Parameters['Turn Buffer Y']);
...
MageStudios.Param.BSCDebuffColor = Number(MageStudios.Parameters['Debuff Color']);

MageStudios.Param.BSCShowEnemyIcon = String(MageStudios.Parameters['Show Enemy Icons']);
MageStudios.Param.BSCShowEnemyIcon = eval(MageStudios.Param.BSCShowEnemyIcon);
MageStudios.Param.BSCEnemyBTurn = String(MageStudios.Parameters['Enemy Buff Turn']);
MageStudios.Param.BSCEnemyBTurn = eval(MageStudios.Param.BSCEnemyBTurn);
MageStudios.Param.BSCEnemyTurn = String(MageStudios.Parameters['Enemy State Turn']);
MageStudios.Param.BSCEnemyTurn = eval(MageStudios.Param.BSCEnemyTurn);
MageStudios.Param.BSCEnemyCounter = String(MageStudios.Parameters['Enemy State Counter']);
MageStudios.Param.BSCEnemyCounter = eval(MageStudios.Param.BSCEnemyCounter);

MageStudios.Param.BSCDefaultLimit = Number(MageStudios.Parameters['Default Limit']);
MageStudios.Param.BSCMaximumLimit = Number(MageStudios.Parameters['Maximum Limit']);
MageStudios.Param.BSCBuffFormula = String(MageStudios.Parameters['Buff Formula']);
MageStudios.Param.BSCShowBuffRate = String(MageStudios.Parameters['Show Buff Rate']);
MageStudios.Param.BSCShowBuffRate = eval(MageStudios.Param.BSCShowBuffRate);

MageStudios.Param.BSCReapplyRules = Number(MageStudios.Parameters['Reapply Rules']);
MageStudios.Param.BSCShowEnemyTurns = String(MageStudios.Parameters['Show Enemy Turns']);
MageStudios.Param.BSCShowEnemyTurns = eval(MageStudios.Param.BSCShowEnemyTurns);

MageStudios.Param.BSCCounterSize = Number(MageStudios.Parameters['Counter Font Size']);
MageStudios.Param.BSCCounterAlign = String(MageStudios.Parameters['Counter Alignment']);
MageStudios.Param.BSCCounterBufferX = Number(MageStudios.Parameters['Counter Buffer X']);
MageStudios.Param.BSCCounterBufferY = Number(MageStudios.Parameters['Counter Buffer Y']);
MageStudios.Param.BSCCounterColor = Number(MageStudios.Parameters['Counter Color']);
...
DataManager.initStateCounter = function(obj) {
  ...
  obj.stateCounterSettings['bufferX'] = MageStudios.Param.BSCCounterBufferX || 0;
  obj.stateCounterSettings['bufferY'] = MageStudios.Param.BSCCounterBufferY || 8;
...
MageStudios.BSC.Game_Battler_regenerateAll = Game_Battler.prototype.regenerateAll;
...
MageStudios.BSC.Game_Battler_onTurnStart =
...
}; // MageStudios.Param.BSCShowEnemyIcon

//=============================================================================
// Window_Base
//=============================================================================

MageStudios.BSC.Window_Base_drawActorIcons = Window_Base.prototype.drawActorIcons;
