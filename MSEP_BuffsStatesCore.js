...
Imported.MSEP_BuffsStatesCore = true;

var MageStudios = MageStudios || {};
MageStudios.BSC = MageStudios.BSC || {};
MageStudios.BSC.version = 1.0;
 ...
 * ============================================================================
 *
 * If you are using MSEP_BattleEngineCore.js, please this plugin under
 * MSEP_BattleEngineCore in the plugin list for the best effect.
 *
 ...
 *    code
 *   </Custom Turn Start Effect>
 *   This requires MSEP_BattleEngineCore. This effect will run at the start of
...
MageStudios.Param.BSCShowTurns = eval(
  String(MageStudios.Parameters["Show Turns"])
);
MageStudios.Param.BSCFontSize = String(MageStudios.Parameters["Font Size"]);
MageStudios.Param.BSCTurnAlign = String(
  MageStudios.Parameters["Turn Alignment"]
);
MageStudios.Param.BSCTurnBufferX = Number(
  MageStudios.Parameters["Turn Buffer X"]
);
MageStudios.Param.BSCTurnBufferY = Number(
  MageStudios.Parameters["Turn Buffer Y"]
);
MageStudios.Param.BSCTurnColor = Number(MageStudios.Parameters["State Color"]);
MageStudios.Param.BSCBuffColor = Number(MageStudios.Parameters["Buff Color"]);
MageStudios.Param.BSCDebuffColor = Number(
  MageStudios.Parameters["Debuff Color"]
);

MageStudios.Param.BSCShowEnemyIcon = String(
  MageStudios.Parameters["Show Enemy Icons"]
);
MageStudios.Param.BSCShowEnemyIcon = eval(MageStudios.Param.BSCShowEnemyIcon);
MageStudios.Param.BSCEnemyBTurn = String(
  MageStudios.Parameters["Enemy Buff Turn"]
);
MageStudios.Param.BSCEnemyBTurn = eval(MageStudios.Param.BSCEnemyBTurn);
MageStudios.Param.BSCEnemyTurn = String(
  MageStudios.Parameters["Enemy State Turn"]
);
MageStudios.Param.BSCEnemyTurn = eval(MageStudios.Param.BSCEnemyTurn);
MageStudios.Param.BSCEnemyCounter = String(
  MageStudios.Parameters["Enemy State Counter"]
);
MageStudios.Param.BSCEnemyCounter = eval(MageStudios.Param.BSCEnemyCounter);

MageStudios.Param.BSCDefaultLimit = Number(
  MageStudios.Parameters["Default Limit"]
);
MageStudios.Param.BSCMaximumLimit = Number(
  MageStudios.Parameters["Maximum Limit"]
);
MageStudios.Param.BSCBuffFormula = String(
  MageStudios.Parameters["Buff Formula"]
);
MageStudios.Param.BSCShowBuffRate = String(
  MageStudios.Parameters["Show Buff Rate"]
);
MageStudios.Param.BSCShowBuffRate = eval(MageStudios.Param.BSCShowBuffRate);

MageStudios.Param.BSCReapplyRules = Number(
  MageStudios.Parameters["Reapply Rules"]
);
MageStudios.Param.BSCShowEnemyTurns = String(
  MageStudios.Parameters["Show Enemy Turns"]
);
MageStudios.Param.BSCShowEnemyTurns = eval(MageStudios.Param.BSCShowEnemyTurns);

MageStudios.Param.BSCCounterSize = Number(
  MageStudios.Parameters["Counter Font Size"]
);
MageStudios.Param.BSCCounterAlign = String(
  MageStudios.Parameters["Counter Alignment"]
);
MageStudios.Param.BSCCounterBufferX = Number(
  MageStudios.Parameters["Counter Buffer X"]
);
MageStudios.Param.BSCCounterBufferY = Number(
  MageStudios.Parameters["Counter Buffer Y"]
);
MageStudios.Param.BSCCounterColor = Number(
  MageStudios.Parameters["Counter Color"]
);

MageStudios.BSC.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function () {
  if (!MageStudios.BSC.DataManager_isDatabaseLoaded.call(this)) return false;
  if (!MageStudios._loaded_MSEP_BuffsStatesCore) {
    ...
    MageStudios._loaded_MSEP_BuffsStatesCore = true;
  }
  return true;
};
...
DataManager.processBSCNotetags1 = function (group) {
  for (var n = 1; n < group.length; n++) {
    ...
    obj.showTurns = MageStudios.Param.BSCShowTurns;
    obj.turnAlign = MageStudios.Param.BSCTurnAlign;
    obj.turnFontSize = MageStudios.Param.BSCFontSize;
    obj.turnBufferX = MageStudios.Param.BSCTurnBufferX;
    obj.turnBufferY = MageStudios.Param.BSCTurnBufferY;
    obj.turnColor = MageStudios.Param.BSCTurnColor;
    obj.reapplyRules = MageStudios.Param.BSCReapplyRules;
    ...
    for (var i = 0; i < notedata.length; i++) {
      ...
      if (line.match(/<(?:SHOW TURNS)>/i)) {
        ...
        obj.customEffectEval[evalType] =
          obj.customEffectEval[evalType] + line + "\n";
...
DataManager.initStateCounter = function (obj) {
  ...
  obj.stateCounterSettings["size"] = MageStudios.Param.BSCCounterSize || 16;
  obj.stateCounterSettings["align"] = MageStudios.Param.BSCCounterAlign;
  if (obj.stateCounterSettings["align"] === "undefined") {
    obj.stateCounterSettings["align"] = "center";
  }
  obj.stateCounterSettings["bufferX"] =
    MageStudios.Param.BSCCounterBufferX || 0;
  obj.stateCounterSettings["bufferY"] =
    MageStudios.Param.BSCCounterBufferY || 8;
  obj.stateCounterSettings["color"] = MageStudios.Param.BSCCounterColor || 0;
};
    ...
    for (var i = 0; i < notedata.length; i++) {
      ...
      if (line.match(/<(.*)[ ](?:BUFF TURNS):[ ]([\+\-]\d+)>/i)) {
        ...
        if (text.match(/(\d+)/i)) {
          ...
          var id = MageStudios.StateIdRef[text.toUpperCase()];
        }
...
DataManager.processBSCNotetags4 = function (group) {
  for (var n = 1; n < group.length; n++) {
    ...
    obj.showStateTurns = MageStudios.Param.BSCShowEnemyTurns;
...
MageStudios.BSC.BattleManager_startAction = BattleManager.startAction;
BattleManager.startAction = function () {
  if (this._subject) this._subject.onActionStartStateEffects();
  MageStudios.BSC.BattleManager_startAction.call(this);
};

MageStudios.BSC.BattleManager_endAction = BattleManager.endAction;
BattleManager.endAction = function () {
  if (this._subject) this._subject.onActionEndStateEffects();
  MageStudios.BSC.BattleManager_endAction.call(this);
};

MageStudios.BSC.BattleManager_endBattle = BattleManager.endBattle;
BattleManager.endBattle = function (result) {
  ...
  MageStudios.BSC.BattleManager_endBattle.call(this, result);
};

MageStudios.BSC.Game_BattlerBase_initMembers =
  Game_BattlerBase.prototype.initMembers;
Game_BattlerBase.prototype.initMembers = function () {
  MageStudios.BSC.Game_BattlerBase_initMembers.call(this);
  this.initStateCounter();
};

MageStudios.BSC.Game_BattlerBase_refresh = Game_BattlerBase.prototype.refresh;
Game_BattlerBase.prototype.refresh = function () {
  this._cacheParamBuffRate = {};
  MageStudios.BSC.Game_BattlerBase_refresh.call(this);
};
...
Game_BattlerBase.prototype.setStateTurns = function (stateId, turns) {
  if (Imported.MSEP_BattleEngineCore && !MageStudios.Param.BECTimeStates) {
...
Game_BattlerBase.prototype.setBuffTurns = function (paramId, turns) {
  if (Imported.MSEP_BattleEngineCore && !MageStudios.Param.BECTimeBuffs) {
    turns = Math.floor(turns);
  }
...
Game_BattlerBase.prototype.paramBuffRate = function (paramId) {
  ...
  var code = MageStudios.Param.BSCBuffFormula;
  try {
    var rate = eval(code);
  } catch (e) {
    var rate = 1;
    MageStudios.Util.displayError(e, code, "PARAM BUFF RATE FORMULA ERROR");
  }
...
MageStudios.BSC.Game_BattlerBase_resetStateCounts =
  Game_BattlerBase.prototype.resetStateCounts;
Game_BattlerBase.prototype.resetStateCounts = function (stateId) {
  var state = $dataStates[stateId];
  if (state.reapplyRules === 1) {
    MageStudios.BSC.Game_BattlerBase_resetStateCounts.call(this, stateId);
...
MageStudios.BSC.Game_Battler_addState = Game_Battler.prototype.addState;
Game_Battler.prototype.addState = function (stateId) {
  var addable = this.isStateAddable(stateId);
  MageStudios.BSC.Game_Battler_addState.call(this, stateId);
  if (addable) {
...
MageStudios.BSC.Game_Battler_removeState = Game_Battler.prototype.removeState;
Game_Battler.prototype.removeState = function (stateId) {
  var affected = this.isStateAffected(stateId);
  MageStudios.BSC.Game_Battler_removeState.call(this, stateId);
...
MageStudios.BSC.Game_Battler_removeStatesAuto =
  Game_Battler.prototype.removeStatesAuto;
Game_Battler.prototype.removeStatesAuto = function (timing) {
  $gameTemp._customLeaveEffectEval = true;
  MageStudios.BSC.Game_Battler_removeStatesAuto.call(this, timing);
...
MageStudios.BSC.Game_Battler_onTurnEnd = Game_Battler.prototype.onTurnEnd;
Game_Battler.prototype.onTurnEnd = function () {
  MageStudios.BSC.Game_Battler_onTurnEnd.call(this);
...
MageStudios.BSC.Game_Battler_regenerateAll =
  Game_Battler.prototype.regenerateAll;
Game_Battler.prototype.regenerateAll = function () {
  if ($gameParty.inBattle()) this.onRegenerateStateEffects();
  MageStudios.BSC.Game_Battler_regenerateAll.call(this);
};

if (Imported.MSEP_BattleEngineCore) {
  MageStudios.BSC.Game_BattlerBase_updateStateTicks =
    Game_BattlerBase.prototype.updateStateTicks;
  Game_BattlerBase.prototype.updateStateTicks = function () {
    $gameTemp._customLeaveEffectEval = true;
    MageStudios.BSC.Game_BattlerBase_updateStateTicks.call(this);
    $gameTemp._customLeaveEffectEval = undefined;
  };

  MageStudios.BSC.Game_BattlerBase_updateStateTurnTiming =
    Game_BattlerBase.prototype.updateStateTurnTiming;
  Game_BattlerBase.prototype.updateStateTurnTiming = function (timing) {
    $gameTemp._customLeaveEffectEval = true;
    MageStudios.BSC.Game_BattlerBase_updateStateTurnTiming.call(this, timing);
    $gameTemp._customLeaveEffectEval = undefined;
  };

  MageStudios.BSC.Game_Battler_onTurnStart = Game_Battler.prototype.onTurnStart;
  Game_Battler.prototype.onTurnStart = function () {
    MageStudios.BSC.Game_Battler_onTurnStart.call(this);
...
MageStudios.BSC.Game_Battler_onBattleEnd = Game_Battler.prototype.onBattleEnd;
Game_Battler.prototype.onBattleEnd = function () {
  MageStudios.BSC.Game_Battler_onBattleEnd.call(this);
...
MageStudios.BSC.Game_Unit_onBattleStart = Game_Unit.prototype.onBattleStart;
Game_Unit.prototype.onBattleStart = function () {
  MageStudios.BSC.Game_Unit_onBattleStart.call(this);
...
MageStudios.BSC.Game_Action_applyItemUserEffect =
  Game_Action.prototype.applyItemUserEffect;
Game_Action.prototype.applyItemUserEffect = function (target) {
  MageStudios.BSC.Game_Action_applyItemUserEffect.call(this, target);
  if (!target) return;
...
Game_Action.prototype.applyBuffTurnsEval = function (turn, paramId, target) {
  ...
  try {
    ...
    MageStudios.Util.displayError(e, code, "CUSTOM BUFF TURN SET ERROR");
  }
  return turn;
};
...
Game_Action.prototype.applyDebuffTurnsEval = function (turn, paramId, target) {
  ...
  try {
    ...
    MageStudios.Util.displayError(e, code, "CUSTOM DEBUFF TURN SET ERROR");
  }
  return turn;
};
...
Game_Action.prototype.applyStateTurnsEval = function (turn, stateId, target) {
  ...
  try {
    ...
    MageStudios.Util.displayError(e, code, "CUSTOM STATE TURN SET ERROR");
  }
  return turn;
};

MageStudios.BSC.Game_Action_apply = Game_Action.prototype.apply;
Game_Action.prototype.apply = function (target) {
  this.onApplyStateEffects(target);
  this.onSelectStateEffects(target);
  MageStudios.BSC.Game_Action_apply.call(this, target);
  this.onDeselectStateEffects(target);
  this.offApplyStateEffects(target);
};

Game_Action.prototype.customEffectEval = function (
  target,
  stateId,
  type,
  side,
...
MageStudios.BSC.Game_Action_executeDamage = Game_Action.prototype.executeDamage;
Game_Action.prototype.executeDamage = function (target, value) {
  value = this.onPreDamageStateEffects(target, value);
  value = this.onReactStateEffects(target, value);
  MageStudios.BSC.Game_Action_executeDaMageStudios.call(this, target, value);
...
Game_Action.prototype.establishStateEffects = function (
  target,
  stateId,
  value
) {
...
if (!MageStudios.Param.BSCShowEnemyIcon) {
  Sprite_StateIcon.prototype.updateFrame = function () {};
} else {
  MageStudios.BSC.Sprite_StateIcon_initMembers =
    Sprite_StateIcon.prototype.initMembers;
  Sprite_StateIcon.prototype.initMembers = function () {
    MageStudios.BSC.Sprite_StateIcon_initMembers.call(this);
  ...
  MageStudios.BSC.Sprite_StateIcon_updateFrame =
    Sprite_StateIcon.prototype.updateFrame;
  Sprite_StateIcon.prototype.updateFrame = function () {
    MageStudios.BSC.Sprite_StateIcon_updateFrame.call(this);
  ...
  Sprite_StateIcon.prototype.updateTurnAndCounter = function () {
    ...
    if (typeof state === "number") {
      if (MageStudios.Param.BSCEnemyBTurn) {
      ...
      if (MageStudios.Param.BSCEnemyTurn) this.drawStateTurns(state);
      if (MageStudios.Param.BSCEnemyCounter) this.drawStateCounter(state);
    }
  };
  ...
  Sprite_StateIcon.prototype.drawStateTurns = function (state) {
    ...
    var turns = MageStudios.Util.toGroup(Math.ceil(turns));
  ...
  Sprite_StateIcon.prototype.drawBuffTurns = function (paramId) {
    if (!MageStudios.Param.BSCShowTurns) return;
    var turns = this._battler.buffTurns(paramId);
    turns = MageStudios.Util.toGroup(Math.ceil(turns));
    var wx = MageStudios.Param.BSCTurnBufferX;
    var wy = MageStudios.Param.BSCTurnBufferY - 2;
    var ww = Window_Base._iconWidth;
    var wh = Window_Base.prototype.lineHeight.call(this);
    var contents = this._turnCounterSprite.bitmap;
    contents.fontSize = MageStudios.Param.BSCFontSize;
    if (this._battler.isBuffAffected(paramId)) {
      contents.textColor = this.textColor(MageStudios.Param.BSCBuffColor);
    } else {
      contents.textColor = this.textColor(MageStudios.Param.BSCDebuffColor);
    }
    contents.drawText(turns, wx, wy, ww, wh, MageStudios.Param.BSCTurnAlign);
  };
  ...
  Sprite_StateIcon.prototype.drawBuffRate = function (paramId) {
    ...
    var wx = MageStudios.Param.BSCCounterBufferX || 0;
    var wy = (MageStudios.Param.BSCCounterBufferY || 8) - 2;
    var ww = Window_Base._iconWidth;
    var wh = Window_Base.prototype.lineHeight.call(this);
    var contents = this._turnCounterSprite.bitmap;
    contents.fontSize = MageStudios.Param.BSCFontSize * 0.75;
    contents.textColor = this.textColor(0);
    contents.drawText(text, wx, wy, ww, wh, "center");
  };
}

MageStudios.BSC.Window_Base_drawActorIcons =
  Window_Base.prototype.drawActorIcons;
Window_Base.prototype.drawActorIcons = function (actor, wx, wy, ww) {
  ww = ww || 144;
  MageStudios.BSC.Window_Base_drawActorIcons.call(this, actor, wx, wy, ww);
...
Window_Base.prototype.drawBuffTurns = function (actor, paramId, wx, wy) {
  if (!MageStudios.Param.BSCShowTurns) return;
  var turns = MageStudios.Util.toGroup(Math.ceil(actor.buffTurns(paramId)));
  wx += MageStudios.Param.BSCTurnBufferX;
  wy += MageStudios.Param.BSCTurnBufferY;
  this.changePaintOpacity(true);
  this.contents.fontSize = MageStudios.Param.BSCFontSize;
  if (actor.isBuffAffected(paramId)) {
    this.changeTextColor(this.textColor(MageStudios.Param.BSCBuffColor));
  } else {
    this.changeTextColor(this.textColor(MageStudios.Param.BSCDebuffColor));
  }
  var align = MageStudios.Param.BSCTurnAlign;
...
Window_Base.prototype.drawBuffRate = function (actor, paramId, wx, wy) {
  ...
  this.contents.fontSize = (MageStudios.Param.BSCCounterSize || 16) * 0.75;
  wx += MageStudios.Param.BSCCounterBufferX || 0;
  wy += MageStudios.Param.BSCCounterBufferY || 8;
  this.changePaintOpacity(true);
...
if (Imported.MSEP_BattleEngineCore) {
  MageStudios.BSC.Window_Help_drawBattler = Window_Help.prototype.drawBattler;
  Window_Help.prototype.drawBattler = function (battler) {
    this.resetFontSettings();
    var length = battler.allIcons().length;
    if (length <= 0) {
      MageStudios.BSC.Window_Help_drawBattler.call(this, battler);
    } else {
