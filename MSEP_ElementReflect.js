...
Imported.MSEP_ElementReflect = true;

var MageStudios = MageStudios || {};
MageStudios.EleRef = MageStudios.EleRef || {};
...
MageStudios.EleRef.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function () {
  if (!MageStudios.EleRef.DataManager_isDatabaseLoaded.call(this)) return false;
...
Game_BattlerBase.prototype.calcElementReflectRate = function (item) {
  if (!item) return 0;
  var elementId = item.daMageStudios.elementId;
...
Game_Actor.prototype.calcElementReflectRate = function (item) {
  ...
  var elementId = item.daMageStudios.elementId;
  if (elementId < 0) return 0;
  var rate = Game_BattlerBase.prototype.calcElementReflectRate.call(this, item);
...
MageStudios.EleRef.Game_Action_itemMrf = Game_Action.prototype.itemMrf;
Game_Action.prototype.itemMrf = function (target) {
  var rate = MageStudios.EleRef.Game_Action_itemMrf.call(this, target);
