//=============================================================================
// Mage Studios Engine Plugins - Damage Extension - Critical Control
// MSEP_X_CriticalControl.js
//=============================================================================
...
MageStudios.Param.critMult = String(MageStudios.Parameters['Critical Multplier Formula']);
MageStudios.Param.flatCrit = String(MageStudios.Parameters['Flat Critical Formula']);
...
MageStudios.Crit.BattleManager_processActionSequence =
  ...
  BattleManager.processActionSequence = function(actionName, actionArgs) {
    ...
    return MageStudios.Crit.BattleManager_processActionSequence.call(this,
...
MageStudios.Crit.Game_Action_applyCritRate = Game_Action.prototype.applyCriticalRate;
Game_Action.prototype.applyCriticalRate = function(value, baseDamage, target) {
    value = MageStudios.Crit.Game_Action_applyCritRate.call(this, value, baseDamage,
        target);
...
MageStudios.Crit.Game_Action_modifyCrit = Game_Action.prototype.modifyCritical;
Game_Action.prototype.modifyCritical = function(critical, baseDamage, target) {
    critical = MageStudios.Crit.Game_Action_modifyCrit.call(this, critical,
      baseDamage, target);
...
MageStudios.Crit.Game_Acion_applyFlatCrit = Game_Action.prototype.applyFlatCritical;
Game_Action.prototype.applyFlatCritical = function(value, baseDamage, target) {
    value = MageStudios.Crit.Game_Acion_applyFlatCrit.call(this, value,
        baseDamage, target);
