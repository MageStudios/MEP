...
Imported.MSEP_X_CriticalControl = true;

var MageStudios = MageStudios || {};
MageStudios.Crit = MageStudios.Crit || {};
MageStudios.Crit.version = 1.0;
 ...
 * ============================================================================
 *
 * This plugin requires MSEP_DamageCore.
 * Make sure this plugin is located under MSEP_DamageCore in the plugin list.
 *
 ...
 * ============================================================================
 *
 * If you have MSEP_BattleEngineCore.js installed with this plugin located
...
if (Imported.MSEP_DamageCore) {
  ...
  MageStudios.Param.critRate = String(
    MageStudios.Parameters["Critical Rate Formula"]
  );
  MageStudios.Param.critMult = String(
    MageStudios.Parameters["Critical Multplier Formula"]
  );
  MageStudios.Param.flatCrit = String(
    MageStudios.Parameters["Flat Critical Formula"]
  );

  MageStudios.Crit.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
  DataManager.isDatabaseLoaded = function () {
    if (!MageStudios.Crit.DataManager_isDatabaseLoaded.call(this)) return false;
    if (!MageStudios._loaded_MSEP_X_CriticalControl) {
      ...
      MageStudios._loaded_MSEP_X_CriticalControl = true;
    }
    return true;
  };
  ...
  DataManager.processCritNotetags1 = function (group) {
    for (var n = 1; n < group.length; n++) {
      ...
      var evalMode = "none";
      obj.critRate = MageStudios.Param.critRate;
      obj.critMult = MageStudios.Param.critMult;
      obj.flatCrit = MageStudios.Param.flatCrit;
      ...
      for (var i = 0; i < notedata.length; i++) {
        ...
        if (line.match(/<(?:CRITICAL RATE):[ ](\d+)([%％])>/i)) {
          ...
          obj.daMageStudios.critical = true;
  ...
  if (Imported.MSEP_BattleEngineCore) {
    MageStudios.Crit.BattleManager_processActionSequence =
    ...
    BattleManager.processActionSequence = function (actionName, actionArgs) {
      ...
      return MageStudios.Crit.BattleManager_processActionSequence.call(
        this,
        actionName,
        actionArgs
      );
  ...
  MageStudios.Crit.Game_System_rDS = Game_System.prototype.resetDamageSettings;
  Game_System.prototype.resetDamageSettings = function () {
    MageStudios.Crit.Game_System_rDS.call(this);
    this._critMult = 1.0;
    this._flatCrit = 0;
  ...
  Game_Action.prototype.applyItemCriticalRate = function (target) {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, "CRITICAL RATE FORMULA ERROR");
    }
    return rate;
  };
  ...
  MageStudios.Crit.Game_Action_applyCritRate =
    Game_Action.prototype.applyCriticalRate;
  Game_Action.prototype.applyCriticalRate = function (
    value,
    baseDamage,
    target
  ) {
    value = MageStudios.Crit.Game_Action_applyCritRate.call(
      this,
      value,
      baseDamage,
      target
  ...
  MageStudios.Crit.Game_Action_modifyCrit =
    Game_Action.prototype.modifyCritical;
  Game_Action.prototype.modifyCritical = function (
    critical,
    baseDamage,
    target
  ) {
    critical = MageStudios.Crit.Game_Action_modifyCrit.call(
      this,
      critical,
      baseDamage,
      target
  ...
  Game_Action.prototype.applyItemCriticalMult = function (
    value,
    baseDamage,
    target
  ) {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, "CRITICAL MULTIPLIER ERROR");
    }
    return value;
  };

  MageStudios.Crit.Game_Acion_applyFlatCrit =
    Game_Action.prototype.applyFlatCritical;
  Game_Action.prototype.applyFlatCritical = function (
    value,
    baseDamage,
    target
  ) {
    value = MageStudios.Crit.Game_Acion_applyFlatCrit.call(
      this,
      value,
      baseDamage,
      target
  ...
  Game_Action.prototype.applyItemFlatCrit = function (
    value,
    baseDamage,
    target
  ) {
    ...
    try {
      ...
      MageStudios.Util.displayError(e, code, "CRITICAL FLAT BONUS ERROR");
    }
    return value;
  };
