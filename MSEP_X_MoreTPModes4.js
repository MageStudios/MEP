//=============================================================================
// Mage Studios Engine Plugins - Enhanced TP Extension - More TP Modes 4
// MSEP_X_MoreTPModes4.js
//=============================================================================

var Imported = Imported || {};
Imported.MSEP_X_MoreTPModes4 = true;
...
//=============================================================================
 /*:
 * @plugindesc v1.01 (Requires MSEP_EnhancedTP.js) Adds TP Modes 81 to 100
 * to your game!
 ...
 * ============================================================================
 *
 * This plugin requires MSEP_EnhancedTP.
 * Make sure this plugin is located under MSEP_EnhancedTP in the plugin list.
 *
 * If you have other MSEP_X_MoreTPModes plugins, place them in sequential order.
 *
...
MageStudios.Parameters = PluginManager.parameters('MEP_X_MoreTPModes4');
MageStudios.Param = MageStudios.Param || {};

MageStudios.Param.ETPMax = 100;
for (MageStudios.i = 81; MageStudios.i < MageStudios.Param.ETPMax + 1; ++MageStudios.i) {
