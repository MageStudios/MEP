 ...
 *   - MSEP_MapSelectSkill
 *
 * Non-Mage Studios Engine Plugins may or may not be compatible.
 *
 * ============================================================================
 * Plugin Commands
 * ============================================================================
...
Game_Character.prototype.processMoveCommand = function (command) {
  ...
  MageStudios.SSV.Game_Character_processMoveCommand.call(this, command);
  if (this._mapId && this._eventId) {
...
Game_Switches.prototype.value = function (switchId) {
  if (DataManager.isSelfSwitch(switchId) && $gameTemp.getSelfSwVarEvent()) {
    ...
    return MageStudios.SSV.Game_Switches_value.call(this, switchId);
  }
};
...
Game_Switches.prototype.setValue = function (switchId, value) {
  ...
  if (DataManager.isSelfSwitch(switchId) && $gameTemp.getSelfSwVarEvent()) {
    ...
    MageStudios.SSV.Game_Switches_setValue.call(this, switchId, value);
  }
};
...
Game_Variables.prototype.value = function (variableId) {
  if (DataManager.isSelfVariable(variableId) && $gameTemp.getSelfSwVarEvent()) {
    ...
    return MageStudios.SSV.Game_Variables_value.call(this, variableId);
  }
};
...
Game_Variables.prototype.setValue = function (variableId, value) {
  ...
  if (DataManager.isSelfVariable(variableId) && $gameTemp.getSelfSwVarEvent()) {
    ...
    MageStudios.SSV.Game_Variables_setValue.call(this, variableId, value);
  }
};
