//=============================================================================
// Mage Studios Engine Plugins - Battle Animation Speed Option
// MSEP_BattleAniSpeedOpt.js
//=============================================================================

var Imported = Imported || {};
Imported.MSEP_BattleAniSpeedOpt = true;
 ...
 *
 * Show/Hide:
 * show = Imported.MSEP_BattleAniSpeedOpt;
 *
 * Enable:
 * enabled = true;
 *
...
MageStudios.Param.BattleAniOptSpeed = Number(MageStudios.Parameters['Default Speed']);
MageStudios.Param.BattleAniOptMove = String(MageStudios.Parameters['Affect Movement?']);
MageStudios.Param.BattleAniOptMove = eval(MageStudios.Param.BattleAniOptMove);
MageStudios.Param.BattleAniOptWait = String(MageStudios.Parameters['Affect Waiting?']);
MageStudios.Param.BattleAniOptWait = eval(MageStudios.Param.BattleAniOptWait);

MageStudios.Param.BattleAniOptVocab = [];
MageStudios.Param.BattleAniOptVocab.push('None');
MageStudios.Param.BattleAniOptVocab.push(String(MageStudios.Parameters['Speed 1']));
MageStudios.Param.BattleAniOptVocab.push(String(MageStudios.Parameters['Speed 2']));
MageStudios.Param.BattleAniOptVocab.push(String(MageStudios.Parameters['Speed 3']));
MageStudios.Param.BattleAniOptVocab.push(String(MageStudios.Parameters['Speed 4']));

//=============================================================================
// MainCode
//=============================================================================

ConfigManager.battleAniSpeed = MageStudios.Param.BattleAniOptSpeed;

MageStudios.BASO.ConfigManager_makeData = ConfigManager.makeData;
ConfigManager.makeData = function() {
    var config = MageStudios.BASO.ConfigManager_makeData.call(this);
    config.battleAniSpeed = this.battleAniSpeed;
    return config;
};

MageStudios.BASO.ConfigManager_applyData = ConfigManager.applyData;
ConfigManager.applyData = function(config) {
    MageStudios.BASO.ConfigManager_applyData.call(this, config);
...
ConfigManager.readConfigBattleAnimationSpeed = function(config, name) {
    ...
    if (value !== undefined) {
        ...
        return MageStudios.Param.BattleAniOptSpeed;
    }
};
...
MageStudios.BASO.Sprite_Animation_setupRate = Sprite_Animation.prototype.setupRate;
Sprite_Animation.prototype.setupRate = function() {
  if ($gameParty.inBattle()) {
    this._rate = ConfigManager.battleAniSpeed;
  } else {
    MageStudios.BASO.Sprite_Animation_setupRate.call(this);
  }
};
...
if (MageStudios.Param.BattleAniOptMove) {

MageStudios.BASO.Sprite_Battler_startMove = Sprite_Battler.prototype.startMove;
Sprite_Battler.prototype.startMove = function(x, y, duration) {
  var modifier = 5 - ConfigManager.battleAniSpeed;
  duration = Math.ceil(duration / modifier);
  MageStudios.BASO.Sprite_Battler_startMove.call(this, x, y, duration);
};

}; // MageStudios.Param.BattleAniOptMove
...
MageStudios.BASO.Window_Options_addVolumeOptions =
  Window_Options.prototype.addVolumeOptions;
Window_Options.prototype.addVolumeOptions = function() {
  if (!Imported.MSEP_OptionsCore) this.addBattleAnimationSpeedOptions();
  MageStudios.BASO.Window_Options_addVolumeOptions.call(this);
};

Window_Options.prototype.addBattleAnimationSpeedOptions = function() {
  var text = MageStudios.Param.BattleAniOptName;
  this.addCommand(text, 'battleAniSpeed');
};

MageStudios.BASO.Window_Options_statusText = Window_Options.prototype.statusText;
Window_Options.prototype.statusText = function(index) {
  ...
  if (symbol === 'battleAniSpeed') {
    ...
    return MageStudios.BASO.Window_Options_statusText.call(this, index);
  }
};

Window_Options.prototype.battleAnimationSpeedText = function(value) {
  return MageStudios.Param.BattleAniOptVocab[value] || '';
};

if (!Imported.MSEP_OptionsCore) {

MageStudios.BASO.Window_Options_processOk = Window_Options.prototype.processOk;
Window_Options.prototype.processOk = function() {
  ...
  if (symbol === 'battleAniSpeed') {
    ...
    MageStudios.BASO.Window_Options_processOk.call(this);
  }
};

MageStudios.BASO.Window_Options_cursorRight = Window_Options.prototype.cursorRight;
Window_Options.prototype.cursorRight = function(wrap) {
  ...
  if (symbol === 'battleAniSpeed') {
    ...
    MageStudios.BASO.Window_Options_cursorRight.call(this, wrap);
  }
};

MageStudios.BASO.Window_Options_cursorLeft = Window_Options.prototype.cursorLeft;
Window_Options.prototype.cursorLeft = function(wrap) {
  ...
  if (symbol === 'battleAniSpeed') {
    ...
    MageStudios.BASO.Window_Options_cursorLeft.call(this, wrap);
  }
};
...
if (MageStudios.Param.BattleAniOptWait) {
...
if (Imported.MSEP_X_ActSeqPack3) {
...
}; // Imported.MSEP_X_ActSeqPack3

}; // MageStudios.Param.BattleAniOptWait
