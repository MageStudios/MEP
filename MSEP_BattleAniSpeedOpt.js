...
MageStudios.Param.BattleAniOptName = String(
  MageStudios.Parameters["Option Name"]
);
MageStudios.Param.BattleAniOptSpeed = Number(
  MageStudios.Parameters["Default Speed"]
);
MageStudios.Param.BattleAniOptMove = String(
  MageStudios.Parameters["Affect Movement?"]
);
MageStudios.Param.BattleAniOptMove = eval(MageStudios.Param.BattleAniOptMove);
MageStudios.Param.BattleAniOptWait = String(
  MageStudios.Parameters["Affect Waiting?"]
);
...
MageStudios.Param.BattleAniOptVocab.push(
  String(MageStudios.Parameters["Speed 1"])
);
MageStudios.Param.BattleAniOptVocab.push(
  String(MageStudios.Parameters["Speed 2"])
);
MageStudios.Param.BattleAniOptVocab.push(
  String(MageStudios.Parameters["Speed 3"])
);
MageStudios.Param.BattleAniOptVocab.push(
  String(MageStudios.Parameters["Speed 4"])
);
...
ConfigManager.applyData = function (config) {
  ...
  this.battleAniSpeed = this.readConfigBattleAnimationSpeed(
    config,
    "battleAniSpeed"
  );
};
...
MageStudios.BASO.Sprite_Animation_setupRate =
  Sprite_Animation.prototype.setupRate;
...
if (MageStudios.Param.BattleAniOptMove) {
  MageStudios.BASO.Sprite_Battler_startMove =
    Sprite_Battler.prototype.startMove;
...
MageStudios.BASO.Window_Options_statusText =
...
if (!Imported.MSEP_OptionsCore) {
  MageStudios.BASO.Window_Options_processOk =
  ...
  MageStudios.BASO.Window_Options_cursorRight =
  ...
  MageStudios.BASO.Window_Options_cursorLeft =
