...
MageStudios.Param.CCCAutoAdd = eval(
...
MageStudios.Param.CCCMaintainLv = String(
  MageStudios.Parameters["Maintain Levels"]
);
MageStudios.Param.CCCMaintainLv = eval(MageStudios.Param.CCCMaintainLv);
MageStudios.Param.CCCUnlock = String(
  MageStudios.Parameters["Unlocked Classes"]
);
MageStudios.Param.CCCUnlock = MageStudios.Param.CCCUnlock.split(" ");
if (MageStudios.Param.CCCUnlock === "") MageStudios.Param.CCCUnlock = [];
for (
  MageStudios.i = 0;
  MageStudios.i < MageStudios.Param.CCCUnlock.length;
  ++MageStudios.i
) {
  MageStudios.Param.CCCUnlock[MageStudios.i] = parseInt(
    MageStudios.Param.CCCUnlock[MageStudios.i]
  );
}

MageStudios.Param.CCCClassCmd = String(
  MageStudios.Parameters["Class Change Command"]
);
MageStudios.Param.CCCShowClass = String(
  MageStudios.Parameters["Show Class Change"]
);
MageStudios.Param.CCCShowClass = eval(MageStudios.Param.CCCShowClass);
MageStudios.Param.CCCEnableClass = String(
  MageStudios.Parameters["Enable Class Change"]
);
MageStudios.Param.CCCEnableClass = eval(MageStudios.Param.CCCEnableClass);
MageStudios.Param.CCCShowLearn = String(
  MageStudios.Parameters["Show Skill Learn"]
);
MageStudios.Param.CCCShowLearn = eval(MageStudios.Param.CCCShowLearn);
MageStudios.Param.CCCFinishCmd = String(
  MageStudios.Parameters["Finish Command"]
);
MageStudios.Param.CCCTextAlign = String(
  MageStudios.Parameters["Text Alignment"]
);

MageStudios.Param.CCCClassColor = Number(
  MageStudios.Parameters["Current Class Color"]
);
MageStudios.Param.CCCLvFmt = String(
  MageStudios.Parameters["Class Level Format"]
);
MageStudios.Param.CCCLvFontSize = Number(
  MageStudios.Parameters["Class Level Font Size"]
);
...
DataManager.processCCCNotetags2 = function (group) {
  ...
  for (var n = 1; n < group.length; n++) {
    ...
    obj.unlockedClasses = obj.unlockedClasses.filter(
...
Game_Actor.prototype.initClasses = function () {
  ...
  this._unlockedClasses.sort(function (a, b) {
    return a - b;
  });
};
...
Game_Actor.prototype.unlockedClasses = function () {
  ...
  var classes = this._unlockedClasses.sort(function (a, b) {
    return a - b;
  });
...
MageStudios.CCC.Game_Actor_setBattlerImage =
