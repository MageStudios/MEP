//=============================================================================
// Mage Studios Engine Plugins - Base Troop Events
// MSEP_BaseTroopEvents.js
//=============================================================================
...
DataManager.processBTEPages = function() {
	for (var n = 1; n < $dataTroops.length; n++) {
		...
		if (n !== MageStudios.Param.BaseTroopID && MageStudios.Param.BaseTroopID > 0) {
