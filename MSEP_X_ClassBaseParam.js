//=============================================================================
// Mage Studios Engine Plugins - Base Parameter Extension - Class Base Parameters
// MSEP_X_ClassBaseParam.js
//=============================================================================

var Imported = Imported || {};
Imported.MSEP_X_ClassBaseParam = true;
 ...
 * ============================================================================
 *
 * This plugin requires MSEP_BaseParamControl. Make sure this plugin is located
 * under MSEP_BaseParamControl in the plugin list.
 *
...
if (Imported.MSEP_BaseParamControl) {

//=============================================================================
// DataManager
//=============================================================================

MageStudios.CBP.DataManager_isDatabaseLoaded = DataManager.isDatabaseLoaded;
DataManager.isDatabaseLoaded = function() {
  if (!MageStudios.CBP.DataManager_isDatabaseLoaded.call(this)) return false;

  if (!MageStudios._loaded_MSEP_X_ClassBaseParam) {
    this.processCBPNotetags1($dataClasses);
    MageStudios._loaded_MSEP_X_ClassBaseParam = true;
  }
...
MageStudios.CBP.Game_Actor_paramBase = Game_Actor.prototype.paramBase;
Game_Actor.prototype.paramBase = function(paramId) {
    ...
    return MageStudios.CBP.Game_Actor_paramBase.call(this, paramId);
};
...
Game_Actor.prototype.classBaseParamFormula = function(formula, paramId, level) {
  ...
  try {
    ...
    MageStudios.Util.displayError(e, code, 'CLASS BASE PARAM FORMULA ERROR');
  }
  switch (paramId) {
  case 0:
    value += hp + maxhp + mhp;
...
MageStudios.CBP.Game_Actor_expForLevel = Game_Actor.prototype.expForLevel;
Game_Actor.prototype.expForLevel = function(level) {
  ...
  return MageStudios.CBP.Game_Actor_expForLevel.call(this, level);
};
...
// End of File
//=============================================================================
}; // Imported.MSEP_BaseParamControl