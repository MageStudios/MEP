...
MageStudios.Param.ELVPreserveRate = eval(
  String(MageStudios.Parameters["Preserve Rate"])
);

MageStudios.Param.ELVDefaultType = Number(
  MageStudios.Parameters["Default Type"]
);
MageStudios.Param.ELVPosFluc = Number(
  MageStudios.Parameters["Positive Fluctuation"]
);
MageStudios.Param.ELVNegFluc = Number(
  MageStudios.Parameters["Negative Fluctuation"]
);
