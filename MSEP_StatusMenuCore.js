...
MageStudios.Status.version = 1.0;
...
MageStudios.Param.StatusCmdOrder = String(
  MageStudios.Parameters["Command Order"]
);
MageStudios.Param.StatusCmdWidth = Number(
  MageStudios.Parameters["Command Window Width"]
);
MageStudios.Param.StatusCmdRows = Number(
  MageStudios.Parameters["Command Window Rows"]
);
MageStudios.Param.StatusCmdAlign = String(
  MageStudios.Parameters["Command Alignment"]
);

MageStudios.Param.StatusGeneral = String(
  MageStudios.Parameters["General Command"]
);
MageStudios.Param.StatusParamText = String(
  MageStudios.Parameters["Parameters Text"]
);
MageStudios.Param.StatusExpText = String(
  MageStudios.Parameters["Experience Text"]
);
MageStudios.Param.StatusTotalFmt = String(
  MageStudios.Parameters["Total Format"]
);
...
MageStudios.Param.StatusParameters = String(
  MageStudios.Parameters["Parameters Command"]
);
MageStudios.Param.StatusGraphText = String(
  MageStudios.Parameters["Graph Text"]
);
MageStudios.Param.ColorParam2Gauge = String(
  MageStudios.Parameters["ATK Color"]
);
MageStudios.Param.ColorParam3Gauge = String(
  MageStudios.Parameters["DEF Color"]
);
MageStudios.Param.ColorParam4Gauge = String(
  MageStudios.Parameters["MAT Color"]
);
MageStudios.Param.ColorParam5Gauge = String(
  MageStudios.Parameters["MDF Color"]
);
MageStudios.Param.ColorParam6Gauge = String(
  MageStudios.Parameters["AGI Color"]
);
MageStudios.Param.ColorParam7Gauge = String(
  MageStudios.Parameters["LUK Color"]
);
...
MageStudios.Param.ColorResistC1 = Number(
  MageStudios.Parameters["120% to 150%"]
);
MageStudios.Param.ColorResistC2 = Number(
  MageStudios.Parameters["100% to 120%"]
);
...
MageStudios.Param.StatusElements = String(
  MageStudios.Parameters["Elements Command"]
);
MageStudios.Param.StatusEleDec = Number(
  MageStudios.Parameters["Elements Decimal"]
);
MageStudios.Param.StatusEleCol1 = String(
  MageStudios.Parameters["Element Column 1"]
);
MageStudios.Param.StatusEleCol1 = MageStudios.Param.StatusEleCol1.split(" ");
MageStudios.Param.StatusEleCol2 = String(
  MageStudios.Parameters["Element Column 2"]
);
MageStudios.Param.StatusEleCol2 = MageStudios.Param.StatusEleCol2.split(" ");
MageStudios.Param.StatusEleCol3 = String(
  MageStudios.Parameters["Element Column 3"]
);
MageStudios.Param.StatusEleCol3 = MageStudios.Param.StatusEleCol3.split(" ");
MageStudios.Param.StatusEleCol4 = String(
  MageStudios.Parameters["Element Column 4"]
);
MageStudios.Param.StatusEleCol4 = MageStudios.Param.StatusEleCol4.split(" ");

MageStudios.Param.StatusStates = String(
  MageStudios.Parameters["States Command"]
);
MageStudios.Param.StatusStatesDec = Number(
  MageStudios.Parameters["States Decimal"]
);
MageStudios.Param.StatusStateCol1 = String(
  MageStudios.Parameters["States Column 1"]
);
MageStudios.Param.StatusStateCol1 =
  MageStudios.Param.StatusStateCol1.split(" ");
MageStudios.Param.StatusStateCol2 = String(
  MageStudios.Parameters["States Column 2"]
);
MageStudios.Param.StatusStateCol2 =
  MageStudios.Param.StatusStateCol2.split(" ");
MageStudios.Param.StatusStateCol3 = String(
  MageStudios.Parameters["States Column 3"]
);
MageStudios.Param.StatusStateCol3 =
  MageStudios.Param.StatusStateCol3.split(" ");
MageStudios.Param.StatusStateCol4 = String(
  MageStudios.Parameters["States Column 4"]
);
MageStudios.Param.StatusStateCol4 =
  MageStudios.Param.StatusStateCol4.split(" ");

MageStudios.Param.StatusAttributes = String(
  MageStudios.Parameters["Attributes Command"]
);
MageStudios.Param.StatusAttriCol1 = String(
  MageStudios.Parameters["Attributes Column 1"]
);
MageStudios.Param.StatusAttriCol1 =
  MageStudios.Param.StatusAttriCol1.split(" ");
MageStudios.Param.StatusAttriCol2 = String(
  MageStudios.Parameters["Attributes Column 2"]
);
MageStudios.Param.StatusAttriCol2 =
  MageStudios.Param.StatusAttriCol2.split(" ");
MageStudios.Param.StatusAttriCol3 = String(
  MageStudios.Parameters["Attributes Column 3"]
);
MageStudios.Param.StatusAttriCol3 =
  MageStudios.Param.StatusAttriCol3.split(" ");
MageStudios.Param.StatusAttriCol4 = String(
  MageStudios.Parameters["Attributes Column 4"]
);
MageStudios.Param.StatusAttriCol4 =
  MageStudios.Param.StatusAttriCol4.split(" ");
MageStudios.Param.StatusAttrSize = Number(
  MageStudios.Parameters["Attribute Font Size"]
);
MageStudios.Param.StatusAttrDec = Number(
  MageStudios.Parameters["Attribute Decimal"]
);
...
Window_StatusInfo.prototype.drawGeneralExp = function (dx, dy, dw, dh) {
  ...
  dy += this.lineHeight();
  this.changeTextColor(this.systemColor());
  text = MageStudios.Param.StatusTotalFmt.format(
    TextManager.exp,
    TextManager.level
  );
  this.drawText(text, dx, dy, dw, "left");
