//=============================================================================
// Mage Studios Engine Plugins - Equip Battle Skills
// MSEP_EquipBattleSkills.js
//=============================================================================
...
MageStudios.Param.EBSStartSlots = Number(MageStudios.Parameters['Starting Skill Slots']);
MageStudios.Param.EBSMaxSlots = Number(MageStudios.Parameters['Maximum Skills']);
MageStudios.Param.EBSAllEquip = eval(String(MageStudios.Parameters['All Equippable?']));
...
MageStudios.Param.EBSEquippedColor = Number(MageStudios.Parameters['Equipped Color']);
...
MageStudios.EBS.Window_SkillList_isEnabled = Window_SkillList.prototype.isEnabled;
...
MageStudios.EBS.Window_SkillList_selectLast = Window_SkillList.prototype.selectLast;
