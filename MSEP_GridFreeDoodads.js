...
Imported.MSEP_GridFreeDoodads = true;

var MageStudios = MageStudios || {};
MageStudios.GFD = MageStudios.GFD || {};
MageStudios.GFD.version = 1.0;
 ...
 *
 * You can find the above resources from MageStudios.moe!
 *
 * ============================================================================
 ...
 * this is confusing, look at some of the examples provided from MageStudios.moe.
 *
 * ============================================================================
 * Changelog
 * ============================================================================
 ...
 * MSEP_X_CoreUpdatesOpt and desktop optimization setting.
 *
 * Version 1.09:
...
if (Utils.RPGMAKER_VERSION && Utils.RPGMAKER_VERSION >= "1.3.0") {
  ...
  MageStudios.Param.GFDFolder = String(
    MageStudios.Parameters["Doodads Folder"]
  );
  MageStudios.Param.GFDSmooth = eval(
    String(MageStudios.Parameters["Doodads Smoothing"])
  );
  MageStudios.Param.GFDAlphabet = String(
    MageStudios.Parameters["Alphabetical Settings"]
  );
  MageStudios.Param.GFDAlphabet = eval(MageStudios.Param.GFDAlphabet);

  MageStudios.Param.GFDGridSnap = eval(
    String(MageStudios.Parameters["Default Grid Snap"])
  );
  MageStudios.Param.GFDGridWidth = Number(
    MageStudios.Parameters["Grid Snap Width"]
  );
  MageStudios.Param.GFDGridHeight = Number(
    MageStudios.Parameters["Grid Snap Height"]
  );
  ...
  ImageManager.loadDoodad = function (filename, hue, smooth) {
    ...
    return this.loadDoodadBitmap(
      MageStudios.Param.GFDFolder,
      filename,
      hue,
      smooth
    );
  ...
  MageStudios.GFD.Game_Map_isEventRunning = Game_Map.prototype.isEventRunning;
  Game_Map.prototype.isEventRunning = function () {
    if ($gameTemp._modeGFD) return true;
    return MageStudios.GFD.Game_Map_isEventRunning.call(this);
  };
  ...
  Sprite_Doodad.prototype.initData = function () {
    ...
    this.bitmap = ImageManager.loadDoodad(
      path,
      this._data.hue || 0,
  ...
  MageStudios.GFD.Spriteset_Map_createCharacters =
    Spriteset_Map.prototype.createCharacters;
  Spriteset_Map.prototype.createCharacters = function () {
    MageStudios.GFD.Spriteset_Map_createCharacters.call(this);
    this.createDoodads();
  };
  ...
  MageStudios.GFD.Scene_Map_terminate = Scene_Map.prototype.terminate;
  Scene_Map.prototype.terminate = function () {
    MageStudios.GFD.Scene_Map_terminate.call(this);
    this._spriteset.clearDoodads();
  };

  if (Utils.isNwjs() && Utils.isOptionValid("test")) {
    MageStudios.GFD.TouchInput_onMouseMove = TouchInput._onMouseMove;
    TouchInput._onMouseMove = function (event) {
      MageStudios.GFD.TouchInput_onMouseMove.call(this, event);
    ...
    DoodadManager.getTemplate = function (folderName, bitmapName) {
      return {
        ...
        yFrames: 1,
        frameUpdate: 20,
        smooth: MageStudios.Param.GFDSmooth,
      };
    };
    ...
    DoodadManager.setCanvasMode = function (setting) {
      if (setting) {
        ...
        this.setGridLockMode(MageStudios.Param.GFDGridSnap);
      }
    ...
    DoodadManager.gridLockX = function () {
      this._gridLockX = this._gridLockX || MageStudios.Param.GFDGridWidth;
      return this._gridLockX;
    };

    DoodadManager.gridLockY = function () {
      this._gridLockY = this._gridLockY || MageStudios.Param.GFDGridHeight;
    ...
    MageStudios.GFD.Graphics_onKeyDown = Graphics._onKeyDown;
    Graphics._onKeyDown = function (event) {
      MageStudios.GFD.Graphics_onKeyDown.call(this, event);
    ...
    DoodadManager.keyDown = function (code) {
      ...
      if (code === 121) {
        this.toggle();
      } else if ($gameTemp._modeGFD && code === 82) {
    ...
    MageStudios.GFD.Game_Player_canMove = Game_Player.prototype.canMove;
    Game_Player.prototype.canMove = function () {
      if ($gameTemp._modeGFD) return false;
      return MageStudios.GFD.Game_Player_canMove.call(this);
    };

    MageStudios.GFD.Game_Event_updateSelfMovement =
      Game_Event.prototype.updateSelfMovement;
    Game_Event.prototype.updateSelfMovement = function () {
      if ($gameTemp._modeGFD) return;
      MageStudios.GFD.Game_Event_updateSelfMovement.call(this);
    };

    MageStudios.GFD.Sprite_Doodad_update = Sprite_Doodad.prototype.update;
    Sprite_Doodad.prototype.update = function () {
      MageStudios.GFD.Sprite_Doodad_update.call(this);
      if (!this._loadedData) return;
      if (!$gameTemp._modeGFD) return;
    ...
    Spriteset_Map.prototype.addRegionOverlayWindow = function () {
      ...
      if ($gameMap.isLoopHorizontal()) {
        ...
        this._regionOverlayWindowH._pX =
      ...
      if ($gameMap.isLoopVertical()) {
        ...
        this._regionOverlayWindowV._pY =
      ...
      if ($gameMap.isLoopHorizontal() && $gameMap.isLoopVertical()) {
        ...
        this._regionOverlayWindowHV._pX =
          $gameMap.width() * $gameMap.tileWidth();
        this._regionOverlayWindowHV._pY =
          $gameMap.height() * $gameMap.tileHeight();
    ...
    MageStudios.GFD.Window_initialize = Window.prototype.initialize;
    Window.prototype.initialize = function () {
      MageStudios.GFD.Window_initialize.call(this);
    ...
    MageStudios.GFD.Window_isOpen = Window.prototype.isOpen;
    Window.prototype.isOpen = function () {
      if (this.isGFD()) return this.opacity >= 255;
      return MageStudios.GFD.Window_isOpen.call(this);
    };

    MageStudios.GFD.Window_isClosed = Window.prototype.isClosed;
    Window.prototype.isClosed = function () {
      if (this.isGFD()) return this.opacity <= 0;
      return MageStudios.GFD.Window_isClosed.call(this);
    };

    MageStudios.GFD.Window_Base_updateOpen = Window_Base.prototype.updateOpen;
    Window_Base.prototype.updateOpen = function () {
      if (this.isGFD() && this._opening) {
        ...
        MageStudios.GFD.Window_Base_updateOpen.call(this);
      }
    };

    MageStudios.GFD.Window_Base_updateClose = Window_Base.prototype.updateClose;
    Window_Base.prototype.updateClose = function () {
      if (this.isGFD() && this._closing) {
        ...
        MageStudios.GFD.Window_Base_updateClose.call(this);
      }
    };

    MageStudios.GFD.Window_Base_updateTone = Window_Base.prototype.updateTone;
    Window_Base.prototype.updateTone = function () {
      if (this.isGFD()) {
        var tone = [100, -50, -50, 0];
        this.setTone(tone[0], tone[1], tone[2]);
      } else {
        MageStudios.GFD.Window_Base_updateTone.call(this);
      }
    };
    ...
    if (Utils.RPGMAKER_VERSION >= "1.6.0") {
      Window_GFD_List.prototype.getLocalPath = function () {
        var path = require("path");
        var base = path.dirname(process.mainModule.filename);
        return path.join(base, MageStudios.Param.GFDFolder);
      };
      ...
      Window_GFD_List.prototype.getLocalPath = function () {
        var path = window.location.pathname.replace(
          /(\/www|)\/[^\/]*$/,
          "/" + MageStudios.Param.GFDFolder + this.folderPath() + "/"
        );
        if (path.match(/^\/([A-Z]\:)/)) {
          path = path.slice(1);
        }
    ...
    Window_GFD_List.prototype.drawDoodadImage = function (index, filename) {
      var bitmap = ImageManager.loadDoodad(
      ...
      if (bitmap.width <= 0) {
        return setTimeout(
          this.drawDoodadIMageStudios.bind(this, index, filename),
          5
        );
      }
      var rect = this.itemRectForText(index);
    ...
    Window_GFD_Canvas.prototype.rawDoodadX = function () {
      ...
      if (DoodadManager._gridLockMode && DoodadManager.current()) {
        ...
        var offset = Math.round(
          this._tileWidth * ($gameMap._displayX - Math.ceil($gameMap._displayX))
        );
        value -= offset;
      }
    ...
    Window_GFD_Canvas.prototype.rawDoodadY = function () {
      ...
      if (DoodadManager._gridLockMode && DoodadManager.current()) {
        ...
        var offset = Math.round(
          this._tileHeight *
            ($gameMap._displayY - Math.ceil($gameMap._displayY))
        );
        value -= offset;
      }
      return Math.floor(value);
    ...
    DoodadManager.updateCanvasMode = function (code) {
      if (code === 81) {
        SoundManager.playCursor();
        var index = (this.layerList().indexOf(this.current().z) - 1).clamp(
          0,
          10
        );
        ...
        this._manualY -= DoodadManager._gridLockMode
          ? DoodadManager._gridLockY
          : 1;
        this.adjustManualMove();
      } else if (code === 37) {
        this.setManualMove(true);
        this._manualX -= DoodadManager._gridLockMode
          ? DoodadManager._gridLockX
          : 1;
        this.adjustManualMove();
      } else if (code === 40) {
        this.setManualMove(true);
        ...
        DoodadManager.addNew(doodad);
      } else if (code === 88 || code === 27) {
        SoundManager.playCancel();
        SceneManager._scene.exitDoodadPlacingMode();
      } else if (code === 49) {
        SoundManager.playCancel();
        this.current().opacity = Math.floor(255 * 0.1);
      } else if (code === 50) {
        SoundManager.playCancel();
        this.current().opacity = Math.floor(255 * 0.2);
      } else if (code === 51) {
        SoundManager.playCancel();
        this.current().opacity = Math.floor(255 * 0.3);
      } else if (code === 52) {
        SoundManager.playCancel();
        this.current().opacity = Math.floor(255 * 0.4);
      } else if (code === 53) {
        SoundManager.playCancel();
        this.current().opacity = Math.floor(255 * 0.5);
      } else if (code === 54) {
        SoundManager.playCancel();
        this.current().opacity = Math.floor(255 * 0.6);
      } else if (code === 55) {
        SoundManager.playCancel();
        this.current().opacity = Math.floor(255 * 0.7);
      } else if (code === 56) {
        SoundManager.playCancel();
        this.current().opacity = Math.floor(255 * 0.8);
      } else if (code === 57) {
        SoundManager.playCancel();
        this.current().opacity = Math.floor(255 * 0.9);
      } else if (code === 48) {
        SoundManager.playCancel();
    ...
    Window_GFD_Settings.prototype.addMainCommands = function () {
      if (MageStudios.Param.GFDAlphabet) return;
      this.addLineCommand();
      this.addCommand("Layer", "layer");
      this.addCommand(
        "Hue",
        "hue",
        this._doodad && this._doodad.iconIndex <= 0
      );
    ...
    Window_GFD_Settings.prototype.addCustomCommands = function () {
      if (MageStudios.Param.GFDAlphabet) this.addLineCommand();
    ...
    Window_GFD_Settings.prototype.drawItem = function (index) {
      ...
      switch (symbol) {
        ...
        case "frameSpeed":
          if (this.isAnimated()) {
            var text = MageStudios.Util.toGroup(this._doodad.frameUpdate);
          } else {
    ...
    Window_GFD_SettingsLayers.prototype = Object.create(
    ...
    Window_GFD_SettingsOpacity.prototype = Object.create(
      Window_Command.prototype
    );
    Window_GFD_SettingsOpacity.prototype.constructor =
    ...
    Window_GFD_SettingsOpacity.prototype.makeCommandList = function () {
      this.addCommand("100%", "opacity", true, Math.floor(255 * 1.0));
      this.addCommand(" 90%", "opacity", true, Math.floor(255 * 0.9));
      this.addCommand(" 80%", "opacity", true, Math.floor(255 * 0.8));
      this.addCommand(" 70%", "opacity", true, Math.floor(255 * 0.7));
      this.addCommand(" 60%", "opacity", true, Math.floor(255 * 0.6));
      this.addCommand(" 50%", "opacity", true, Math.floor(255 * 0.5));
      this.addCommand(" 40%", "opacity", true, Math.floor(255 * 0.4));
      this.addCommand(" 30%", "opacity", true, Math.floor(255 * 0.3));
      this.addCommand(" 20%", "opacity", true, Math.floor(255 * 0.2));
      this.addCommand(" 10%", "opacity", true, Math.floor(255 * 0.1));
      this.addCommand("  0%", "opacity", true, Math.floor(255 * 0.0));
    };
    ...
    Window_GFD_SettingsScale.prototype = Object.create(
      Window_Command.prototype
    );
    ...
    Window_GFD_SettingsAnchorX.prototype = Object.create(
      Window_Command.prototype
    );
    Window_GFD_SettingsAnchorX.prototype.constructor =
    ...
    Window_GFD_SettingsAnchorY.prototype = Object.create(
      Window_Command.prototype
    );
    Window_GFD_SettingsAnchorY.prototype.constructor =
    ...
    Window_GFD_SettingsFrameSpeed.prototype = Object.create(
      Window_Command.prototype
    );
    ...
    Window_GFD_SettingsBlend.prototype = Object.create(
      Window_Command.prototype
    );
    ...
    Window_GFD_SettingsSmooth.prototype = Object.create(
      Window_Command.prototype
    );
    ...
    Window_GFD_GridMenu.prototype.drawItem = function (index) {
      ...
      if (symbol === "gridX" || symbol === "gridY") {
        var rect = this.itemRectForText(index);
        var ext = MageStudios.Util.toGroup(this._list[index].ext);
    ...
    Window_GFD_GridMenu.prototype.updateLeftRight = function () {
      ...
      var changed = false;
      if (symbol === "gridX") {
        DoodadManager._gridLockX = Math.max(
          1,
          DoodadManager._gridLockX + value
        );
        var changed = true;
      } else if (symbol === "gridY") {
        DoodadManager._gridLockY = Math.max(
          1,
          DoodadManager._gridLockY + value
        );
        var changed = true;
      }
      if (changed) {
    ...
    Window_GFD_PickDoodadLayer.prototype = Object.create(
      Window_Command.prototype
    );
    Window_GFD_PickDoodadLayer.prototype.constructor =
    ...
    Window_GFD_PickDoodadLayer.prototype.drawItem = function (index) {
      ...
      var rect = this.itemRectForText(index);
      var text = "x" + MageStudios.Util.toGroup(total);
      this.drawText(text, rect.x, rect.y, rect.width, "right");
    };
    ...
    Window_GFD_PickDoodadList.prototype = Object.create(
      Window_Command.prototype
    );
    ...
    Window_GFD_PickDoodadList.prototype.drawDoodadImage = function (
      index,
      data
    ) {
      ...
      if (bitmap.width <= 0) {
        return setTimeout(
          this.drawDoodadIMageStudios.bind(this, index, data),
          5
        );
      }
      var rect = this.itemRect(index);
    ...
    MageStudios.GFD.Scene_Map_createAllWindows =
      Scene_Map.prototype.createAllWindows;
    Scene_Map.prototype.createAllWindows = function () {
      MageStudios.GFD.Scene_Map_createAllWindows.call(this);
      this.createGFDWindows();
    };

    MageStudios.GFD.Scene_Map_updateScene = Scene_Map.prototype.updateScene;
    Scene_Map.prototype.updateScene = function () {
      if ($gameTemp._modeGFD) return;
      MageStudios.GFD.Scene_Map_updateScene.call(this);
    };
    ...
    MageStudios.GFD.Scene_Map_isMenuEnabled = Scene_Map.prototype.isMenuEnabled;
    Scene_Map.prototype.isMenuEnabled = function () {
      if ($gameTemp._modeGFD) return false;
      return MageStudios.GFD.Scene_Map_isMenuEnabled.call(this);
    };

    MageStudios.GFD.Scene_Map_isDebugCalled = Scene_Map.prototype.isDebugCalled;
    Scene_Map.prototype.isDebugCalled = function () {
      if ($gameTemp._modeGFD) return false;
      return MageStudios.GFD.Scene_Map_isDebugCalled.call(this);
    };
