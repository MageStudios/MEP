//=============================================================================
// Mage Studios Engine Plugins - Grid-Free Doodads
// MSEP_GridFreeDoodads.js
//=============================================================================
...
MageStudios.Param.GFDSmooth = eval(String(MageStudios.Parameters['Doodads Smoothing']));
MageStudios.Param.GFDAlphabet = String(MageStudios.Parameters['Alphabetical Settings']);
MageStudios.Param.GFDAlphabet = eval(MageStudios.Param.GFDAlphabet);

MageStudios.Param.GFDGridSnap = eval(String(MageStudios.Parameters['Default Grid Snap']));
MageStudios.Param.GFDGridWidth = Number(MageStudios.Parameters['Grid Snap Width']);
MageStudios.Param.GFDGridHeight = Number(MageStudios.Parameters['Grid Snap Height']);
...
ImageManager.loadDoodad = function(filename, hue, smooth) {
  ...
  return this.loadDoodadBitmap(MageStudios.Param.GFDFolder, filename, hue, smooth);
};
...
Window_GFD_List.prototype.drawDoodadImage = function(index, filename) {
  ...
  if (bitmap.width <= 0) {
    return setTimeout(this.drawDoodadIMageStudios.bind(this, index, filename), 5);
  }
  var rect = this.itemRectForText(index);
...
Window_GFD_PickDoodadList.prototype.drawDoodadImage = function(index, data) {
  ...
  if (bitmap.width <= 0) {
    return setTimeout(this.drawDoodadIMageStudios.bind(this, index, data), 5);
  }
  var rect = this.itemRect(index);
  var xframes = DoodadManager.getXFrames(filename);
  var yframes = DoodadManager.getYFrames(filename);
...
MageStudios.GFD.Scene_Map_createAllWindows = Scene_Map.prototype.createAllWindows;
