...
Sprite_Character.prototype.setCharacterBitmap = function() {
  if (this._characterName.match(/\[(\d+)x(\d+)\]/i)) {
    ...
    MageStudios.ScSpr.Sprite_Character_setCharacterBitmap.call(this);
    this.scale.x = 1.0;
    this.scale.y = 1.0;
  }
};
...
Sprite_Character.prototype.patternWidth = function() {
  ...
  return MageStudios.ScSpr.Sprite_Character_patternWidth.call(this);
};
...
Window_Base.prototype.drawCharacter = function(name, index, x, y) {
  if (name.match(/\[(\d+)x(\d+)\]/i)) {
    ...
    MageStudios.ScSpr.Window_Base_drawCharacter.call(this, name, index, x, y);
  }
};
